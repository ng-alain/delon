import{a as M}from"./chunk-LUGCOC4B.js";import{a as w}from"./chunk-XFEF7HZC.js";import"./chunk-WK4VD42U.js";import{b as B}from"./chunk-3XXVNPSY.js";import{b as T}from"./chunk-FBSRXXMD.js";import"./chunk-GPS3STYB.js";import"./chunk-MJWBK4BK.js";import"./chunk-53JX7EQO.js";import{s as x,t as G,u as D}from"./chunk-LJKXQ2Z5.js";import{R as $}from"./chunk-OAR6ASNJ.js";import{Ab as v,Db as u,Ja as l,Jb as b,Ka as h,Kb as k,Ra as f,Sa as m,Ua as y,cg as C,eg as N,fb as n,gb as i,gg as _,ha as p,hb as g,ig as z,pb as s,qc as S,yb as e}from"./chunk-JIFQ6OJY.js";var R=(()=>{let o=class o{get newValue(){return+new Date}constructor(c,r){this.srv=c,this.msg=r,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(c=>{this.value=c})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(c=>{if(c==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${c.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}};o.\u0275fac=function(r){return new(r||o)(h(M),h($))},o.\u0275cmp=p({type:o,selectors:[["cache-getting-started-simple"]],standalone:!0,features:[u],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(r,t){r&1&&(e(0,`
