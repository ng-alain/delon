...
- [\u5173\u4E8EAngular\u6837\u5F0F\u5C01\u88C5](https://zhuanlan.zhihu.com/p/31235358)`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-component-styles`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var _=class n{item={name:`customize-theme`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:5,title:`Customize Theme`,description:`Ant Design allows you to customize some basic design aspects in order to meet the needs of UI diversity from business and brand, including primary col...`,group:`Documents`,path:`packages/theme/docs/customize-theme.en-US.md`,url:`/theme/customize-theme/en`},text:`<p>Ant Design allows you to customize some basic design aspects in order to meet the needs of UI diversity from business and brand, including primary color, border radius, border color, etc.</p>
...
\u5982\u679C\u4EE5\u4E0A\u53D8\u91CF\u4E0D\u80FD\u6EE1\u8DB3\u4F60\u7684\u5B9A\u5236\u9700\u6C42\uFF0C\u53EF\u4EE5\u7ED9\u6211\u4EEC\u63D0 issue\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-getting-started`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var N=class n{item={name:`global`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`Global Parameters`,description:`By nz-table。`,group:`Theme`,path:`packages/theme/docs/global.en-US.md`,url:`/theme/global/en`},text:`<h2 id="public"><a class="lake-link"><i data-anchor="public"></i></a>Public</h2><table>
<thead>
<tr>
<th>Name</th>
<th>Default</th>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-icon`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var L=class n{item={name:`locale`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:2,title:`Internationalization`,description:`Provide a uniform localization support for @delon/* class library built-in text of components.Provides the token of DELON_LOCALE for configuring antd ...`,group:`Documents`,path:`packages/theme/docs/locale.en-US.md`,url:`/theme/locale/en`},text:`<p>Provide a uniform localization support for <code>&#64;delon/*</code> class library built-in text of components.</p>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-index`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var H=class n{item={name:`date`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`_date`,subtitle:`Date`,description:`Based on date-fns date formatting, see more details date-fns (China mirror: moment format)date-fns supports different kinds of time formats, such as:2...`,group:`Pipe`,path:`packages/theme/src/pipes/date/index.en-US.md`,url:`/theme/date/en`},text:`<p>Based on date-fns date formatting, see more details <a href="https://date-fns.org/v1.29.0/docs/format" target="_blank" rel="noopener">date-fns</a> (China mirror: <a href="http://Momentjs.cn/docs/#/displaying/format/" target="_blank" rel="noopener">moment format</a>)</p>
...
\`\`\`txt
2017\u5E7408\u670824\u65E5
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-date`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var W=class n{item={name:`keys`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`keys`,subtitle:`Keys`,description:`Transforms Object or Map into an array of key value pairs.Data:Use:DictionaryIf you want to keep the key name number numeric:Angular 6.1.0 will suppor...`,group:`Pipe`,path:`packages/theme/src/pipes/keys/index.en-US.md`,url:`/theme/keys/en`},text:`<p>Transforms Object or Map into an array of key value pairs.</p>
<p>Data:</p>
...
> Angular \`6.1.0\` \u4EE5\u540E\u539F\u751F\u652F\u6301 [KeyValuePipe](https://angular.io/api/common/KeyValuePipe)\uFF0C\u7528\u6CD5\u6709\u70B9\u7C7B\u4F3C\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-keys`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var B=class n{item={name:`safe`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`safe`,subtitle:`XSS`,description:`Simplify the use of bypassSecurityTrustHtml.Simplify the use of bypassSecurityTrustUrl.`,group:`Pipe`,path:`packages/theme/src/pipes/safe/index.en-US.md`,url:`/theme/safe/en`},text:`<h2 id="html"><a class="lake-link"><i data-anchor="html"></i></a>html</h2><p>Simplify the use of <code>bypassSecurityTrustHtml</code>.</p>
...
\`\`\`html
<a [href]="file_url | url" target="_blank"></a>
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-safe`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var j=class n{item={name:`yn`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`yn`,subtitle:`Badge`,description:`yn Make boolean as badge.`,group:`Pipe`,path:`packages/theme/src/pipes/yn/index.en-US.md`,url:`/theme/yn/en`},text:`<p><code>yn</code> Make boolean as badge.</p>
...
Output:
<td><i class="text-blue"><svg viewBox="64 64 896 896" fill="currentColor" width="1em" height="1em" aria-hidden="true"><path d="M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 0 0-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z"></path></svg></i></td>
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-yn`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var G=class n{constructor(o,e){this.modalHelper=o;this.msg=e}modalHelper;msg;open(){this.modalHelper.create(`View`,k,{record:{a:1,b:`2`,c:new Date}}).subscribe(o=>{this.msg.info(o)})}static(){this.modalHelper.static(`View`,k,{record:{a:1,b:`2`,c:new Date}}).subscribe(o=>{this.msg.info(o)})}static ɵfac=function(e){return new(e||n)(Mt(rm),Mt(lu))};static ɵcmp=Se({type:n,selectors:[[`theme-drawer-simple`]],decls:4,vars:0,consts:[[`nz-button`,``,3,`click`]],template:function(e,t){e&1&&(oe(0,`button`,0),je(`click`,function(){return t.open()}),an(1,`Open`),he(),oe(2,`button`,0),je(`click`,function(){return t.static()}),an(3,`Static`),he())},dependencies:[v5,a3,f5,m5],encapsulation:2})};var F=class n{item={name:`drawer`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:3,title:`DrawerHelper`,subtitle:`Drawer Helper`,description:`Based on the NzDrawerService package, it solves some known issues:More friendly handling callbacksSupport responsiveThere are includes create & static`,group:`Service`,path:`packages/theme/src/services/drawer/index.en-US.md`,url:`/theme/drawer/en`},text:`<p>Based on the <code>NzDrawerService</code> package, it solves some known issues:</p>
<ul>
...
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/theme/src/services/drawer/demo/simple.md`}];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-drawer`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt(4,`theme-drawer-simple`),he()()()()),e&2&&(ie(`codes`,t.codes)(`item`,t.item),A$1(),ie(`nzGutter`,16),A$1(2),ie(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce,G,sn,We,X$1],encapsulation:2})};var V=class n{item={name:`http`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`_HttpClient`,description:`_HttpClient service is based on Angular HttpClient.More friendly call methodsMaintain loading attributeHandling null valuesUnified time format is time...`,group:`Service`,path:`packages/theme/src/services/http/index.en-US.md`,url:`/theme/http/en`},text:`<p><a href="https://github.com/ng-alain/delon/blob/master/packages/theme/src/services/http/http.client.ts" target="_blank" rel="noopener">_HttpClient</a> service is based on Angular <code>HttpClient</code>.</p>
...
`,"zh-CN":`\u652F\u6301\u62D6\u52A8\u5BF9\u8BDD\u6846\u3002
`},path:`packages/theme/src/services/modal/demo/drag.md`}];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-modal`]],hostAttrs:[1,`d-block`],decls:7,vars:7,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt(4,`theme-modal-simple`),he(),oe(5,`code-box`,3),pt(6,`theme-modal-drag`),he()()()()),e&2&&(ie(`codes`,t.codes)(`item`,t.item),A$1(),ie(`nzGutter`,16),A$1(2),ie(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A$1(2),ie(`item`,t.codes[1]),$t(`id`,t.codes[1].id))},dependencies:[ce,K,$,sn,We,X$1],encapsulation:2})};var Z=class n{item={name:`responsive`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:5,title:`ResponsiveService`,subtitle:`Responsive Service`,description:`More friendly use responsive rules, the original xs, sm etc. reduced to col property, the default response rule:In order to better develop responsives...`,group:`Service`,path:`packages/theme/src/services/responsive/index.en-US.md`,url:`/theme/responsive/en`},text:`<p>More friendly use responsive rules, the original <code>xs</code>, <code>sm</code> etc. reduced to <code>col</code> property, the default response rule:</p>
<table>
<thead>
<tr>
<th><code>col</code></th>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`theme-responsive`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var J=class n{item={name:`rtl`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:6,title:`RTLService`,subtitle:`RTL Service`,description:`RTL service control.`,group:`Service`,path:`packages/theme/src/services/rtl/index.en-US.md`,url:`/theme/rtl/en`},text:`<p>RTL service control.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><table>
<thead>
<tr>
<th>Method</th>
