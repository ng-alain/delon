import{e as M,f as w}from"./chunk-JB5EBB25.js";import"./chunk-DFTH5LK6.js";import"./chunk-LANDAJ75.js";import"./chunk-4LMKEQTT.js";import"./chunk-WCHKEMEB.js";import{Ab as f,Bb as y,Db as h,Ja as l,Jb as o,Ka as u,Kb as s,Qc as I,Rc as x,Ye as m,fb as p,gb as a,ha as c,hb as v,qc as g,yb as e}from"./chunk-KLO4GQEX.js";var H=(()=>{let t=class t{constructor(i){this.route=i,this.first=m(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=m(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=m(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)(u(I))},t.\u0275cmp=c({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,r){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
