import{Bc as vi,Cr as S,Fr as Se,Gn as Oa,Pc as v5,Qn as P$1,Qt as Je,So as hse,Ts as oe,Ut as Io,Wc as w,Xa as f5,Ya as f3,Ys as rc,as as m5,c as $t,ca as a3,fa as an,ha as b,io as g,jn as Mt,jo as ie$1,kn as Me,lc as se,ml as yi,po as h,ts as ln,u as A,vn as LA,vo as he,zo as je,zr as T,zs as pt}from"./chunk-Bix55avy.js";import{B as lu}from"./chunk-3aQ3WiqM.js";import{f as sn,i as We}from"./chunk-bq9s7eY5.js";import{t as X}from"./main-YYZC7LXB.js";import"./chunk-46Ii5gWu.js";import"./chunk-CKkdg4oh.js";import{t as ce}from"./chunk-AxTuKf1y.js";import{t as ee}from"./chunk-BjZZfLcG.js";var ie=new b(`DC_STORE_STORAGE_TOKEN`,{providedIn:`root`,factory:()=>new J});var J=class{platform=h(Me);get(e){return this.platform.isBrowser?JSON.parse(localStorage.getItem(e)??`null`)??null:null}set(e,n){return this.platform.isBrowser&&localStorage.setItem(e,JSON.stringify(n)),!0}remove(e){this.platform.isBrowser&&localStorage.removeItem(e)}};var u=class c{store=h(ie);http=h(rc);platform=h(Me);memory=new Map;notifyBuffer=new Map;meta=new Set;freqTick=3e3;freqTime;cog=h(ln).merge(`cache`,{mode:`promise`,reName:``,prefix:``,meta_key:`__cache_meta`});constructor(){this.platform.isBrowser&&(this.loadMeta(),this.startExpireNotify())}pushMeta(e){this.meta.has(e)||(this.meta.add(e),this.saveMeta())}removeMeta(e){this.meta.has(e)&&(this.meta.delete(e),this.saveMeta())}loadMeta(){let e=this.store.get(this.cog.meta_key);e&&e.v&&e.v.forEach(n=>this.meta.add(n))}saveMeta(){let e=[];this.meta.forEach(n=>e.push(n)),this.store.set(this.cog.meta_key,{v:e,e:0})}getMeta(){return this.meta}set(e,n,t={}){if(!this.platform.isBrowser)return;let r=0,{type:f,expire:ce}=this.cog;t=g({type:f,expire:ce},t),t.expire&&(r=f3(new Date,t.expire).valueOf());let F=t.emitNotify!==!1;if(!(n instanceof T)){this.save(t.type,e,{v:n,e:r},F);return}return n.pipe(Je(le=>{this.save(t.type,e,{v:le,e:r},F)}))}save(e,n,t,r=!0){e===`m`?this.memory.set(n,t):(this.store.set(this.cog.prefix+n,t),this.pushMeta(n)),r&&this.runNotify(n,`set`)}get(e,n={}){if(!this.platform.isBrowser)return null;let t=n.mode!==`none`&&this.cog.mode===`promise`,r=this.memory.has(e)?this.memory.get(e):this.store.get(this.cog.prefix+e);return!r||r.e&&r.e>0&&r.e<new Date().valueOf()?t?(this.cog.request?this.cog.request(e):this.http.get(e)).pipe(P$1(f=>hse(f,this.cog.reName,f)),Je(f=>this.set(e,f,{type:n.type,expire:n.expire,emitNotify:n.emitNotify}))):null:t?S(r.v):r.v}getNone(e){return this.get(e,{mode:`none`})}tryGet(e,n,t={}){if(!this.platform.isBrowser)return null;let r=this.getNone(e);return r===null?n instanceof T?this.set(e,n,t):(this.set(e,n,t),n):S(r)}has(e){return this.memory.has(e)||this.meta.has(e)}_remove(e,n){if(n&&this.runNotify(e,`remove`),this.memory.has(e)){this.memory.delete(e);return}this.store.remove(this.cog.prefix+e),this.removeMeta(e)}remove(e){this.platform.isBrowser&&this._remove(e,!0)}clear(){this.platform.isBrowser&&(this.notifyBuffer.forEach((e,n)=>this.runNotify(n,`remove`)),this.memory.clear(),this.meta.forEach(e=>this.store.remove(this.cog.prefix+e)))}set freq(e){this.freqTick=Math.max(20,e),this.abortExpireNotify(),this.startExpireNotify()}startExpireNotify(){this.checkExpireNotify(),this.runExpireNotify()}runExpireNotify(){this.freqTime=setTimeout(()=>{this.checkExpireNotify(),this.runExpireNotify()},this.freqTick)}checkExpireNotify(){let e=[];this.notifyBuffer.forEach((n,t)=>{this.has(t)&&this.getNone(t)===null&&e.push(t)}),e.forEach(n=>{this.runNotify(n,`expire`),this._remove(n,!1)})}abortExpireNotify(){clearTimeout(this.freqTime)}runNotify(e,n){this.notifyBuffer.has(e)&&this.notifyBuffer.get(e).next({type:n,value:this.getNone(e)})}notify(e){if(!this.notifyBuffer.has(e)){let n=new se(this.getNone(e));this.notifyBuffer.set(e,n)}return this.notifyBuffer.get(e).asObservable()}cancelNotify(e){this.notifyBuffer.has(e)&&(this.notifyBuffer.get(e).unsubscribe(),this.notifyBuffer.delete(e))}hasNotify(e){return this.notifyBuffer.has(e)}clearNotify(){this.notifyBuffer.forEach(e=>e.unsubscribe()),this.notifyBuffer.clear()}ngOnDestroy(){this.memory.clear(),this.abortExpireNotify(),this.clearNotify()}static ɵfac=function(n){return new(n||c)};static ɵprov=w({token:c,factory:c.ɵfac,providedIn:`root`})};new Oa(()=>({}));var O=class c{constructor(e,n){this.srv=e;this.msg=n}srv;msg;value;key=`demo`;notify$;get newValue(){return+new Date}getByHttp(){this.srv.get(`https://randomuser.me/api/?results=1`).subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success(`register success`);return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static ɵfac=function(n){return new(n||c)(Mt(u),Mt(lu))};static ɵcmp=Se({type:c,selectors:[[`cache-getting-started-simple`]],decls:23,vars:3,consts:[[1,`pt-sm`],[`nz-button`,``,3,`click`]],template:function(n,t){n&1&&(oe(0,`p`),an(1),vi(2,`json`),he(),oe(3,`div`,0),an(4,` Basic: `),oe(5,`button`,1),je(`click`,function(){return t.srv.set(t.key,t.newValue)}),an(6,`Set`),he(),oe(7,`button`,1),je(`click`,function(){return t.value=t.srv.getNone(t.key)}),an(8,`Get`),he(),oe(9,`button`,1),je(`click`,function(){return t.srv.remove(t.key)}),an(10,`Remove`),he(),oe(11,`button`,1),je(`click`,function(){return t.srv.clear()}),an(12,`Clear`),he()(),oe(13,`div`,0),an(14,` Key is valid request: `),oe(15,`button`,1),je(`click`,function(){return t.getByHttp()}),an(16,`Get`),he()(),oe(17,`div`,0),an(18,` Notify: `),oe(19,`button`,1),je(`click`,function(){return t.registerNotify()}),an(20,`Register`),he(),oe(21,`button`,1),je(`click`,function(){return t.unRegisterNotify()}),an(22,`UnRegister`),he()()),n&2&&(A(),Io(`value: `,yi(2,1,t.value)))},dependencies:[v5,a3,f5,m5,LA],encapsulation:2})};var R=class c{item={name:`getting-started`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:1,title:`开始使用`,description:`通常把一些远程数据缓存在内存或 localStorage 持久化，目的是为了减少 Http 请求的成本；这样的数据通常是字典、城市数据等。缓存的获取应该是非常简单的，我们不应该把时间浪费在如何保证加载这件事情上，因此 @delon/cache 更多是以约定为前提。key 作为缓存的唯一键值，它不应该...`,group:`Documents`,path:`packages/cache/docs/getting-started.md`,url:`/cache/getting-started/zh`},text:`<h2 id="\u5199\u5728\u524D\u9762"><a class="lake-link"><i data-anchor="\u5199\u5728\u524D\u9762"></i></a>\u5199\u5728\u524D\u9762</h2><p>\u901A\u5E38\u628A\u4E00\u4E9B\u8FDC\u7A0B\u6570\u636E\u7F13\u5B58\u5728\u5185\u5B58\u6216 <code>localStorage</code> \u6301\u4E45\u5316\uFF0C\u76EE\u7684\u662F\u4E3A\u4E86\u51CF\u5C11 Http \u8BF7\u6C42\u7684\u6210\u672C\uFF1B\u8FD9\u6837\u7684\u6570\u636E\u901A\u5E38\u662F\u5B57\u5178\u3001\u57CE\u5E02\u6570\u636E\u7B49\u3002</p>
...
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/cache/docs/demo/simple.md`}];static ɵfac=function(n){return new(n||c)};static ɵcmp=Se({type:c,selectors:[[`cache-getting-started`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(n,t){n&1&&(oe(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt(4,`cache-getting-started-simple`),he()()()()),n&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce,O,sn,We,X],encapsulation:2})};var $=class c{constructor(e,n){this.srv=e;this.msg=n}srv;msg;value;key=`demo`;notify$;get newValue(){return+new Date}getByHttp(){this.srv.get(`https://randomuser.me/api/?results=1`).subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success(`register success`);return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static ɵfac=function(n){return new(n||c)(Mt(u),Mt(lu))};static ɵcmp=Se({type:c,selectors:[[`cache-interceptor-simple`]],decls:23,vars:3,consts:[[1,`pt-sm`],[`nz-button`,``,3,`click`]],template:function(n,t){n&1&&(oe(0,`p`),an(1),vi(2,`json`),he(),oe(3,`div`,0),an(4,` Basic: `),oe(5,`button`,1),je(`click`,function(){return t.srv.set(t.key,t.newValue)}),an(6,`Set`),he(),oe(7,`button`,1),je(`click`,function(){return t.value=t.srv.getNone(t.key)}),an(8,`Get`),he(),oe(9,`button`,1),je(`click`,function(){return t.srv.remove(t.key)}),an(10,`Remove`),he(),oe(11,`button`,1),je(`click`,function(){return t.srv.clear()}),an(12,`Clear`),he()(),oe(13,`div`,0),an(14,` Key is valid request: `),oe(15,`button`,1),je(`click`,function(){return t.getByHttp()}),an(16,`Get`),he()(),oe(17,`div`,0),an(18,` Notify: `),oe(19,`button`,1),je(`click`,function(){return t.registerNotify()}),an(20,`Register`),he(),oe(21,`button`,1),je(`click`,function(){return t.unRegisterNotify()}),an(22,`UnRegister`),he()()),n&2&&(A(),Io(`value: `,yi(2,1,t.value)))},dependencies:[v5,a3,f5,m5,LA],encapsulation:2})};var G=class c{item={name:`interceptor`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:3,title:`Interceptor`,description:`搭配 httpCacheInterceptor Http 拦截器，可以将缓存应用到 Http 请求当中。它只有几个特征：支持缓存过期时间支持自定义缓存 KEY支持任何 Http 请求、任何数据格式符合 Http 缓存响应标准 Cache-Control在 withInterceptors 中引入 h...`,group:`Documents`,path:`packages/cache/docs/interceptor.md`,url:`/cache/interceptor/zh`},text:`<h2 id="\u5199\u5728\u524D\u9762"><a class="lake-link"><i data-anchor="\u5199\u5728\u524D\u9762"></i></a>\u5199\u5728\u524D\u9762</h2><p>\u642D\u914D <code>httpCacheInterceptor</code> Http \u62E6\u622A\u5668\uFF0C\u53EF\u4EE5\u5C06\u7F13\u5B58\u5E94\u7528\u5230 Http \u8BF7\u6C42\u5F53\u4E2D\u3002\u5B83\u53EA\u6709\u51E0\u4E2A\u7279\u5F81\uFF1A</p>
<ul>
<li>\u652F\u6301\u7F13\u5B58\u8FC7\u671F\u65F6\u95F4</li>
<li>\u652F\u6301\u81EA\u5B9A\u4E49\u7F13\u5B58 KEY</li>
