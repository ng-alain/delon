import{a as T}from"./chunk-SKF2GXFR.js";import"./chunk-EBLUQ6D4.js";import{a as E}from"./chunk-GDCKMHPN.js";import{a as ne}from"./chunk-DJHXEMNR.js";import"./chunk-UTW2MQ4M.js";import"./chunk-BNVDYK7G.js";import"./chunk-JVOEVV4C.js";import{d as D,e as w}from"./chunk-VFONZWU4.js";import{ba as B}from"./chunk-N7N5PMOX.js";import{$c as Z,Eb as a,Gd as te,Ld as J,Ma as p,Mg as k,Ng as _,Pg as z,Qg as x,Sb as g,Tc as N,Td as M,Tg as ie,Ua as d,Vb as r,W as A,Wa as l,Xb as b,a as q,ba as Q,da as X,fa as h,gb as y,gd as ee,j as U,l as Y,oc as C,pc as S,sb as m,t as V,tb as n,ub as s,vb as v,x as L}from"./chunk-5O2FY4HA.js";var oe=new X("DC_STORE_STORAGE_TOKEN",{providedIn:"root",factory:()=>new K}),K=class{platform=h(M);get(e){return this.platform.isBrowser?JSON.parse(localStorage.getItem(e)??"null")??null:null}set(e,i){return this.platform.isBrowser&&localStorage.setItem(e,JSON.stringify(i)),!0}remove(e){this.platform.isBrowser&&localStorage.removeItem(e)}};var u=class c{store=h(oe);http=h(ee);platform=h(M);memory=new Map;notifyBuffer=new Map;meta=new Set;freqTick=3e3;freqTime;cog=h(J).merge("cache",{mode:"promise",reName:"",prefix:"",meta_key:"__cache_meta"});constructor(){this.platform.isBrowser&&(this.loadMeta(),this.startExpireNotify())}pushMeta(e){this.meta.has(e)||(this.meta.add(e),this.saveMeta())}removeMeta(e){this.meta.has(e)&&(this.meta.delete(e),this.saveMeta())}loadMeta(){let e=this.store.get(this.cog.meta_key);e&&e.v&&e.v.forEach(i=>this.meta.add(i))}saveMeta(){let e=[];this.meta.forEach(i=>e.push(i)),this.store.set(this.cog.meta_key,{v:e,e:0})}getMeta(){return this.meta}set(e,i,t={}){if(!this.platform.isBrowser)return;let o=0,{type:f,expire:pe}=this.cog;t=q({type:f,expire:pe},t),t.expire&&(o=ie(new Date,t.expire).valueOf());let W=t.emitNotify!==!1;if(!(i instanceof U)){this.save(t.type,e,{v:i,e:o},W);return}return i.pipe(A(le=>{this.save(t.type,e,{v:le,e:o},W)}))}save(e,i,t,o=!0){e==="m"?this.memory.set(i,t):(this.store.set(this.cog.prefix+i,t),this.pushMeta(i)),o&&this.runNotify(i,"set")}get(e,i={}){if(!this.platform.isBrowser)return null;let t=i.mode!=="none"&&this.cog.mode==="promise",o=this.memory.has(e)?this.memory.get(e):this.store.get(this.cog.prefix+e);return!o||o.e&&o.e>0&&o.e<new Date().valueOf()?t?(this.cog.request?this.cog.request(e):this.http.get(e)).pipe(L(f=>te(f,this.cog.reName,f)),A(f=>this.set(e,f,{type:i.type,expire:i.expire,emitNotify:i.emitNotify}))):null:t?V(o.v):o.v}getNone(e){return this.get(e,{mode:"none"})}tryGet(e,i,t={}){if(!this.platform.isBrowser)return null;let o=this.getNone(e);return o===null?i instanceof U?this.set(e,i,t):(this.set(e,i,t),i):V(o)}has(e){return this.memory.has(e)||this.meta.has(e)}_remove(e,i){if(i&&this.runNotify(e,"remove"),this.memory.has(e)){this.memory.delete(e);return}this.store.remove(this.cog.prefix+e),this.removeMeta(e)}remove(e){this.platform.isBrowser&&this._remove(e,!0)}clear(){this.platform.isBrowser&&(this.notifyBuffer.forEach((e,i)=>this.runNotify(i,"remove")),this.memory.clear(),this.meta.forEach(e=>this.store.remove(this.cog.prefix+e)))}set freq(e){this.freqTick=Math.max(20,e),this.abortExpireNotify(),this.startExpireNotify()}startExpireNotify(){this.checkExpireNotify(),this.runExpireNotify()}runExpireNotify(){this.freqTime=setTimeout(()=>{this.checkExpireNotify(),this.runExpireNotify()},this.freqTick)}checkExpireNotify(){let e=[];this.notifyBuffer.forEach((i,t)=>{this.has(t)&&this.getNone(t)===null&&e.push(t)}),e.forEach(i=>{this.runNotify(i,"expire"),this._remove(i,!1)})}abortExpireNotify(){clearTimeout(this.freqTime)}runNotify(e,i){this.notifyBuffer.has(e)&&this.notifyBuffer.get(e).next({type:i,value:this.getNone(e)})}notify(e){if(!this.notifyBuffer.has(e)){let i=new Y(this.getNone(e));this.notifyBuffer.set(e,i)}return this.notifyBuffer.get(e).asObservable()}cancelNotify(e){this.notifyBuffer.has(e)&&(this.notifyBuffer.get(e).unsubscribe(),this.notifyBuffer.delete(e))}hasNotify(e){return this.notifyBuffer.has(e)}clearNotify(){this.notifyBuffer.forEach(e=>e.unsubscribe()),this.notifyBuffer.clear()}ngOnDestroy(){this.memory.clear(),this.abortExpireNotify(),this.clearNotify()}static \u0275fac=function(i){return new(i||c)};static \u0275prov=Q({token:c,factory:c.\u0275fac,providedIn:"root"})};var me=new Z(()=>({}));var G=class c{constructor(e,i){this.srv=e;this.msg=i}value;key="demo";notify$;get newValue(){return+new Date}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static \u0275fac=function(i){return new(i||c)(d(u),d(B))};static \u0275cmp=l({type:c,selectors:[["cache-getting-started-simple"]],decls:23,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(i,t){i&1&&(n(0,"p"),r(1),C(2,"json"),s(),n(3,"div",0),r(4," Basic: "),n(5,"button",1),a("click",function(){return t.srv.set(t.key,t.newValue)}),r(6,"Set"),s(),n(7,"button",1),a("click",function(){return t.value=t.srv.getNone(t.key)}),r(8,"Get"),s(),n(9,"button",1),a("click",function(){return t.srv.remove(t.key)}),r(10,"Remove"),s(),n(11,"button",1),a("click",function(){return t.srv.clear()}),r(12,"Clear"),s()(),n(13,"div",0),r(14," Key is valid request: "),n(15,"button",1),a("click",function(){return t.getByHttp()}),r(16,"Get"),s()(),n(17,"div",0),r(18," Notify: "),n(19,"button",1),a("click",function(){return t.registerNotify()}),r(20,"Register"),s(),n(21,"button",1),a("click",function(){return t.unRegisterNotify()}),r(22,"UnRegister"),s()()),i&2&&(p(),b("value: ",S(2,1,t.value)))},dependencies:[x,z,k,_,N],encapsulation:2})};var $=class c{item={cols:1,urls:{"zh-CN":"packages/cache/docs/getting-started.md"},content:{"zh-CN":{content:`<section class="markdown"><h2 id="\u5199\u5728\u524D\u9762"><a class="lake-link"><i data-anchor="\u5199\u5728\u524D\u9762"></i></a>\u5199\u5728\u524D\u9762</h2><p>\u901A\u5E38\u628A\u4E00\u4E9B\u8FDC\u7A0B\u6570\u636E\u7F13\u5B58\u5728\u5185\u5B58\u6216 <code>localStorage</code> \u6301\u4E45\u5316\uFF0C\u76EE\u7684\u662F\u4E3A\u4E86\u51CF\u5C11 Http \u8BF7\u6C42\u7684\u6210\u672C\uFF1B\u8FD9\u6837\u7684\u6570\u636E\u901A\u5E38\u662F\u5B57\u5178\u3001\u57CE\u5E02\u6570\u636E\u7B49\u3002</p><p>\u7F13\u5B58\u7684\u83B7\u53D6\u5E94\u8BE5\u662F\u975E\u5E38\u7B80\u5355\u7684\uFF0C\u6211\u4EEC\u4E0D\u5E94\u8BE5\u628A\u65F6\u95F4\u6D6A\u8D39\u5728\u5982\u4F55\u4FDD\u8BC1\u52A0\u8F7D\u8FD9\u4EF6\u4E8B\u60C5\u4E0A\uFF0C\u56E0\u6B64 <code>@delon/cache</code> \u66F4\u591A\u662F\u4EE5<strong>\u7EA6\u5B9A</strong>\u4E3A\u524D\u63D0\u3002<code>key</code> \u4F5C\u4E3A\u7F13\u5B58\u7684\u552F\u4E00\u952E\u503C\uFF0C\u5B83\u4E0D\u5E94\u8BE5\u53EA\u662F\u5355\u7EAF\u7684\u4E00\u4E2A\u6807\u8BC6\u7B26\uFF0C\u5982\u679C\u9075\u5B88\u67D0\u79CD\u7EA6\u5B9A\u5B83\u7684\u5B58\u5728\u4F1A\u66F4\u6709\u4EF7\u503C\u3002<code>@delon/cache</code> \u9ED8\u8BA4\u60C5\u51B5\u4E0B\u4E0D\u5149\u628A <code>key</code> \u5F53\u4F5C\u552F\u4E00\u6807\u8BC6\u7B26\uFF0C\u540C\u65F6\u5B83\u8FD8\u662F\u4E00\u4E2A\u7528\u4E8E\u83B7\u53D6\u8FDC\u7A0B\u6570\u636E\u7684\u6709\u6548HTTP\uFF0C\u4F8B\u5982\uFF1A</p><pre class="hljs language-ts"><code>cacheService.get('/data/unit');</code></pre><p>\u5728\u4EE5\u5F80\u6211\u4EEC\u4F1A\u8BA4\u4E3A\uFF0C\u5728\u5B83\u4E4B\u524D\u5E94\u8BE5\u9700\u8981\u52A0\u4E00\u4E2A\uFF1A</p><pre class="hljs language-ts"><code>cacheService.set('/data/unit', [ '\u4E2A', '\u4EF6' ]);</code></pre><p>\u624D\u80FD\u591F\u786E\u4FDD\u83B7\u53D6\u5230\u7F13\u5B58\u6570\u636E\u3002</p><p>\u800C\u5BF9\u4E8E <code>@delon/cache</code> \u800C\u8A00\uFF0C\u4F60\u65E0\u987B <code>set</code> \u65B9\u6CD5\uFF0C\u76F4\u63A5\u4F7F\u7528 <code>get</code> \u83B7\u53D6\u5230\u5355\u4F4D\u5B57\u5178\uFF0C\u56E0\u4E3A\u6211\u4EEC\u6709\u4E00\u79CD<strong>\u7EA6\u5B9A</strong>\uFF0C\u5F53\u7F13\u5B58\u4E0D\u5B58\u5728\u900F\u8FC7 <code>key</code> \u4F5C\u4E3AHTTP\u8BF7\u6C42\u6570\u636E\u7F13\u5B58\u540E\u518D\u8FD4\u56DE\u3002</p><p>\u7F13\u5B58\u7684\u83B7\u53D6\u4E0E\u8BBE\u7F6E\u90FD\u662F\u901A\u8FC7 <a href="/cache/service" data-url="/cache/service">CacheService</a> \u6765\u64CD\u4F5C\uFF0C\u4F60\u53EA\u9700\u8981\u5C06 <code>CacheService</code> \u5BFC\u5165\u5BF9\u5E94\u7684\u7C7B\u5F53\u4E2D\u5373\u53EF\u3002</p><h2 id="\u5982\u4F55\u4F7F\u7528"><a class="lake-link"><i data-anchor="\u5982\u4F55\u4F7F\u7528"></i></a>\u5982\u4F55\u4F7F\u7528</h2><p><strong>\u5B89\u88C5</strong></p><pre class="hljs language-bash"><code>npm i -S @delon/cache</code></pre><h3 id="\u53C2\u6570"><a class="lake-link"><i data-anchor="\u53C2\u6570"></i></a>\u53C2\u6570</h3><table><thead><tr><th>\u6210\u5458</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th><th>\u5168\u5C40\u914D\u7F6E</th></tr></thead><tbody><tr><td><code>[mode]</code></td><td><code>promise,none</code></td><td><code>promise</code></td><td>\u7F13\u5B58\u6A21\u5F0F\uFF1B<code>promise</code> \u7EA6\u5B9A\u6A21\u5F0F\uFF0C\u5141\u8BB8 <code>key</code> \u4F5C\u4E3A http \u83B7\u53D6\u6570\u636E\uFF1B<code>none</code> \u6B63\u5E38\u6A21\u5F0F</td><td>\u2705</td></tr><tr><td><code>[reName]</code></td><td><code>string</code></td><td>-</td><td>\u91CD\u547D\u540D\u8FD4\u56DE\u53C2\u6570\uFF0C\u4F8B\u5982\uFF1A<br> <code>null</code> \u8FD4\u56DE\u4F53\u4E3A\u5185\u5BB9<br><code>list</code> \u8FD4\u56DE\u4F53\u5E94 <code>{ list: [] }</code><br><code>result.list</code> \u8FD4\u56DE\u4F53\u5E94 <code>{ result: { list: [] } }</code></td><td>\u2705</td></tr><tr><td><code>[expire]</code></td><td><code>number</code></td><td>-</td><td>\u8BBE\u7F6E\u9ED8\u8BA4\u8FC7\u671F\u65F6\u95F4\u503C\uFF08\u5355\u4F4D\uFF1A\u79D2\uFF09</td><td>\u2705</td></tr><tr><td><code>[prefix]</code></td><td><code>string</code></td><td>-</td><td>\u6301\u4E45\u5316\u6570\u636E\u952E\u503C\u524D\u7F00</td><td>\u2705</td></tr><tr><td><code>[meta_key]</code></td><td><code>string</code></td><td><code>__cache_meta</code></td><td>\u6301\u4E45\u5316\u6570\u636E\u5143\u6570\u636E\u5B58\u50A8\u952E\u540D</td><td>\u2705</td></tr><tr><td><code>[request]</code></td><td><code>(key: string) => Observable&lt;unknown></code></td><td>-</td><td>\u81EA\u5B9A\u4E49\u8BF7\u6C42\u4F53</td><td>\u2705</td></tr></tbody></table><blockquote><p>\u53EF\u4EE5\u901A\u8FC7<a href="/docs/global-config" data-url="/docs/global-config">\u5168\u5C40\u914D\u7F6E</a>\u8986\u76D6\u5B83\u4EEC\u3002</p></blockquote></section>`,meta:{order:1,title:"\u5F00\u59CB\u4F7F\u7528",type:"Documents"},toc:[{id:"\u5199\u5728\u524D\u9762",title:"\u5199\u5728\u524D\u9762",h:2},{id:"\u5982\u4F55\u4F7F\u7528",title:"\u5982\u4F55\u4F7F\u7528",h:2,children:[{id:"\u53C2\u6570",title:"\u53C2\u6570",h:3}]}]}},demo:!0};codes=[{id:"cache-getting-started-simple",meta:{title:{"zh-CN":"\u57FA\u7840\u6837\u4F8B","en-US":"Basic Usage"},order:0},summary:{"zh-CN":"<p>\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002</p>","en-US":"<p>Simplest of usage.</p>"},code:`import { JsonPipe } from '@angular/common';
...
}`,lang:"ts",componentName:"CacheGettingStartedSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}];static \u0275fac=function(i){return new(i||c)};static \u0275cmp=l({type:c,selectors:[["app-cache-getting-started"]],hostVars:2,hostBindings:function(i,t){i&2&&g("d-block","true")},decls:5,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(i,t){i&1&&(n(0,"app-docs",0)(1,"div",1)(2,"div",2)(3,"code-box",3),v(4,"cache-getting-started-simple"),s()()()()),i&2&&(m("codes",t.codes)("item",t.item),p(),m("nzGutter",16),p(2),m("item",t.codes[0]),y("id",t.codes[0].id))},dependencies:[E,G,w,D,T],encapsulation:2})};var R=class c{constructor(e,i){this.srv=e;this.msg=i}value;key="demo";notify$;get newValue(){return+new Date}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static \u0275fac=function(i){return new(i||c)(d(u),d(B))};static \u0275cmp=l({type:c,selectors:[["cache-interceptor-simple"]],decls:23,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(i,t){i&1&&(n(0,"p"),r(1),C(2,"json"),s(),n(3,"div",0),r(4," Basic: "),n(5,"button",1),a("click",function(){return t.srv.set(t.key,t.newValue)}),r(6,"Set"),s(),n(7,"button",1),a("click",function(){return t.value=t.srv.getNone(t.key)}),r(8,"Get"),s(),n(9,"button",1),a("click",function(){return t.srv.remove(t.key)}),r(10,"Remove"),s(),n(11,"button",1),a("click",function(){return t.srv.clear()}),r(12,"Clear"),s()(),n(13,"div",0),r(14," Key is valid request: "),n(15,"button",1),a("click",function(){return t.getByHttp()}),r(16,"Get"),s()(),n(17,"div",0),r(18," Notify: "),n(19,"button",1),a("click",function(){return t.registerNotify()}),r(20,"Register"),s(),n(21,"button",1),a("click",function(){return t.unRegisterNotify()}),r(22,"UnRegister"),s()()),i&2&&(p(),b("value: ",S(2,1,t.value)))},dependencies:[x,z,k,_,N],encapsulation:2})};var H=class c{item={cols:1,urls:{"zh-CN":"packages/cache/docs/interceptor.md"},content:{"zh-CN":{content:'<section class="markdown"><h1 id="\u5199\u5728\u524D\u9762">\u5199\u5728\u524D\u9762</h1><p>\u642D\u914D <code>httpCacheInterceptor</code> Http \u62E6\u622A\u5668\uFF0C\u53EF\u4EE5\u5C06\u7F13\u5B58\u5E94\u7528\u5230 Http \u8BF7\u6C42\u5F53\u4E2D\u3002\u5B83\u53EA\u6709\u51E0\u4E2A\u7279\u5F81\uFF1A</p><ul><li><p>\u652F\u6301\u7F13\u5B58\u8FC7\u671F\u65F6\u95F4</p></li><li><p>\u652F\u6301\u81EA\u5B9A\u4E49\u7F13\u5B58 KEY</p></li><li><p>\u652F\u6301\u4EFB\u4F55 Http \u8BF7\u6C42\u3001\u4EFB\u4F55\u6570\u636E\u683C\u5F0F</p></li><li><p>\u7B26\u5408 Http \u7F13\u5B58\u54CD\u5E94\u6807\u51C6 <code>Cache-Control</code></p></li></ul><h1 id="\u5982\u4F55\u4F7F\u7528">\u5982\u4F55\u4F7F\u7528</h1><p>\u5728 <code>withInterceptors</code> \u4E2D\u5F15\u5165 <code>httpCacheInterceptor</code>\uFF1A</p><pre class="hljs language-ts"><code>provideHttpClient(withInterceptors([httpCacheInterceptor]))</code></pre></section>',meta:{order:3,title:"Interceptor",type:"Documents"},toc:[{id:"\u5199\u5728\u524D\u9762",title:"\u5199\u5728\u524D\u9762",h:1},{id:"\u5982\u4F55\u4F7F\u7528",title:"\u5982\u4F55\u4F7F\u7528",h:1}]}},demo:!0};codes=[{id:"cache-interceptor-simple",meta:{title:{"zh-CN":"\u57FA\u7840\u6837\u4F8B","en-US":"Basic Usage"},order:0},summary:{"zh-CN":"<p>\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002</p>","en-US":"<p>Simplest of usage.</p>"},code:`import { JsonPipe } from '@angular/common';
import { Component, OnDestroy } from '@angular/core';
import { Subscription } from 'rxjs';
