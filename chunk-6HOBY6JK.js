...
}`,lang:"ts",componentName:"ChartBarBasicComponent",point:0,name:"basic",urls:"packages/chart/bar/demo/basic.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-bar"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
          `),l(6,"chart-bar-basic"),a(7,`
        `),c(),a(8,`
      `),c()()()),n&2&&(r("codes",o.codes)("item",o.item),m(1),r("nzGutter",16),m(3),r("item",o.codes[0]),u("id",o.codes[0].id))},dependencies:[y,b,g,x,Ft],encapsulation:2});let i=e;return i})();function Fe(i,e){i&1&&(a(0,`
        `),l(1,"i",4),a(2,`
...
export class ChartCardStyle3Component {}`,lang:"ts",componentName:"ChartCardStyle3Component",point:2,name:"style3",urls:"packages/chart/card/demo/style3.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-card"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:21,vars:9,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","12"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
...
export class ChartChartEchartsOnComponent {
  ...
  constructor(private msg: NzMessageService) {}
}`,lang:"ts",componentName:"ChartChartEchartsOnComponent",point:1,name:"on",urls:"packages/chart/chart-echarts/demo/on.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-chart-echarts"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:14,vars:7,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
  ...
  ngOnInit(): void {
    ...
    for (let i = 0; i < 20; i += 1) {
      ...
      `),c(),d(14,"div",2),a(15,`
        ...
        `),c(),a(20,`
      `),c()()()),n&2&&(r("codes",o.codes)("item",o.item),m(1),r("nzGutter",16),m(3),r("item",o.codes[0]),u("id",o.codes[0].id),m(5),r("item",o.codes[2]),u("id",o.codes[2].id),m(7),r("item",o.codes[1]),u("id",o.codes[1].id))},dependencies:[y,b,g,x,te,ee,ne],encapsulation:2});let i=e;return i})();var ie=(()=>{let e=class e{constructor(t){this.msg=t,this.visitData=this.genData()}genData(){let t=new Date().getTime(),n=[];for(let o=0;o<20;o+=1)n.push({x:E(new Date(t+1e3*60*60*24*o),"yyyy-MM-dd"),y:Math.floor(Math.random()*100)+10});return n}refresh(){this.visitData=this.genData()}handleClick(t){this.msg.info(`${t.item.x} - ${t.item.y}`)}};e.\u0275fac=function(n){return new(n||e)(M(T))},e.\u0275cmp=s({type:e,selectors:[["chart-mini-bar-basic"]],decls:6,vars:1,consts:[["nz-button","","nzType","primary",3,"click"],["height","45",3,"data","clickItem"]],template:function(n,o){n&1&&(a(0,`
    `),d(1,"button",0),C("click",function(){return o.refresh()}),a(2,"Refresh"),c(),a(3,`
...
}`,lang:"ts",componentName:"ChartMiniBarTooltipComponent",point:2,name:"tooltip",urls:"packages/chart/mini-bar/demo/tooltip.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-mini-bar"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:21,vars:9,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","12"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
...
export class ChartNumberInfoMultipleComponent {}`,lang:"ts",componentName:"ChartNumberInfoMultipleComponent",point:2,name:"multiple",urls:"packages/chart/number-info/demo/multiple.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-number-info"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:21,vars:9,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","12"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
      ...
      `),c(),d(14,"div",2),a(15,`
        ...
        `),c(),a(20,`
      `),c()()()),n&2&&(r("codes",o.codes)("item",o.item),m(1),r("nzGutter",16),m(3),r("item",o.codes[0]),u("id",o.codes[0].id),m(5),r("item",o.codes[2]),u("id",o.codes[2].id),m(7),r("item",o.codes[1]),u("id",o.codes[1].id))},dependencies:[y,b,g,x,pe,he,ue],encapsulation:2});let i=e;return i})();var dn=["pie"],ve=(()=>{let e=class e{constructor(t){this.msg=t,this.salesPieData=[],this.total="",this.refresh()}refresh(){let t=(n=0,o=5e3)=>Math.floor(Math.random()*(o-n+1)+n);this.salesPieData=[{x:"\u5BB6\u7528\u7535\u5668",y:t()},{x:"\u98DF\u7528\u9152\u6C34",y:t()},{x:"\u4E2A\u62A4\u5065\u5EB7",y:t()},{x:"\u670D\u9970\u7BB1\u5305",y:t()},{x:"\u6BCD\u5A74\u4EA7\u54C1",y:t()}],Math.random()>.5&&this.salesPieData.push({x:"\u5176\u4ED6",y:t()}),this.total=`&yen ${this.salesPieData.reduce((n,o)=>o.y+n,0).toFixed(2)}`,this.pie&&setTimeout(()=>this.pie.changeData())}format(t){return`&yen ${t.toFixed(2)}`}handleClick(t){this.msg.info(`${t.item.x} - ${t.item.y}`)}};e.\u0275fac=function(n){return new(n||e)(M(T))},e.\u0275cmp=s({type:e,selectors:[["chart-pie-basic"]],viewQuery:function(n,o){if(n&1&&lt(dn,5),n&2){let p;st(p=pt())&&(o.pie=p.first)}},decls:7,vars:4,consts:[["nz-button","","nzType","primary",3,"click"],["title","\u9500\u552E\u989D","subTitle","\u9500\u552E\u989D","height","294","repaint","false",3,"hasLegend","total","valueFormat","data","clickItem"],["pie",""]],template:function(n,o){n&1&&(a(0,`
    `),d(1,"button",0),C("click",function(){return o.refresh()}),a(2,"Refresh"),c(),a(3,`
    `),d(4,"g2-pie",1,2),C("clickItem",function(f){return o.handleClick(f)}),c(),a(6,`
  `)),n&2&&(m(4),r("hasLegend",!0)("total",o.total)("valueFormat",o.format)("data",o.salesPieData))},dependencies:[X,z,D,k],encapsulation:2});let i=e;return i})();var ge=(()=>{let e=class e{};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["chart-pie-mini"]],decls:6,vars:0,consts:[[2,"width","200px","display","inline-block"],["percent","28","subTitle","\u4E2D\u5F0F\u5FEB\u9910","total","28%","height","130"]],template:function(n,o){n&1&&(a(0,`
    `),d(1,"div",0),a(2,`
      `),l(3,"g2-pie",1),a(4,`
    `),c(),a(5,`
...
export class ChartPieMiniComponent {}`,lang:"ts",componentName:"ChartPieMiniComponent",point:1,name:"mini",urls:"packages/chart/pie/demo/mini.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-pie"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:14,vars:7,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
...
}`,lang:"ts",componentName:"ChartRadarBasicComponent",point:0,name:"basic",urls:"packages/chart/radar/demo/basic.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-radar"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
          `),l(6,"chart-radar-basic"),a(7,`
        `),c(),a(8,`
      `),c()()()),n&2&&(r("codes",o.codes)("item",o.item),m(1),r("nzGutter",16),m(3),r("item",o.codes[0]),u("id",o.codes[0].id))},dependencies:[y,b,g,x,be],encapsulation:2});let i=e;return i})();function ln(i,e){if(i&1&&(a(0,`
          `),d(1,"tr"),a(2,`
            `),d(3,"td"),a(4),c(),a(5,`
            `),d(6,"td"),a(7,`
...
export class ChartTimelineMaskComponent implements OnInit {
  ...
  handleClick(data: G2TimelineClickItem): void {
    this.msg.info(\`\u5BA2\u6D41\u91CF: \${data.item.y1}, \u652F\u4ED8\u7B14\u6570: \${data.item.y2}\`);
...
}`,lang:"ts",componentName:"ChartTimelineMaskComponent",point:2,name:"mask",urls:"packages/chart/timeline/demo/mask.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-timeline"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:19,vars:9,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
        ...
        `),c(),a(18,`
      `),c()()()),n&2&&(r("codes",o.codes)("item",o.item),m(1),r("nzGutter",16),m(3),r("item",o.codes[0]),u("id",o.codes[0].id),m(5),r("item",o.codes[1]),u("id",o.codes[1].id),m(5),r("item",o.codes[2]),u("id",o.codes[2].id))},dependencies:[y,b,g,x,Te,we,Ge],encapsulation:2});let i=e;return i})();var Be=(()=>{let e=class e{};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["chart-trend-basic"]],decls:7,vars:0,consts:[["flag","up"],["flag","down",1,"ml-sm"]],template:function(n,o){n&1&&(a(0,`
...
export class ChartTrendReverseComponent {}`,lang:"ts",componentName:"ChartTrendReverseComponent",point:1,name:"reverse",urls:"packages/chart/trend/demo/reverse.md",type:"demo"}]}};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["app-chart-trend"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block","true")},decls:14,vars:7,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,o){n&1&&(d(0,"app-docs",0)(1,"div",1)(2,"div",2),a(3,`
        `),d(4,"code-box",3),a(5,`
        ...
        `),c(),a(13,`
      `),c()()()),n&2&&(r("codes",o.codes)("item",o.item),m(1),r("nzGutter",16),m(3),r("item",o.codes[0]),u("id",o.codes[0].id),m(5),r("item",o.codes[1]),u("id",o.codes[1].id))},dependencies:[y,b,g,x,Be,Ee],encapsulation:2});let i=e;return i})();var Ne=(()=>{let e=class e{};e.\u0275fac=function(n){return new(n||e)},e.\u0275cmp=s({type:e,selectors:[["chart-water-wave-basic"]],hostVars:2,hostBindings:function(n,o){n&2&&v("d-block",!0)},decls:3,vars:3,consts:[[3,"title","percent","height"]],template:function(n,o){n&1&&(a(0,`
