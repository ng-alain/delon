import{a as Dt,b as Tt,c as nt}from"./chunk-Z2WO3Z4A.js";import{e as b,g as Nt,i as y}from"./chunk-OM4DM3K5.js";import"./chunk-FUBVCIOZ.js";import"./chunk-KP6LD5NC.js";import"./chunk-354SCS6Y.js";import{a as zt,b as xt}from"./chunk-WMK7B2EN.js";import"./chunk-3GRVA54L.js";import{a as N}from"./chunk-ISGKC3SX.js";import"./chunk-7VAZVM4R.js";import{a as w}from"./chunk-QPLJ63AM.js";import{a as Mt}from"./chunk-M3YRLNCS.js";import"./chunk-WRDJRDKD.js";import"./chunk-OH6GSKKG.js";import"./chunk-AY5GLEY5.js";import{s as F,t as z,u as x}from"./chunk-BTLIR5N7.js";import{I as dt,N as ot,R as S,d as kt,g as Ct,m as wt,v as Ft}from"./chunk-YMIRTON6.js";import{Ab as A,Bb as j,Cb as E,D as st,Db as K,Df as X,Eb as n,Ef as tt,Fb as ut,Ff as _,Gb as gt,Gf as R,If as U,J as lt,Ja as s,Jb as m,Kf as O,Ma as ht,O as P,Sa as L,Ta as C,Ua as a,Ub as $,Wa as k,X as mt,Z as pt,ab as G,ag as Z,fb as r,ga as g,gb as c,hb as u,hd as ft,ia as l,id as bt,k as at,kd as yt,lb as q,lg as St,ng as vt,oa as B,pa as V,pb as h,rb as W,s as I,ug as et,v as rt,w as ct}from"./chunk-T6QZOGIV.js";var It=(()=>{let t=class t{constructor(){this.modal=g(St),this.schema={properties:{name:{title:"Name",type:"string"}},required:["name"],ui:{spanLabelFixed:150,grid:{span:24}}}}save(o){this.modal.destroy(o)}close(){this.modal.destroy()}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["app-demo-dialog-modal"]],standalone:!0,features:[m],decls:20,vars:4,consts:[[1,"modal-header"],[1,"modal-title"],["mode","edit","button","none",3,"schema","formData"],["sf",""],[1,"modal-footer"],["nz-button","","type","button",3,"click"],["nz-button","","type","submit",3,"nzType","disabled","click"]],template:function(e,d){if(e&1){let p=q();n(0,`
    `),r(1,"div",0),n(2,`
...
export class FormConditionalVisibleIfComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.searchDepartment$.complete();
        ...
        `),c(),n(13,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id),s(5),a("item",d.codes[1]),C("id",d.codes[1].id))},dependencies:[w,N,Wt,Bt,x,z,F],encapsulation:2});let i=t;return i})();var id=["sf"],qt=(()=>{let t=class t{constructor(){this.msg=g(S),this.i18n=g(yt),this.schema=this.i18nSchema}get i18nSchema(){return{properties:{name:{type:"string",ui:{i18n:"sf.name",descriptionI18n:"sf.description",optionalHelp:{i18n:"sf.description"}}},password:{type:"string",title:this.i18n.fanyi("sf.name"),description:this.i18n.fanyi("sf.description"),ui:{type:"password"}}},required:["name","password"]}}changeLang(o){this.i18n.use(this.i18n.zone==="zh"?"en-US":"zh-CN"),o==="ref"&&this.comp.refreshSchema(this.i18nSchema)}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-i18n-simple"]],viewQuery:function(e,d){if(e&1&&A(id,7),e&2){let p;j(p=E())&&(d.comp=p.first)}},standalone:!0,features:[m],decls:10,vars:1,consts:[["nz-button","","type","button",3,"click"],[3,"schema","formSubmit"],["sf",""]],template:function(e,d){e&1&&(n(0,`
...
export class FormCheckboxSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,te,x,z,F],encapsulation:2});let i=t;return i})();var cd=["sf"];function sd(i,t){if(i&1){let M=q();n(0,`
        `),r(1,"div",4),n(2,`
          `),r(3,"div",5),n(4,`
      ...
      `)}if(i&2){let M=t.$implicit,o=t.ui;s(5),a("disabled",M.disabled)("nzSize",M.size)("ngModel",M.value),C("id",M.id)("disabled",M.disabled),s(6),ut(o.btnText)}}function ld(i,t){if(i&1&&(n(0,`
        `),u(1,"nz-qrcode",8),n(2,`
      `)),i&2){let M=t.$implicit;s(),a("nzValue",M.value)}}var de=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{formName:{type:"string",title:"Custom Title",ui:{widget:"custom",btnText:"Update Qr"},default:"test"},qr:{type:"string",ui:{widget:"custom"},default:"https://ng-alain.com"}}}}updateQr(){let o=this.sf.getProperty("/formName")?.value;this.sf.getProperty("/qr")?.setValue(o,!0),this.msg.info("Suc")}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-custom-simple"]],viewQuery:function(e,d){if(e&1&&A(cd,5),e&2){let p;j(p=E())&&(d.sf=p.first)}},standalone:!0,features:[m],decls:9,vars:1,consts:[[3,"schema","formSubmit"],["sf",""],["sf-template","formName"],["sf-template","qr"],["nz-row",""],["nz-col",""],["nz-input","",3,"disabled","nzSize","ngModel","ngModelChange"],["nz-button","","type","button","nzType","link",3,"click"],[3,"nzValue"]],template:function(e,d){e&1&&(n(0,`
    `),r(1,"sf",0,1),h("formSubmit",function(f){return d.submit(f)}),n(3,`
      `),L(4,sd,15,6,"ng-template",2),n(5,`
      `),L(6,ld,3,1,"ng-template",3),n(7,`
    `),c(),n(8,`
  `)),e&2&&(s(),a("schema",d.schema))},dependencies:[y,b,Nt,Ft,kt,Ct,wt,x,z,F,ot,dt,O,U,_,Tt,Dt],encapsulation:2});let i=t;return i})();var oe=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/src/widgets/custom/index.en-US.md","zh-CN":"packages/form/src/widgets/custom/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Custom the current dynamic form widget. For more complexity, please refer to <a href="/form/customize" data-url="/form/customize">customize</a> widget.</p><h2 id="Usage"><a class="lake-link"><i data-anchor="Usage"></i></a>Usage</h2><p>Make sure to specify <strong>sf-template</strong> a valid path value, for example:</p><pre class="hljs language-html"><code>&lt;sf&gt;
