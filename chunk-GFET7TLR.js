...
export class FormAclSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),r(),d(8,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,ce,w,k,x],encapsulation:2})};var le=class n{msg=u(b);schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string"},code:{type:"number"},name:{type:"string"},pwd:{type:"string",ui:{type:"password"}}},required:["login_type"],if:{properties:{login_type:{enum:["mobile"]}}},then:{required:["mobile","code"]},else:{required:["name","pwd"]}};submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-conditional-if"]],decls:3,vars:1,consts:[[3,"formSubmit","schema"]],template:function(e,t){e&1&&(d(0," "),a(1,"sf",0),m("formSubmit",function(p){return t.submit(p)}),r(),d(2," ")),e&2&&(c(),i("schema",t.schema))},dependencies:[f,g],encapsulation:2})};var oo=["sf"],me=class n{msg=u(b);sf;searchDepartment$=new It;schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string",description:"Try typing: ng-alain",ui:{changeDebounceTime:100,change:o=>{this.sf.getProperty("/department")?.updateFeedback("validating"),this.searchDepartment$.next(o)},visibleIf:{login_type:o=>o==="mobile"?{required:!0,show:!0}:null}}},code:{type:"number",ui:{visibleIf:{login_type:["mobile"]}}},type:{type:"string",title:"\u7C7B\u578B",enum:["\u5185\u7F51","\u5916\u7F51"],default:"\u5185\u7F51",ui:{widget:"select",visibleIf:{login_type:o=>o==="mobile"}}},department:{type:"string",title:"Department",default:"\u90E8\u95E81",ui:{widget:"select",visibleIf:{type:["\u5185\u7F51"]}}},remark:{type:"string",title:"Remark",ui:{visibleIf:{type:o=>o==="\u5185\u7F51"?{required:!0,show:!0}:null}}},adr:{type:"string",title:"Address",ui:{visibleIf:{type:o=>o==="\u5916\u7F51"?{required:!0,show:!0}:null}}},name:{type:"string",ui:{visibleIf:{login_type:["account"]}}},pwd:{type:"string",ui:{type:"password",visibleIf:{login_type:["account"]}}}},required:["login_type"],ui:{debug:!0}};ngOnInit(){let o=e=>T(e==="ng-alain"?new Array(5).fill(0).map((t,l)=>`NG-ALAIN\u90E8\u95E8${l+1}`):new Array(3).fill(0).map((t,l)=>`\u90E8\u95E8${l+1}`)).pipe(M(500),At(()=>[]));this.searchDepartment$.asObservable().pipe(Et(o)).subscribe(e=>{let t=this.sf.getProperty("/department");t.schema.enum=e,t.schema.default=e[0],t.widget.reset(e[0]),this.sf.getProperty("/department")?.updateFeedback()})}toggleMobile(o){this.sf.getProperty("/mobile")?.setVisible(o)?.widget?.detectChanges()}submit(o){this.msg.success(JSON.stringify(o))}ngOnDestroy(){this.searchDepartment$.complete()}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-conditional-visibleIf"]],viewQuery:function(e,t){if(e&1&&A(oo,7),e&2){let l;P(l=_())&&(t.sf=l.first)}},decls:10,vars:1,consts:[["sf",""],["type","button","nz-button","",3,"click"],[3,"formSubmit","schema"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"button",1),m("click",function(){return z(l),D(t.toggleMobile(!1))}),d(2,"Hide mobile"),r(),d(3,`
    `),a(4,"button",1),m("click",function(){return z(l),D(t.toggleMobile(!0))}),d(5,"Show mobile"),r(),d(6,`
    `),a(7,"sf",2,0),m("formSubmit",function(E){return z(l),D(t.submit(E))}),r(),d(9,`
...
export class FormConditionalVisibleIfComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.searchDepartment$.complete();
        ...
        `),r(),d(13,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id),c(5),i("item",t.codes[1]),C("id",t.codes[1].id))},dependencies:[F,le,me,w,k,x],encapsulation:2})};var no=["sf"],he=class n{msg=u(b);i18n=u(Bt);comp;schema=this.i18nSchema;get i18nSchema(){return{properties:{name:{type:"string",ui:{i18n:"sf.name",descriptionI18n:"sf.description",optionalHelp:{i18n:"sf.description"}}},password:{type:"string",title:this.i18n.fanyi("sf.name"),description:this.i18n.fanyi("sf.description"),ui:{type:"password"}}},required:["name","password"]}}changeLang(o){this.i18n.use(this.i18n.zone==="zh"?"en-US":"zh-CN"),o==="ref"&&this.comp.refreshSchema(this.i18nSchema)}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-i18n-simple"]],viewQuery:function(e,t){if(e&1&&A(no,7),e&2){let l;P(l=_())&&(t.comp=l.first)}},decls:10,vars:1,consts:[["sf",""],["nz-button","","type","button",3,"click"],[3,"formSubmit","schema"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"button",1),m("click",function(){return z(l),D(t.changeLang("srv"))}),d(2,"Change Language Via Service"),r(),d(3,`
    `),a(4,"button",1),m("click",function(){return z(l),D(t.changeLang("ref"))}),d(5,"Change Language Via call refresh schema"),r(),d(6,`
    `),a(7,"sf",2,0),m("formSubmit",function(E){return z(l),D(t.submit(E))}),r(),d(9,`
...
export class FormI18nSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),r(),d(8,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,he,w,k,x],encapsulation:2})};var io=["sf"],ge=class n{sf;msg=u(b);d$=u(Ut);schema={properties:{userName:{type:"string",title:"\u7528\u6237\u540D"},pwd:{type:"string",title:"\u5BC6\u7801"}},required:["userName","pwd"]};get userNameRequired(){return(this.sf.getProperty("/userName")?.parent?.schema.required??[]).includes("userName")}get userNameDisabled(){return this.sf.getProperty("/userName")?.schema?.readOnly===!0}toggleUserNameRequired(){this.sf.setRequired("/userName",!this.userNameRequired)}toggleUserNameDisabled(){this.sf.setDisabled("/userName",!this.userNameDisabled)}modifyUserNameValue(){this.sf.setValue("/userName",`Mock text ${+new Date}`)}getUserNameValue(){this.msg.info(this.sf.getValue("/userName"))}triggerUserNameAsyncStatus(){this.sf.updateFeedback("/userName","validating"),_t(1e3*2).pipe(Vt(this.d$)).subscribe(()=>{this.sf.updateFeedback("/userName","success")})}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-method-simple"]],viewQuery:function(e,t){if(e&1&&A(io,5),e&2){let l;P(l=_())&&(t.sf=l.first)}},decls:22,vars:1,consts:[["sf",""],[1,"mb-md"],["nz-button","",3,"click"],[3,"formSubmit","schema"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"p",1),d(2,`
      `),a(3,"button",2),m("click",function(){return z(l),D(t.getUserNameValue())}),d(4,"Get userName value"),r(),d(5,`
      `),a(6,"button",2),m("click",function(){return z(l),D(t.modifyUserNameValue())}),d(7,"Modify userName value"),r(),d(8,`
      `),a(9,"button",2),m("click",function(){return z(l),D(t.toggleUserNameRequired())}),d(10,"Toggle userName required"),r(),d(11,`
      `),a(12,"button",2),m("click",function(){return z(l),D(t.toggleUserNameDisabled())}),d(13,"Toggle userName disabled"),r(),d(14,`
      `),a(15,"button",2),m("click",function(){return z(l),D(t.triggerUserNameAsyncStatus())}),d(16,"userName async status"),r(),d(17,`
    `),r(),d(18,`
    `),a(19,"sf",3,0),m("formSubmit",function(E){return z(l),D(t.submit(E))}),r(),d(21,`
...
export class FormCheckboxSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),r(),d(8,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,we,w,k,x],encapsulation:2})};var ro=["sf"];function co(n,o){if(n&1){let e=I();d(0,`
        `),a(1,"div",4),d(2,`
          `),a(3,"div",5),d(4,`
            `),a(5,"input",6),m("ngModelChange",function(l){let p=z(e).$implicit;return D(p.setValue(l))}),r(),d(6,`
          `),r(),d(7,`
          `),a(8,"div",5),d(9,`
            `),a(10,"button",7),m("click",function(){z(e);let l=R();return D(l.updateQr())}),d(11),r(),d(12,`
          `),r(),d(13,`
        `),r(),d(14,`
      `)}if(n&2){let e=o.$implicit,t=o.ui;c(5),i("disabled",e.disabled)("nzSize",e.size)("ngModel",e.value),C("id",e.id)("disabled",e.disabled),c(6),Wt(t.btnText)}}function so(n,o){if(n&1&&(d(0,`
        `),h(1,"nz-qrcode",8),d(2,`
      `)),n&2){let e=o.$implicit;c(),i("nzValue",e.value)}}var Ne=class n{msg=u(b);sf;schema={properties:{formName:{type:"string",title:"Custom Title",ui:{widget:"custom",btnText:"Update Qr"},default:"test"},qr:{type:"string",ui:{widget:"custom"},default:"https://ng-alain.com"}}};updateQr(){let o=this.sf.getProperty("/formName")?.value;this.sf.getProperty("/qr")?.setValue(o,!0),this.msg.info("Suc")}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-custom-simple"]],viewQuery:function(e,t){if(e&1&&A(ro,5),e&2){let l;P(l=_())&&(t.sf=l.first)}},decls:9,vars:1,consts:[["sf",""],[3,"formSubmit","schema"],["sf-template","formName"],["sf-template","qr"],["nz-row",""],["nz-col",""],["nz-input","",3,"ngModelChange","disabled","nzSize","ngModel"],["nz-button","","type","button","nzType","link",3,"click"],[3,"nzValue"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"sf",1,0),m("formSubmit",function(E){return z(l),D(t.submit(E))}),d(3,`
      `),V(4,co,15,6,"ng-template",2),d(5,`
      `),V(6,so,3,1,"ng-template",3),d(7,`
    `),r(),d(8,`
  `)}e&2&&(c(),i("schema",t.schema))},dependencies:[f,g,Zt,$t,Lt,Jt,Gt,Kt,w,k,ee,X,W,U,j,eo,Xt],encapsulation:2})};var ze=class n{item={cols:1,urls:{"en-US":"packages/form/src/widgets/custom/index.en-US.md","zh-CN":"packages/form/src/widgets/custom/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Custom the current dynamic form widget. For more complexity, please refer to <a href="/form/customize" data-url="/form/customize">customize</a> widget.</p><h2 id="Usage"><a class="lake-link"><i data-anchor="Usage"></i></a>Usage</h2><p>Make sure to specify <strong>sf-template</strong> a valid path value, for example:</p><pre class="hljs language-html"><code>&lt;sf&gt;
...
export class FormNumberSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
      ...
      `),a(1,"sf",1),m("formSubmit",function(l){z(e);let p=R();return D(p.submit(l))}),r(),d(2,`
    `)}if(n&2){let e=R();c(),i("schema",e.schema)}}function po(n,o){if(n&1){let e=I();d(0,`
      `),a(1,"a",2),m("click",function(){z(e);let l=R();return D(l.msg.success("Success"))}),d(2,"More"),r(),d(3,`
    `)}}var Ae=class n{msg=u(b);extra;schema;ngOnInit(){this.schema={properties:{name:{type:"string"},age:{type:"number"},address1:{title:"\u5730\u57401",type:"object",properties:{country:{type:"string"},city:{type:"string"},zone:{type:"string"}},ui:{type:"card",cardExtra:this.extra}},address2:{title:"\u5730\u57402",type:"object",properties:{country:{type:"string"},city:{type:"string"},zone:{type:"string"}},ui:{type:"card",showExpand:!1}}},required:["name","age"],ui:{spanLabelFixed:150,grid:{span:12,gutter:16}}}}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-object-card"]],viewQuery:function(e,t){if(e&1&&A(lo,7),e&2){let l;P(l=_())&&(t.extra=l.first)}},decls:5,vars:1,consts:[["extra",""],[3,"formSubmit","schema"],[3,"click"]],template:function(e,t){e&1&&(d(0,`
    `),q(1,mo,3,1),V(2,po,4,0,"ng-template",null,0,J),d(4,`
