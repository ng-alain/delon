...
<pre><code class="language-txt">\u251C\u2500\u2500 _mock                                       # Mock Data rule
\u251C\u2500\u2500 src
\u2502\xA0\xA0 \u251C\u2500\u2500 app
...
<pre><code class="language-txt">\u251C\u2500\u2500 _mock                                       # Mock \u6570\u636E\u89C4\u5219\u76EE\u5F55
...
| **src/environments** | \u5E94\u7528\u73AF\u5883\u53D8\u91CF\uFF0C\u5305\u542B\u4EE5\u4E0B\u503C\uFF1A\`SERVER_URL\` \u6240\u6709HTTP\u8BF7\u6C42\u7684\u524D\u7F00\uFF1B\`production\` \u662F\u5426\u751F\u4EA7\u73AF\u5883\uFF1B\`useHash\` \u8DEF\u7531\u662F\u5426useHash\u6A21\u5F0F |`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-architecture`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var u=class n{item={name:`auth`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:40,title:`用户认证`,redirect:`/auth/getting-started`,description:``,group:`Advance`,path:`docs/auth.md`,url:`/docs/auth/zh`},text:``,api:``,toc:[],raw:`---
order: 40
title:
  en-US: Auth
  zh-CN: \u7528\u6237\u8BA4\u8BC1
...
---`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-auth`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var h=class n{item={name:`cache`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:70,title:`缓存`,redirect:`/cache/getting-started`,description:``,group:`Advance`,path:`docs/cache.md`,url:`/docs/cache/zh`},text:``,api:``,toc:[],raw:`---
order: 70
title:
  en-US: Cache
  zh-CN: \u7F13\u5B58
...
<li><strong>chart:</strong> migrate to &#64;antv/g2 v5 (<a href="https://github.com/ng-alain/delon/issues/2064" target="_blank" rel="noopener">#2064</a>) (<a href="https://github.com/ng-alain/delon/commit/d45f67028824318892d9fb744e78aa944d246e93" target="_blank" rel="noopener">d45f670</a>)</li>
</ul>
<h1 id="lessa_href=https//githubcom/ng-alain/delon/compare/21302200_target=_blank_rel=noopenergreater2200less/agreater_2026-09-11"><a class="lake-link"><i data-anchor="lessa_href=https//githubcom/ng-alain/delon/compare/21302200_target=_blank_rel=noopenergreater2200less/agreater_2026-09-11"></i></a><a href="https://github.com/ng-alain/delon/compare/21.3.0...22.0.0" target="_blank" rel="noopener">22.0.0</a> (2026-09-11)</h1><h3 id="bug_fixes"><a class="lake-link"><i data-anchor="bug_fixes"></i></a>Bug Fixes</h3><ul>
<li><strong>form:</strong> add nzId to sf-boolean widget (<a href="https://github.com/ng-alain/delon/issues/2053" target="_blank" rel="noopener">#2053</a>) (<a href="https://github.com/ng-alain/delon/commit/bd64da7cd27bfcb0a0b91b6f868016508142ec3b" target="_blank" rel="noopener">bd64da7</a>)</li>
<li><strong>theme:layout-default-nav:</strong> use stable track expression to avoid NG0956 (<a href="https://github.com/ng-alain/delon/issues/2041" target="_blank" rel="noopener">#2041</a>) (<a href="https://github.com/ng-alain/delon/commit/ff343b60f76b9502926f1328dbc56232f6eda168" target="_blank" rel="noopener">ff343b6</a>)</li>
</ul>
<h3 id="features"><a class="lake-link"><i data-anchor="features"></i></a>Features</h3><ul>
<li><strong>form:</strong> align sf widgets API with ng-zorro v22 (<a href="https://github.com/ng-alain/delon/issues/2052" target="_blank" rel="noopener">#2052</a>) (<a href="https://github.com/ng-alain/delon/commit/085e8db79f2b471eb7587c41c234be7ab78fdaa3" target="_blank" rel="noopener">085e8db</a>)</li>
<li><strong>sf:number-widget:</strong> add support for <code>nzChangeOnWheel</code> (<a href="https://github.com/ng-alain/delon/commit/7623196c986a38a39790a3a54edcb59c368db606" target="_blank" rel="noopener">7623196</a>)</li>
...
<h3 id="features"><a class="lake-link"><i data-anchor="features"></i></a>Features</h3><ul>
<li><strong>chart:</strong> \u8FC1\u79FB\u5230 <code>&#64;antv/g2</code> v5 (<a href="https://github.com/ng-alain/delon/issues/2064" target="_blank" rel="noopener">#2064</a>) (<a href="https://github.com/ng-alain/delon/commit/d45f67028824318892d9fb744e78aa944d246e93" target="_blank" rel="noopener">d45f670</a>)</li>
</ul>
<h1 id="lessa_href=https//githubcom/ng-alain/delon/compare/21302200_target=_blank_rel=noopenergreater2200less/agreater_2026-09-11"><a class="lake-link"><i data-anchor="lessa_href=https//githubcom/ng-alain/delon/compare/21302200_target=_blank_rel=noopenergreater2200less/agreater_2026-09-11"></i></a><a href="https://github.com/ng-alain/delon/compare/21.3.0...22.0.0" target="_blank" rel="noopener">22.0.0</a> (2026-09-11)</h1><h3 id="bug_fixes"><a class="lake-link"><i data-anchor="bug_fixes"></i></a>Bug Fixes</h3><ul>
<li><strong>form:</strong> \u4E3A sf-boolean \u7EC4\u4EF6\u65B0\u589E <code>nzId</code> (<a href="https://github.com/ng-alain/delon/issues/2053" target="_blank" rel="noopener">#2053</a>) (<a href="https://github.com/ng-alain/delon/commit/bd64da7cd27bfcb0a0b91b6f868016508142ec3b" target="_blank" rel="noopener">bd64da7</a>)</li>
<li><strong>theme:layout-default-nav:</strong> \u4F7F\u7528\u7A33\u5B9A\u7684 track \u8868\u8FBE\u5F0F\u907F\u514D <code>NG0956</code> (<a href="https://github.com/ng-alain/delon/issues/2041" target="_blank" rel="noopener">#2041</a>) (<a href="https://github.com/ng-alain/delon/commit/ff343b60f76b9502926f1328dbc56232f6eda168" target="_blank" rel="noopener">ff343b6</a>)</li>
</ul>
<h3 id="features"><a class="lake-link"><i data-anchor="features"></i></a>Features</h3><ul>
<li><strong>form:</strong> \u5BF9\u9F50 sf \u7EC4\u4EF6 API \u4E0E ng-zorro v22 (<a href="https://github.com/ng-alain/delon/issues/2052" target="_blank" rel="noopener">#2052</a>) (<a href="https://github.com/ng-alain/delon/commit/085e8db79f2b471eb7587c41c234be7ab78fdaa3" target="_blank" rel="noopener">085e8db</a>)</li>
<li><strong>sf:number-widget:</strong> \u65B0\u589E\u652F\u6301 <code>nzChangeOnWheel</code> (<a href="https://github.com/ng-alain/delon/commit/7623196c986a38a39790a3a54edcb59c368db606" target="_blank" rel="noopener">7623196</a>)</li>
...
All releases notes can be found [here](https://github.com/ng-alain/ng-alain/releases).`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-changelog`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var m=class n{item={name:`cli`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:10,title:`命令行工具`,redirect:`/cli/getting-started`,description:``,group:`Other`,path:`docs/cli.md`,url:`/docs/cli/zh`},text:``,api:``,toc:[],raw:`---
order: 10
title:
  en-US: Cli
  zh-CN: \u547D\u4EE4\u884C\u5DE5\u5177
...
---`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-cli`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var f=class n{item={name:`contributing`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:40,title:`Contributing`,description:`The following is a set of guidelines for contributing to ng-alain. Please spend several minutes in reading these guidelines before you create an issue...`,group:`Other`,path:`docs/contributing.en-US.md`,url:`/docs/contributing/en`},text:`<p>The following is a set of guidelines for contributing to ng-alain. Please spend several minutes in reading these guidelines before you create an issue or pull request.</p>
...
<p><img src="./assets/screenshot/bundle-size.png" alt="Bundle Size"></p>
...
<pre><code class="language-yaml">- 443:443
</code></pre>
...
\u53C2\u8003 [Angular \u5BB9\u5668\u90E8\u7F72](https://zhuanlan.zhihu.com/p/35688938)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-deploy`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var y=class n{item={name:`faq`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:20,title:`FAQ`,description:`Please check the FAQ below before asking questions.Common mistakes under Angular, this article will help you understand why.Common mistakes under Angu...`,group:`Other`,path:`docs/faq.en-US.md`,url:`/docs/faq/en`},text:`<p>Please check the FAQ below before asking questions.</p>
...
<p><img src="./assets/screenshot/desktop.png" alt="Desktop" width="700" loading="lazy"></p>
...
<p><img src="./assets/screenshot/start.png" alt="Start" width="700" loading="lazy"></p>
...
![Donate](./assets/donate.png)`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-getting-started`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var v=class n{item={name:`global-config`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:90,title:`Global Configuration`,description:`We add support of global configuration to many components. You can define the default behavior of the component through global configuration, thus red...`,group:`Dev`,path:`docs/global-config.en-US.md`,url:`/docs/global-config/en`},text:`<p>We add support of <strong>global configuration</strong> to many components. You can define the default behavior of the component through global configuration, thus reducing the code that needs to be written in the template, and support changing global config at runtime.</p>
...
\u8BF7\u53C2\u8003 NG-ZORRO [\u5B98\u7F51\u6587\u6863](https://ng.ant.design/docs/global-config/zh)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-global-config`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var A=class n{item={name:`graph`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:20,title:`图表`,redirect:`/chart/getting-started`,description:``,group:`Advance`,path:`docs/graph.md`,url:`/docs/graph/zh`},text:``,api:``,toc:[],raw:`---
order: 20
title:
  en-US: Charts
  zh-CN: \u56FE\u8868
...
---`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-graph`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var _=class n{item={name:`how-to-start`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:0,title:`How to start`,i18n:`need-update`,description:`As you begin your business development on NG-ALAIN, i recommend that you first review the following documents, which is very helpful for everyone on t...`,group:`Dev`,path:`docs/how-to-start.en-US.md`,url:`/docs/how-to-start/en`},text:`<h2 id="first,_pre-order_preparation"><a class="lake-link"><i data-anchor="first,_pre-order_preparation"></i></a>First, pre-order preparation</h2><p>As you begin your business development on NG-ALAIN, i recommend that you first review the following documents, which is very helpful for everyone on the team.</p>
<ul>
...
<li><a href="https://g2.antv.antgroup.com/en/" target="_blank" rel="noopener">Antv chart - G2</a></li>
...
+ [Antv chart - G2](https://g2.antv.antgroup.com/en/)
...
<li><a href="https://g2.antv.antgroup.com/" target="_blank" rel="noopener">G2 \u56FE\u8868\u4E2D\u6587\u6587\u6863</a>\uFF0C\u5982\u679C\u9700\u8981\u56FE\u8868\u5F00\u53D1\uFF0C\u5219\u8FD9\u4EFD\u6587\u6863\u662F\u5FC5\u5907</li>
</ul>
</li>
<li>\u8F85\u52A9\u7C7B<ul>
...
- [NG-ALAIN Snippets](https://marketplace.visualstudio.com/items?itemName=cipchk.ng-alain-vscode)`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-how-to-start`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var w=class n{item={name:`i18n`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:30,title:`I18n`,description:`Angular internationalization provides a solution for extracting language files, but for NG-ALAIN, this is not the best way; this is mainly limited by ...`,group:`Advance`,path:`docs/i18n.en-US.md`,url:`/docs/i18n/en`},text:`<p>Angular internationalization provides a solution for extracting language files, but for NG-ALAIN, this is not the best way; this is mainly limited by &#64;Delon/* The component library needs to provide a set of dynamic translation Service, therefore, NG-ALAIN has built-in a simple internationalized service <code>ALAIN_I18N_TOKEN</code> interface.</p>
...
> \u5176\u4E2D \`:i18n\` \u662F\u53C2\u6570\u56FA\u5B9A\u503C\uFF0C\u53EF\u4EE5\u901A\u8FC7[\u5168\u5C40\u914D\u7F6E](/docs/global-config) \`paramNameOfUrlGuard\` \u6765\u8C03\u6574\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-i18n`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var N=class n{item={name:`import`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:60,title:`Use a third-party lib`,description:`In addition to the NG-ALAIN base component and the @delon business component, sometimes we need to reference other external class libraries, the follo...`,group:`Dev`,path:`docs/import.en-US.md`,url:`/docs/import/en`},text:`<p>In addition to the NG-ALAIN base component and the &#64;delon business component, sometimes we need to reference other external class libraries, the following is how to use the rich text component <a href="https://github.com/cipchk/ngx-tinymce" target="_blank" rel="noopener">ngx-tinymce</a>:</p>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-import`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var I=class n{item={name:`llms`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`LLMs.txt`,tag:`New`,group:`AI`,description:`This guide explains how to enable AI tools to better understand @delon/*.We support LLMs.txt files for making the @delon/* documentation available to ...`,path:`docs/llms.en-US.md`,url:`/docs/llms/en`},text:`<p>This guide explains how to enable AI tools to better understand &#64;delon/*.</p>
...
**\u5E94** \u53EA\u5305\u62EC\u8DEF\u7531\u7684 \`import\`\u3001\`exports\` \u6A21\u5757\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-module`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var S=class n{item={name:`new-component`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:20,title:`New Component`,description:`For some functional modules that may be referenced in multiple places, it is recommended to refine the management into unified management of business ...`,group:`Dev`,path:`docs/new-component.en-US.md`,url:`/docs/new-component/en`},text:`<p>For some functional modules that may be referenced in multiple places, it is recommended to refine the management into unified management of business components. These components generally have the following characteristics:</p>
<ul>
...
\u5F85 NG-ALAIN \u63D0\u4F9B\u66F4\u597D\u7684\u4F18\u5316\u652F\u6301\u540E\uFF0C\u6211\u4EEC\u4F1A\u53D1\u5E03 [#684](https://github.com/ng-alain/ng-alain/pull/684) \u5E0C\u671B\u5BF9\u5305\u4F53\u5927\u5C0F\u6709\u66F4\u597D\u7684\u671F\u671B\u7ED3\u679C\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-performance`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var M=class n{item={name:`server`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:40,title:`Work with Server`,description:`NG-ALAIN is a single-page application based on the Angular technology stack. We provide development models for front-end code and native analog data.
...
<pre><code class="language-txt">Access to XMLHttpRequest at &#39;http://192.168.1.100/api/app&#39; from origin &#39;http://localhost:4200&#39; has been blocked by CORS policy: No &#39;Access-Control-Allow-Origin&#39; header is present on the requested resource.
</code></pre>
...
\u4ECE Angular13 \u5F00\u59CB\u8FDC\u7A0B\u8BF7\u6C42\u7684\u8C03\u8BD5\u65E5\u5FD7\u5C06\u4E0D\u518D\u7EC8\u7AEF\u4E2D\u663E\u793A\uFF0C\u82E5\u6709\u663E\u793A\u65E5\u671F\u9700\u6C42\uFF0C\u53EF\u81EA\u884C\u53C2\u8003 [How to fix logging for proxy in angular](https://medium.com/@gagandeep.sidhu88/how-to-fix-logging-for-proxy-in-angular-834cf46d437d) \u89E3\u51B3\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-server`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var z=class n{item={name:`ssr`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:110,title:`服务端渲染（SSR）`,description:`本文描述的是 NG-ALAIN 如何支持服务端渲染（SSR）。NG-ALAIN 不推荐在中后台使用服务端渲染（SSR），这是因为中后台本身对于SSR所带来的好处远大于开发带来的麻烦，但不管怎么样在许多人的要求下，从 9.5 版本开始，已经对所有 @delon/* 类库支持服务端渲染。在开始之前请先阅...`,group:`Dev`,path:`docs/ssr.md`,url:`/docs/ssr/zh`},text:`<p>\u672C\u6587\u63CF\u8FF0\u7684\u662F NG-ALAIN \u5982\u4F55\u652F\u6301\u670D\u52A1\u7AEF\u6E32\u67D3\uFF08SSR\uFF09\u3002</p>
<blockquote>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-ssr`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var R=class n{item={name:`style-guide`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:90,title:`Style Guide`,description:`The project built by Angular CLI is already very good in terms of its directory structure. Official website also has an Angular Style Guide (Chinese v...`,group:`Advance`,path:`docs/style-guide.en-US.md`,url:`/docs/style-guide/en`},text:`<p>The project built by Angular CLI is already very good in terms of its directory structure. Official website also has an <a href="https://angular.io/guide/styleguide" target="_blank" rel="noopener">Angular Style Guide</a> (<a href="https://angular.cn/guide/styleguide" target="_blank" rel="noopener">Chinese version</a>) Style guide. It is recommended to read it several times. In addition, NG-ALAIN also has a part of the coding style, the following instructions may be useful for reading the code.</p>
...
vscode \u662F\u7F16\u5199 Angular \u6700\u4F73\u7684\u9009\u62E9\uFF0C\u81EA\u7136 NG-ALAIN \u4E5F\u5236\u4F5C\u4E86\u76F8\u5E94 snippets \u6269\u5C55\u63D2\u4EF6\uFF1A[ng-zorro-vscode](//marketplace.visualstudio.com/items?itemName=cipchk.ng-zorro-vscode) \u548C [ng-alain-vscode](//marketplace.visualstudio.com/items?itemName=cipchk.ng-alain-vscode)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-style-guide`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var T=class n{item={name:`theme`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:10,title:`主题系统`,redirect:`/theme/getting-started`,description:``,group:`Advance`,path:`docs/theme.md`,url:`/docs/theme/zh`},text:``,api:``,toc:[],raw:`---
order: 10
title:
  en-US: Theme
  zh-CN: \u4E3B\u9898\u7CFB\u7EDF
...
---`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-theme`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var G=class n{item={name:`upgrade-v22`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1e3,title:`Upgrade to version 22.0`,description:`This guide applies to the current version of NG-ALAIN >= 21;
...
- \u4EE3\u7801\u98CE\u683C\u914D\u7F6E\u53D8\u66F4 [#2636](https://github.com/ng-alain/ng-alain/pull/2636/files)`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`docs-upgrade-v22`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var q=class n{item={name:`upgrade`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:80,title:`Upgrade scaffold`,description:`In Architecture we have described the overall composition of the NG-ALAIN scaffolding. We spent a lot of time developing some infrastructure and publi...`,group:`Dev`,path:`docs/upgrade.en-US.md`,url:`/docs/upgrade/en`},text:`<p>In <a href="/docs/architecture">Architecture</a> we have described the overall composition of the NG-ALAIN scaffolding. We spent a lot of time developing some infrastructure and publishing these to the <code>&#64;delon/*</code> series to Npm. , making the upgrade very easy.</p>
...
<pre><code class="language-json">&quot;&#64;delon/theme&quot;: &quot;^12.0.0&quot;
</code></pre>
