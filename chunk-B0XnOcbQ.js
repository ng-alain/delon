...
\u8BF7\u53C2\u8003 NG-ZORRO [\u5B98\u7F51\u6587\u6863](https://ng.ant.design/docs/global-config/zh)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-global-config`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var _=class n{item={name:`graph`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:20,title:`图表`,redirect:`/chart/getting-started`,description:``,group:`Advance`,path:`docs/graph.md`,url:`/docs/graph/zh`},text:``,api:``,toc:[],raw:`---
order: 20
title:
  en-US: Charts
  zh-CN: \u56FE\u8868
...
- [NG-ALAIN Snippets](https://marketplace.visualstudio.com/items?itemName=cipchk.ng-alain-vscode)`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-how-to-start`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var w=class n{item={name:`i18n`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:30,title:`I18n`,description:`Angular internationalization provides a solution for extracting language files, but for NG-ALAIN, this is not the best way; this is mainly limited by ...`,group:`Advance`,path:`docs/i18n.en-US.md`,url:`/docs/i18n/en`},text:`<p>Angular internationalization provides a solution for extracting language files, but for NG-ALAIN, this is not the best way; this is mainly limited by &#64;Delon/* The component library needs to provide a set of dynamic translation Service, therefore, NG-ALAIN has built-in a simple internationalized service <code>ALAIN_I18N_TOKEN</code> interface.</p>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-ssr`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var T=class n{item={name:`style-guide`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:90,title:`Style Guide`,description:`The project built by Angular CLI is already very good in terms of its directory structure. Official website also has an Angular Style Guide (Chinese v...`,group:`Advance`,path:`docs/style-guide.en-US.md`,url:`/docs/style-guide/en`},text:`<p>The project built by Angular CLI is already very good in terms of its directory structure. Official website also has an <a href="https://angular.io/guide/styleguide" target="_blank" rel="noopener">Angular Style Guide</a> (<a href="https://angular.cn/guide/styleguide" target="_blank" rel="noopener">Chinese version</a>) Style guide. It is recommended to read it several times. In addition, NG-ALAIN also has a part of the coding style, the following instructions may be useful for reading the code.</p>
