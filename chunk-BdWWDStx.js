...
| **src/environments** | \u5E94\u7528\u73AF\u5883\u53D8\u91CF\uFF0C\u5305\u542B\u4EE5\u4E0B\u503C\uFF1A\`SERVER_URL\` \u6240\u6709HTTP\u8BF7\u6C42\u7684\u524D\u7F00\uFF1B\`production\` \u662F\u5426\u751F\u4EA7\u73AF\u5883\uFF1B\`useHash\` \u8DEF\u7531\u662F\u5426useHash\u6A21\u5F0F |`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-architecture`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var u=class n{item={name:`auth`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:40,title:`用户认证`,redirect:`/auth/getting-started`,description:``,group:`Advance`,path:`docs/auth.md`,url:`/docs/auth/zh`},text:``,api:``,toc:[],raw:`---
order: 40
title:
  en-US: Auth
  zh-CN: \u7528\u6237\u8BA4\u8BC1
...
---`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-auth`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var h=class n{item={name:`cache`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:70,title:`缓存`,redirect:`/cache/getting-started`,description:``,group:`Advance`,path:`docs/cache.md`,url:`/docs/cache/zh`},text:``,api:``,toc:[],raw:`---
order: 70
title:
  en-US: Cache
  zh-CN: \u7F13\u5B58
...
All releases notes can be found [here](https://github.com/ng-alain/ng-alain/releases).`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-changelog`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var m=class n{item={name:`cli`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:10,title:`命令行工具`,redirect:`/cli/getting-started`,description:``,group:`Other`,path:`docs/cli.md`,url:`/docs/cli/zh`},text:``,api:``,toc:[],raw:`---
order: 10
title:
  en-US: Cli
  zh-CN: \u547D\u4EE4\u884C\u5DE5\u5177
...
---`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-cli`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var f=class n{item={name:`contributing`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:40,title:`Contributing`,description:`The following is a set of guidelines for contributing to ng-alain. Please spend several minutes in reading these guidelines before you create an issue...`,group:`Other`,path:`docs/contributing.en-US.md`,url:`/docs/contributing/en`},text:`<p>The following is a set of guidelines for contributing to ng-alain. Please spend several minutes in reading these guidelines before you create an issue or pull request.</p>
...
\u53C2\u8003 [Angular \u5BB9\u5668\u90E8\u7F72](https://zhuanlan.zhihu.com/p/35688938)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-deploy`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var y=class n{item={name:`faq`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:20,title:`FAQ`,description:`Please check the FAQ below before asking questions.Common mistakes under Angular, this article will help you understand why.Common mistakes under Angu...`,group:`Other`,path:`docs/faq.en-US.md`,url:`/docs/faq/en`},text:`<p>Please check the FAQ below before asking questions.</p>
...
![Donate](./assets/donate.png)`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-getting-started`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var v=class n{item={name:`global-config`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:90,title:`Global Configuration`,description:`We add support of global configuration to many components. You can define the default behavior of the component through global configuration, thus red...`,group:`Dev`,path:`docs/global-config.en-US.md`,url:`/docs/global-config/en`},text:`<p>We add support of <strong>global configuration</strong> to many components. You can define the default behavior of the component through global configuration, thus reducing the code that needs to be written in the template, and support changing global config at runtime.</p>
...
\u8BF7\u53C2\u8003 NG-ZORRO [\u5B98\u7F51\u6587\u6863](https://ng.ant.design/docs/global-config/zh)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-global-config`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var A=class n{item={name:`graph`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:20,title:`图表`,redirect:`/chart/getting-started`,description:``,group:`Advance`,path:`docs/graph.md`,url:`/docs/graph/zh`},text:``,api:``,toc:[],raw:`---
order: 20
title:
  en-US: Charts
  zh-CN: \u56FE\u8868
...
---`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-graph`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var w=class n{item={name:`how-to-start`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:0,title:`How to start`,i18n:`need-update`,description:`As you begin your business development on NG-ALAIN, i recommend that you first review the following documents, which is very helpful for everyone on t...`,group:`Dev`,path:`docs/how-to-start.en-US.md`,url:`/docs/how-to-start/en`},text:`<h2 id="first,_pre-order_preparation"><a class="lake-link"><i data-anchor="first,_pre-order_preparation"></i></a>First, pre-order preparation</h2><p>As you begin your business development on NG-ALAIN, i recommend that you first review the following documents, which is very helpful for everyone on the team.</p>
<ul>
...
- [NG-ALAIN Snippets](https://marketplace.visualstudio.com/items?itemName=cipchk.ng-alain-vscode)`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-how-to-start`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var _=class n{item={name:`i18n`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:30,title:`I18n`,description:`Angular internationalization provides a solution for extracting language files, but for NG-ALAIN, this is not the best way; this is mainly limited by ...`,group:`Advance`,path:`docs/i18n.en-US.md`,url:`/docs/i18n/en`},text:`<p>Angular internationalization provides a solution for extracting language files, but for NG-ALAIN, this is not the best way; this is mainly limited by &#64;Delon/* The component library needs to provide a set of dynamic translation Service, therefore, NG-ALAIN has built-in a simple internationalized service <code>ALAIN_I18N_TOKEN</code> interface.</p>
...
> \u5176\u4E2D \`:i18n\` \u662F\u53C2\u6570\u56FA\u5B9A\u503C\uFF0C\u53EF\u4EE5\u901A\u8FC7[\u5168\u5C40\u914D\u7F6E](/docs/global-config) \`paramNameOfUrlGuard\` \u6765\u8C03\u6574\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-i18n`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var N=class n{item={name:`import`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:60,title:`Use a third-party lib`,description:`In addition to the NG-ALAIN base component and the @delon business component, sometimes we need to reference other external class libraries, the follo...`,group:`Dev`,path:`docs/import.en-US.md`,url:`/docs/import/en`},text:`<p>In addition to the NG-ALAIN base component and the &#64;delon business component, sometimes we need to reference other external class libraries, the following is how to use the rich text component <a href="https://github.com/cipchk/ngx-tinymce" target="_blank" rel="noopener">ngx-tinymce</a>:</p>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-import`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var I=class n{item={name:`llms`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:1,title:`LLMs.txt`,tag:`New`,group:`AI`,description:`This guide explains how to enable AI tools to better understand @delon/*.We support LLMs.txt files for making the @delon/* documentation available to ...`,path:`docs/llms.en-US.md`,url:`/docs/llms/en`},text:`<p>This guide explains how to enable AI tools to better understand &#64;delon/*.</p>
...
**\u5E94** \u53EA\u5305\u62EC\u8DEF\u7531\u7684 \`import\`\u3001\`exports\` \u6A21\u5757\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-module`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var S=class n{item={name:`new-component`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:20,title:`New Component`,description:`For some functional modules that may be referenced in multiple places, it is recommended to refine the management into unified management of business ...`,group:`Dev`,path:`docs/new-component.en-US.md`,url:`/docs/new-component/en`},text:`<p>For some functional modules that may be referenced in multiple places, it is recommended to refine the management into unified management of business components. These components generally have the following characteristics:</p>
<ul>
...
\u5F85 NG-ALAIN \u63D0\u4F9B\u66F4\u597D\u7684\u4F18\u5316\u652F\u6301\u540E\uFF0C\u6211\u4EEC\u4F1A\u53D1\u5E03 [#684](https://github.com/ng-alain/ng-alain/pull/684) \u5E0C\u671B\u5BF9\u5305\u4F53\u5927\u5C0F\u6709\u66F4\u597D\u7684\u671F\u671B\u7ED3\u679C\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-performance`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var z=class n{item={name:`server`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:40,title:`Work with Server`,description:`NG-ALAIN is a single-page application based on the Angular technology stack. We provide development models for front-end code and native analog data.
...
\u4ECE Angular13 \u5F00\u59CB\u8FDC\u7A0B\u8BF7\u6C42\u7684\u8C03\u8BD5\u65E5\u5FD7\u5C06\u4E0D\u518D\u7EC8\u7AEF\u4E2D\u663E\u793A\uFF0C\u82E5\u6709\u663E\u793A\u65E5\u671F\u9700\u6C42\uFF0C\u53EF\u81EA\u884C\u53C2\u8003 [How to fix logging for proxy in angular](https://medium.com/@gagandeep.sidhu88/how-to-fix-logging-for-proxy-in-angular-834cf46d437d) \u89E3\u51B3\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-server`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var M=class n{item={name:`ssr`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:110,title:`服务端渲染（SSR）`,description:`本文描述的是 NG-ALAIN 如何支持服务端渲染（SSR）。NG-ALAIN 不推荐在中后台使用服务端渲染（SSR），这是因为中后台本身对于SSR所带来的好处远大于开发带来的麻烦，但不管怎么样在许多人的要求下，从 9.5 版本开始，已经对所有 @delon/* 类库支持服务端渲染。在开始之前请先阅...`,group:`Dev`,path:`docs/ssr.md`,url:`/docs/ssr/zh`},text:`<p>\u672C\u6587\u63CF\u8FF0\u7684\u662F NG-ALAIN \u5982\u4F55\u652F\u6301\u670D\u52A1\u7AEF\u6E32\u67D3\uFF08SSR\uFF09\u3002</p>
<blockquote>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-ssr`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var R=class n{item={name:`style-guide`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:90,title:`Style Guide`,description:`The project built by Angular CLI is already very good in terms of its directory structure. Official website also has an Angular Style Guide (Chinese v...`,group:`Advance`,path:`docs/style-guide.en-US.md`,url:`/docs/style-guide/en`},text:`<p>The project built by Angular CLI is already very good in terms of its directory structure. Official website also has an <a href="https://angular.io/guide/styleguide" target="_blank" rel="noopener">Angular Style Guide</a> (<a href="https://angular.cn/guide/styleguide" target="_blank" rel="noopener">Chinese version</a>) Style guide. It is recommended to read it several times. In addition, NG-ALAIN also has a part of the coding style, the following instructions may be useful for reading the code.</p>
...
vscode \u662F\u7F16\u5199 Angular \u6700\u4F73\u7684\u9009\u62E9\uFF0C\u81EA\u7136 NG-ALAIN \u4E5F\u5236\u4F5C\u4E86\u76F8\u5E94 snippets \u6269\u5C55\u63D2\u4EF6\uFF1A[ng-zorro-vscode](//marketplace.visualstudio.com/items?itemName=cipchk.ng-zorro-vscode) \u548C [ng-alain-vscode](//marketplace.visualstudio.com/items?itemName=cipchk.ng-alain-vscode)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=_e({type:n,selectors:[[`docs-style-guide`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,t.codes)(`item`,t.item)},dependencies:[rt],encapsulation:2})};var T=class n{item={name:`theme`,langs:[`zh-CN`],content:{"zh-CN":{meta:{order:10,title:`主题系统`,redirect:`/theme/getting-started`,description:``,group:`Advance`,path:`docs/theme.md`,url:`/docs/theme/zh`},text:``,api:``,toc:[],raw:`---
order: 10
title:
  en-US: Theme
  zh-CN: \u4E3B\u9898\u7CFB\u7EDF
