import{a as D}from"./chunk-ITYT6Z4Z.js";import"./chunk-FG4I7JXG.js";import{a as $}from"./chunk-QPLJ63AM.js";import{a as X}from"./chunk-M3YRLNCS.js";import"./chunk-WRDJRDKD.js";import"./chunk-OH6GSKKG.js";import"./chunk-AY5GLEY5.js";import{s as w,t as T,u as M}from"./chunk-BTLIR5N7.js";import{R as G}from"./chunk-YMIRTON6.js";import{Eb as n,Ec as W,Ff as _,Gb as N,Gf as z,If as E,Ja as l,Jb as h,Ka as y,Kf as B,Pb as k,Qb as S,Rf as Q,Ta as g,Ua as p,Wa as v,Z as I,a as U,bd as Y,ca as V,ea as J,fa as K,fb as r,ga as f,gb as s,gd as L,hb as b,ia as m,j,l as A,nd as x,pb as d,rc as C,s as q,w as F}from"./chunk-T6QZOGIV.js";var Z=new J("DC_STORE_STORAGE_TOKEN",{providedIn:"root",factory:()=>new P}),P=class{constructor(){this.platform=f(x)}get(o){return this.platform.isBrowser&&JSON.parse(localStorage.getItem(o)||"null")||null}set(o,re){return this.platform.isBrowser&&localStorage.setItem(o,JSON.stringify(re)),!0}remove(o){this.platform.isBrowser&&localStorage.removeItem(o)}};var O=(()=>{let o=class o{constructor(e){this.store=f(Z),this.http=f(W),this.platform=f(x),this.memory=new Map,this.notifyBuffer=new Map,this.meta=new Set,this.freqTick=3e3,this.cog=e.merge("cache",{mode:"promise",reName:"",prefix:"",meta_key:"__cache_meta"}),this.platform.isBrowser&&(this.loadMeta(),this.startExpireNotify())}pushMeta(e){this.meta.has(e)||(this.meta.add(e),this.saveMeta())}removeMeta(e){this.meta.has(e)&&(this.meta.delete(e),this.saveMeta())}loadMeta(){let e=this.store.get(this.cog.meta_key);e&&e.v&&e.v.forEach(t=>this.meta.add(t))}saveMeta(){let e=[];this.meta.forEach(t=>e.push(t)),this.store.set(this.cog.meta_key,{v:e,e:0})}getMeta(){return this.meta}set(e,t,i={}){if(!this.platform.isBrowser)return;let c=0,{type:u,expire:se}=this.cog;i=U({type:u,expire:se},i),i.expire&&(c=Q(new Date,i.expire).valueOf());let H=i.emitNotify!==!1;if(!(t instanceof j)){this.save(i.type,e,{v:t,e:c},H);return}return t.pipe(I(ce=>{this.save(i.type,e,{v:ce,e:c},H)}))}save(e,t,i,c=!0){e==="m"?this.memory.set(t,i):(this.store.set(this.cog.prefix+t,i),this.pushMeta(t)),c&&this.runNotify(t,"set")}get(e,t={}){if(!this.platform.isBrowser)return null;let i=t.mode!=="none"&&this.cog.mode==="promise",c=this.memory.has(e)?this.memory.get(e):this.store.get(this.cog.prefix+e);return!c||c.e&&c.e>0&&c.e<new Date().valueOf()?i?(this.cog.request?this.cog.request(e):this.http.get(e)).pipe(F(u=>Y(u,this.cog.reName,u)),I(u=>this.set(e,u,{type:t.type,expire:t.expire,emitNotify:t.emitNotify}))):null:i?q(c.v):c.v}getNone(e){return this.get(e,{mode:"none"})}tryGet(e,t,i={}){if(!this.platform.isBrowser)return null;let c=this.getNone(e);return c===null?t instanceof j?this.set(e,t,i):(this.set(e,t,i),t):q(c)}has(e){return this.memory.has(e)||this.meta.has(e)}_remove(e,t){if(t&&this.runNotify(e,"remove"),this.memory.has(e)){this.memory.delete(e);return}this.store.remove(this.cog.prefix+e),this.removeMeta(e)}remove(e){this.platform.isBrowser&&this._remove(e,!0)}clear(){this.platform.isBrowser&&(this.notifyBuffer.forEach((e,t)=>this.runNotify(t,"remove")),this.memory.clear(),this.meta.forEach(e=>this.store.remove(this.cog.prefix+e)))}set freq(e){this.freqTick=Math.max(20,e),this.abortExpireNotify(),this.startExpireNotify()}startExpireNotify(){this.checkExpireNotify(),this.runExpireNotify()}runExpireNotify(){this.freqTime=setTimeout(()=>{this.checkExpireNotify(),this.runExpireNotify()},this.freqTick)}checkExpireNotify(){let e=[];this.notifyBuffer.forEach((t,i)=>{this.has(i)&&this.getNone(i)===null&&e.push(i)}),e.forEach(t=>{this.runNotify(t,"expire"),this._remove(t,!1)})}abortExpireNotify(){clearTimeout(this.freqTime)}runNotify(e,t){this.notifyBuffer.has(e)&&this.notifyBuffer.get(e).next({type:t,value:this.getNone(e)})}notify(e){if(!this.notifyBuffer.has(e)){let t=new A(this.getNone(e));this.notifyBuffer.set(e,t)}return this.notifyBuffer.get(e).asObservable()}cancelNotify(e){this.notifyBuffer.has(e)&&(this.notifyBuffer.get(e).unsubscribe(),this.notifyBuffer.delete(e))}hasNotify(e){return this.notifyBuffer.has(e)}clearNotify(){this.notifyBuffer.forEach(e=>e.unsubscribe()),this.notifyBuffer.clear()}ngOnDestroy(){this.memory.clear(),this.abortExpireNotify(),this.clearNotify()}};o.\u0275fac=function(t){return new(t||o)(K(L))},o.\u0275prov=V({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();var te=(()=>{let o=class o{get newValue(){return+new Date}constructor(e,t){this.srv=e,this.msg=t,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}};o.\u0275fac=function(t){return new(t||o)(y(O),y(G))},o.\u0275cmp=m({type:o,selectors:[["cache-getting-started-simple"]],standalone:!0,features:[h],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(t,i){t&1&&(n(0,`
    `),r(1,"p"),n(2),k(3,"json"),s(),n(4,`
    `),r(5,"div",0),n(6,`
      Basic:
      `),r(7,"button",1),d("click",function(){return i.srv.set(i.key,i.newValue)}),n(8,"Set"),s(),n(9,`
      `),r(10,"button",1),d("click",function(){return i.value=i.srv.getNone(i.key)}),n(11,"Get"),s(),n(12,`
      `),r(13,"button",1),d("click",function(){return i.srv.remove(i.key)}),n(14,"Remove"),s(),n(15,`
      `),r(16,"button",1),d("click",function(){return i.srv.clear()}),n(17,"Clear"),s(),n(18,`
    `),s(),n(19,`
    `),r(20,"div",0),n(21,`
      Key is valid request:
      `),r(22,"button",1),d("click",function(){return i.getByHttp()}),n(23,"Get"),s(),n(24,`
    `),s(),n(25,`
    `),r(26,"div",0),n(27,`
      Notify:
      `),r(28,"button",1),d("click",function(){return i.registerNotify()}),n(29,"Register"),s(),n(30,`
      `),r(31,"button",1),d("click",function(){return i.unRegisterNotify()}),n(32,"UnRegister"),s(),n(33,`
    `),s(),n(34,`
...
}`,lang:"ts",componentName:"CacheGettingStartedSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}};o.\u0275fac=function(t){return new(t||o)},o.\u0275cmp=m({type:o,selectors:[["app-cache-getting-started"]],hostVars:2,hostBindings:function(t,i){t&2&&v("d-block","true")},standalone:!0,features:[h],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(t,i){t&1&&(r(0,"app-docs",0)(1,"div",1)(2,"div",2),n(3,`
        `),r(4,"code-box",3),n(5,`
          `),b(6,"cache-getting-started-simple"),n(7,`
        `),s(),n(8,`
      `),s()()()),t&2&&(p("codes",i.codes)("item",i.item),l(),p("nzGutter",16),l(3),p("item",i.codes[0]),g("id",i.codes[0].id))},dependencies:[$,D,te,M,T,w],encapsulation:2});let a=o;return a})();var ne=(()=>{let o=class o{get newValue(){return+new Date}constructor(e,t){this.srv=e,this.msg=t,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}};o.\u0275fac=function(t){return new(t||o)(y(O),y(G))},o.\u0275cmp=m({type:o,selectors:[["cache-service-simple"]],standalone:!0,features:[h],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(t,i){t&1&&(n(0,`
    `),r(1,"p"),n(2),k(3,"json"),s(),n(4,`
    `),r(5,"div",0),n(6,`
      Basic:
      `),r(7,"button",1),d("click",function(){return i.srv.set(i.key,i.newValue)}),n(8,"Set"),s(),n(9,`
...
export class CacheServiceSimpleComponent implements OnDestroy {
  ...
  ngOnDestroy(): void {
    if (this.notify$) this.notify$.unsubscribe();
        ...
        `),s(),n(8,`
      `),s()()()),t&2&&(p("codes",i.codes)("item",i.item),l(),p("nzGutter",16),l(3),p("item",i.codes[0]),g("id",i.codes[0].id))},dependencies:[$,D,ne,M,T,w],encapsulation:2});let a=o;return a})();var Le=[{path:"",component:X,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:ie},{path:"service",redirectTo:"service/zh",pathMatch:"full"},{path:"service/:lang",component:oe}]}];export{Le as routes};
