  ...
  ngOnInit(): void {
    ...
    for (let i = 0; i < 20; i += 1) {
      ...
      `),c(),s(14,"div",2),i(15,`
        ...
        `),c(),i(20,`
      `),c()()()),n&2&&(l("codes",a.codes)("item",a.item),d(1),l("nzGutter",16),d(3),l("item",a.codes[0]),b("id",a.codes[0].id),d(5),l("item",a.codes[2]),b("id",a.codes[2].id),d(7),l("item",a.codes[1]),b("id",a.codes[1].id))},dependencies:[S,E,ao,ro,co,N,G,w],encapsulation:2});let o=t;return o})();var vi=o=>({"left.%":o}),lo=o=>({"background-color":o}),Ci=(o,t,r)=>({"background-color":o,"width.%":t,"height.px":r}),ve=class ve{constructor(t,r){this.i18n=t,this.cdr=r,this.color="#1890FF"}fixNum(t){return Math.min(Math.max(yn(t),0),100)}ngOnChanges(){this.target=this.fixNum(this.target),this.percent=this.fixNum(this.percent),this.cdr.detectChanges()}};ve.\u0275fac=function(r){return new(r||ve)(U(hn),U(Tt))},ve.\u0275cmp=m({type:ve,selectors:[["g2-mini-progress"]],hostVars:2,hostBindings:function(r,e){r&2&&y("g2-mini-progress",!0)},inputs:{color:"color",target:"target",percent:"percent",strokeWidth:"strokeWidth"},exportAs:["g2MiniProgress"],features:[oe],decls:5,vars:15,consts:[["nz-tooltip","",1,"g2-mini-progress__target",3,"nzTooltipTitle","ngStyle"],[1,"g2-mini-progress__target-item",3,"ngStyle"],[1,"g2-mini-progress__wrap"],[1,"g2-mini-progress__value",3,"ngStyle"]],template:function(r,e){r&1&&(s(0,"div",0),p(1,"span",1)(2,"span",1),c(),s(3,"div",2),p(4,"div",3),c()),r&2&&(l("nzTooltipTitle",e.i18n.getData("miniProgress").target+e.target+"%")("ngStyle",at(5,vi,e.target)),d(1),l("ngStyle",at(7,lo,e.color)),d(1),l("ngStyle",at(9,lo,e.color)),d(2),l("ngStyle",mn(11,Ci,e.color,e.percent,e.strokeWidth)))},dependencies:[mt,Ft],encapsulation:2,changeDetection:0});var jt=ve;v([z()],jt.prototype,"target",void 0);v([z()],jt.prototype,"percent",void 0);v([z()],jt.prototype,"strokeWidth",void 0);var mo=(()=>{let t=class t{};t.\u0275fac=function(n){return new(n||t)},t.\u0275mod=A({type:t}),t.\u0275inj=F({imports:[P,un,At]});let o=t;return o})();var po=(()=>{let t=class t{};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=m({type:t,selectors:[["chart-mini-progress-basic"]],standalone:!0,features:[u],decls:3,vars:0,consts:[["percent","78","strokeWidth","8","target","80"]],template:function(n,a){n&1&&(i(0," "),p(1,"g2-mini-progress",0),i(2," "))},dependencies:[mo,jt],encapsulation:2});let o=t;return o})();var ho=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"zh-CN":"packages/chart/mini-progress/index.md"},content:{"zh-CN":{content:'<section class="markdown"><p>\u7528\u4E8E\u663E\u793A\u8DDF\u901F\u5EA6\u76F8\u5173\u56FE\u5F62\u518D\u9002\u5408\u4E0D\u8FC7\u3002</p></section>',api:'<h2 id="API"><a class="lake-link"><i data-anchor="API"></i></a>API</h2><h3 id="g2-mini-progress"><a class="lake-link"><i data-anchor="g2-mini-progress"></i></a>g2-mini-progress</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td><code>[target]</code></td><td>\u76EE\u6807\u6BD4\u4F8B</td><td><code>number</code></td><td>-</td></tr><tr><td><code>[color]</code></td><td>\u8FDB\u5EA6\u6761\u989C\u8272</td><td><code>string</code></td><td>-</td></tr><tr><td><code>[strokeWidth]</code></td><td>\u8FDB\u5EA6\u6761\u9AD8\u5EA6</td><td><code>number</code></td><td>-</td></tr><tr><td><code>[percent]</code></td><td>\u8FDB\u5EA6\u6BD4\u4F8B</td><td><code>number</code></td><td>-</td></tr></tbody></table>',meta:{title:"g2-mini-progress",subtitle:"\u8FF7\u4F60\u8FDB\u5EA6\u6761",cols:1,type:"G2",module:"import { G2MiniProgressModule } from '@delon/chart/mini-progress';"},toc:[{id:"API",title:"API",h:2,children:[{id:"g2-mini-progress",title:"g2-mini-progress",h:3}]}]}},demo:!0},this.codes=[{id:"chart-mini-progress-basic",meta:{order:0,title:{"zh-CN":"\u57FA\u7840","en-US":"Basic"}},summary:"<p>\u57FA\u7840\u7528\u6CD5\u3002</p>",code:`import { Component } from '@angular/core';
    ...
    this.msg.info(\`\${data.item.label} - \${data.item.name} - \${data.item.value}\`);
      ...
      `),c()()()),n&2&&(l("codes",a.codes)("item",a.item),d(1),l("nzGutter",16),d(3),l("item",a.codes[0]),b("id",a.codes[0].id))},dependencies:[S,E,zo,N,G,w],encapsulation:2});let o=t;return o})();var Yt=class Yt extends nt{constructor(){super(...arguments),this.plusColor="#40a9ff",this.minusColor="#ff4d4f",this.height=60,this.barSize=30,this.min=0,this.max=100,this.value=0,this.line=!1,this.padding=0,this.textStyle={fontSize:12,color:"#595959"},this.onlyChangeData=t=>Object.keys(t).length===1&&!!t.value}install(){let{el:t,height:r,padding:e,textStyle:n,line:a,format:h,theme:f,min:D,max:C,plusColor:x,minusColor:$,barSize:j}=this,B=this._chart=new this.winG2.Chart({container:t.nativeElement,autoFit:!0,height:r,padding:e,theme:f});B.legend(!1),B.axis(!1),B.scale({value:{max:C,min:D}}),B.tooltip(!1),B.coordinate().transpose(),B.interval().position("1*value").color("value",W=>W>0?x:$).size(j).label("value",()=>({formatter:h,style:kt({},n)})),a&&B.annotation().line({start:["50%","0%"],end:["50%","100%"],style:{stroke:"#e8e8e8",lineDash:[0,0]}}),this.ready.next(B),this.changeData(),B.render()}changeData(){let{_chart:t,value:r}=this;t&&t.changeData([{value:r}])}};Yt.\u0275fac=(()=>{let t;return function(e){return(t||(t=Q(Yt)))(e||Yt)}})(),Yt.\u0275cmp=m({type:Yt,selectors:[["g2-single-bar"]],hostVars:2,hostBindings:function(r,e){r&2&&bt("height",e.height,"px")},inputs:{plusColor:"plusColor",minusColor:"minusColor",height:"height",barSize:"barSize",min:"min",max:"max",value:"value",line:"line",format:"format",padding:"padding",textStyle:"textStyle"},exportAs:["g2SingleBar"],features:[J],decls:0,vars:0,template:function(r,e){},encapsulation:2,changeDetection:0});var yt=Yt;v([z()],yt.prototype,"height",void 0);v([z()],yt.prototype,"barSize",void 0);v([z()],yt.prototype,"min",void 0);v([z()],yt.prototype,"max",void 0);v([z()],yt.prototype,"value",void 0);v([H()],yt.prototype,"line",void 0);var To=(()=>{let t=class t{};t.\u0275fac=function(n){return new(n||t)},t.\u0275mod=A({type:t}),t.\u0275inj=F({imports:[P]});let o=t;return o})();function qi(o,t){if(o&1&&(i(0,`
          `),s(1,"tr"),i(2,`
            ...
            `),c(),i(15,`
          `),c(),i(16,`
        `)),o&2){let r=t.$implicit,e=t.$index;d(4),L(e+1),d(4),l("value",r.value),d(5),l("value",r.other)}}var So=(()=>{let t=class t{constructor(){this.list=new Array(5).fill({}).map(()=>({id:Math.floor(Math.random()*1e4),value:Math.floor(Math.random()*100),other:Math.floor(Math.random()*100)>50?Math.floor(Math.random()*100):-Math.floor(Math.random()*100)}))}refresh(){this.list.forEach(e=>{e.value=Math.floor(Math.random()*100),e.other=Math.floor(Math.random()*100)>50?Math.floor(Math.random()*100):-Math.floor(Math.random()*100)})}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=m({type:t,selectors:[["chart-single-bar-basic"]],standalone:!0,features:[u],decls:27,vars:2,consts:[["nz-button","","nzType","primary",3,"click"],[3,"nzData","nzShowPagination"],["nzWidth","350px"],["height","24",3,"value"],["height","60","min","-100","line","",3,"value"]],template:function(n,a){n&1&&(i(0,`
    `),s(1,"button",0),T("click",function(){return a.refresh()}),i(2,"Refresh"),c(),i(3,`
    `),s(4,"nz-table",1),i(5,`
      `),s(6,"thead"),i(7,`
        `),s(8,"tr"),i(9,`
...
export class ChartWaterWaveBasicComponent {}`,lang:"ts",componentName:"ChartWaterWaveBasicComponent",point:0,name:"basic",urls:"packages/chart/water-wave/demo/basic.md",type:"demo"}]}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=m({type:t,selectors:[["app-chart-water-wave"]],hostVars:2,hostBindings:function(n,a){n&2&&y("d-block","true")},standalone:!0,features:[u],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,a){n&1&&(s(0,"app-docs",0)(1,"div",1)(2,"div",2),i(3,`
        ...
        `),c(),i(8,`
      `),c()()()),n&2&&(l("codes",a.codes)("item",a.item),d(1),l("nzGutter",16),d(3),l("item",a.codes[0]),b("id",a.codes[0].id))},dependencies:[S,E,jo,N,G,w],encapsulation:2});let o=t;return o})();var rh=[{path:"",component:Fn,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"faq",redirectTo:"faq/zh",pathMatch:"full"},{path:"faq/:lang",component:On},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:Rn},{path:"bar",redirectTo:"bar/zh",pathMatch:"full"},{path:"bar/:lang",component:$n},{path:"card",redirectTo:"card/zh",pathMatch:"full"},{path:"card/:lang",component:Vn},{path:"chart-echarts",redirectTo:"chart-echarts/zh",pathMatch:"full"},{path:"chart-echarts/:lang",component:Zn},{path:"custom",redirectTo:"custom/zh",pathMatch:"full"},{path:"custom/:lang",component:Yn},{path:"gauge",redirectTo:"gauge/zh",pathMatch:"full"},{path:"gauge/:lang",component:to},{path:"mini-area",redirectTo:"mini-area/zh",pathMatch:"full"},{path:"mini-area/:lang",component:io},{path:"mini-bar",redirectTo:"mini-bar/zh",pathMatch:"full"},{path:"mini-bar/:lang",component:so},{path:"mini-progress",redirectTo:"mini-progress/zh",pathMatch:"full"},{path:"mini-progress/:lang",component:ho},{path:"number-info",redirectTo:"number-info/zh",pathMatch:"full"},{path:"number-info/:lang",component:vo},{path:"pie",redirectTo:"pie/zh",pathMatch:"full"},{path:"pie/:lang",component:Mo},{path:"radar",redirectTo:"radar/zh",pathMatch:"full"},{path:"radar/:lang",component:ko},{path:"single-bar",redirectTo:"single-bar/zh",pathMatch:"full"},{path:"single-bar/:lang",component:_o},{path:"tag-cloud",redirectTo:"tag-cloud/zh",pathMatch:"full"},{path:"tag-cloud/:lang",component:No},{path:"timeline",redirectTo:"timeline/zh",pathMatch:"full"},{path:"timeline/:lang",component:Fo},{path:"trend",redirectTo:"trend/zh",pathMatch:"full"},{path:"trend/:lang",component:Oo},{path:"water-wave",redirectTo:"water-wave/zh",pathMatch:"full"},{path:"water-wave/:lang",component:$o}]}];export{rh as routes};
