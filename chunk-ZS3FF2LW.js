import{Eg as z,Fb as m,Gg as v,Ig as D,Jc as u,Ma as o,Vb as e,Xb as d,Za as c,ga as l,ib as a,ih as _,jc as s,kc as f,wb as t,xb as n,xh as N,yg as y}from"./chunk-SCDKUK6D.js";var S=class p{modal=l(_);record;ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static \u0275fac=function(i){return new(i||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(i,r){i&1&&(e(0,`
    `),t(1,"div",0),e(2,`
