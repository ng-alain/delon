...
const EMAILSUFFIX = [
    'qq.com', '163.com', 'gmail.com', '126.com', 'aliyun.com'
];
...
export class AutoCompleteWidget extends ControlWidget implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (typeof this.filterOption === 'boolean') {
            this.filterOption = this.filterOption === true ?
                (input: string, option: SFSchemaEnum) => option.label.toLowerCase().indexOf(input.toLowerCase()) > -1 :
                () => true;
        }
