...
import { getAngular, getPackage, overwriteAngular, overwritePackage, removeAllowedCommonJsDependencies } from '../../../utils/json';
import { logInfo, logStart, logWarn } from '../../../utils/log';
...
export function fixHmr(sourceRoot: string, tree: Tree, context: SchematicContext): void {
