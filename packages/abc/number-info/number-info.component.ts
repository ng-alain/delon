import { Component, ViewEncapsulation, TemplateRef, Input, ContentChild, ElementRef, Renderer2, SimpleChanges, OnChanges, SimpleChange, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
