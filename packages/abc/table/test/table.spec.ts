...
describe('abc: table', () => {
  ...
  describe('[property]', () => {
    describe('#columns', () => {
      ...
      xit('should be render', (done: () => void) => {
  ...
  describe('[row events]', () => {
    ...
    xit(`should be row click`, (done: () => void) => {
    ...
    xit(`should be row double click`, (done: () => void) => {
      expect(context.rowClick).not.toHaveBeenCalled();
      expect(context.rowDblClick).not.toHaveBeenCalled();
    ...
    xit('should be ingore input', (done: () => void) => {
      expect(context.rowClick).not.toHaveBeenCalled();
      expect(context.rowDblClick).not.toHaveBeenCalled();
  ...
  describe('[i18n]', () => {
    ...
    xit('should be re-render columns when i18n changed', (done: () => void) => {
      page.newColumn([{ title: '', i18n: curLang, index: 'id' }]).then(() => {
