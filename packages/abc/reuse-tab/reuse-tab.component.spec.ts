    ...
    describe('', () => {
        ...
        describe('[context-menu]', () => {
            ...
            it('should be include non-closeable when push ctrl key', fakeAsync(() => {
                page.to('#e')
                    .openContextMenu(1)
                    .tap(() => expect(document.querySelector(`.reuse-tab-cm li[data-type="close"]`).classList).toContain('ant-menu-item-disabled'))
                    .openContextMenu(1, { ctrlKey: true })
                    .tap(() => expect(document.querySelector(`.reuse-tab-cm li[data-type="close"]`).classList).not.toContain('ant-menu-item-disabled'))
                    .expectCount(2);
            }));
        });
