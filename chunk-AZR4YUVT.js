import{Cg as z,Eg as v,Fb as m,Gg as D,Jc as u,Ma as o,Vb as e,Xa as c,Xb as d,eh as _,ha as l,ib as a,jc as s,kc as f,th as N,wb as t,wg as y,xb as n}from"./chunk-BYVQI7J6.js";var S=class p{modal=l(_);record;ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static \u0275fac=function(i){return new(i||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(i,r){i&1&&(e(0,`
    `),t(1,"div",0),e(2,`
