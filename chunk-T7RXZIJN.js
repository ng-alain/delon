import{Db as e,Fb as s,Ig as _,Ja as r,Lb as u,Ng as k,Rb as f,Sb as v,Va as l,cg as z,da as c,dg as y,fg as h,hb as n,hg as D,ib as i,qb as p,va as d,vc as x}from"./chunk-LBINBHXL.js";var I=(()=>{let t=class t{constructor(){this.modal=d(_)}ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}};t.\u0275fac=function(o){return new(o||t)},t.\u0275cmp=c({type:t,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},standalone:!0,features:[u],decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"nzType","nzSize","click"]],template:function(o,m){o&1&&(e(0,`
    `),n(1,"div",0),e(2,`
