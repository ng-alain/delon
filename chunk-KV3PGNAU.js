import{Fb as e,Hb as s,Hf as z,If as y,Ja as r,Kb as u,Kf as h,Mf as D,Qb as f,Rb as v,Ua as l,ga as c,gb as n,hb as i,ia as d,ng as _,qb as p,sc as x,sg as k}from"./chunk-P6RVAZV5.js";var I=(()=>{let t=class t{constructor(){this.modal=c(_)}ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}};t.\u0275fac=function(o){return new(o||t)},t.\u0275cmp=d({type:t,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},standalone:!0,features:[u],decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"nzType","nzSize","click"]],template:function(o,m){o&1&&(e(0,`
    ...
    `),i(),e(19,`
  `)),o&2&&(r(8),s("\u53C2\u6570\uFF1A",v(9,5,m.record),""),r(5),l("nzType","default")("nzSize","large"),r(3),l("nzType","primary")("nzSize","large"))},dependencies:[D,h,z,y,x],encapsulation:2});let a=t;return a})();var $=(()=>{let t=class t{constructor(){this.ref=c(k)}ok(){this.ref.close(`new time: ${+new Date}`),this.cancel()}cancel(){this.ref.close()}};t.\u0275fac=function(o){return new(o||t)},t.\u0275cmp=d({type:t,selectors:[["app-demo-dialog-drawer"]],inputs:{record:"record"},standalone:!0,features:[u],decls:16,vars:5,consts:[[2,"height","1000px"],["routerLink","/"],[1,"drawer-footer"],["nz-button","",3,"nzType","click"]],template:function(o,m){o&1&&(e(0,`
