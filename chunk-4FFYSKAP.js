import{d as M,e as w}from"./chunk-JJ6SK7MW.js";import"./chunk-6EEOJUWQ.js";import"./chunk-UPFXGK3T.js";import"./chunk-JKRTWPTS.js";import"./chunk-7US7IHHY.js";import"./chunk-NEUQGGWU.js";import{Db as e,Fb as y,Gb as f,Ja as d,Lb as h,Rb as i,Sb as o,Wc as I,Xc as x,da as u,hb as r,ib as p,jb as v,ug as a,va as c,vc as g}from"./chunk-CDEDXUOP.js";var S=(()=>{let t=class t{constructor(){this.route=c(I),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=u({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
