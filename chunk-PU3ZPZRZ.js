import{a as Zt,b as Xt,c as zt}from"./chunk-DL7HWI2N.js";import{e as g,g as Kt,i as f}from"./chunk-KYGMJMHJ.js";import"./chunk-YAM2LDJJ.js";import"./chunk-T2BMI2AK.js";import"./chunk-TUSG7BD6.js";import"./chunk-PPRFXIDT.js";import{a as $t,b as Qt}from"./chunk-3OOI7B6E.js";import"./chunk-ZEVXAXVD.js";import"./chunk-YZR7MD3I.js";import{a as x}from"./chunk-SQSFP2NC.js";import"./chunk-MKMQ53XO.js";import{a as F}from"./chunk-QH6LWHB6.js";import{a as eo}from"./chunk-MKWK23US.js";import"./chunk-GEZ532TA.js";import"./chunk-TWWSUF4P.js";import"./chunk-HIIF36CB.js";import{q as k,r as w,s as Yt}from"./chunk-G2KCB6QS.js";import{I as Z,M as X,P as b,d as qt,g as Lt,m as Jt,v as Gt}from"./chunk-EEXBANEL.js";import{Bh as K,Cb as I,Cd as Ot,Dd as Rt,Eg as O,F as Pt,Fb as m,Gd as Vt,Gg as W,Hb as R,Ig as U,M as _t,Ma as c,Ob as P,Pb as _,Q as M,Qb as A,Ub as G,Vb as d,Wb as Wt,X as At,Xb as Ut,Xg as $,Z as Et,Za as s,db as V,ga as u,hb as C,ib as i,ih as Bt,kb as v,kh as Ht,l as Tt,ma as z,na as D,oc as L,rb as q,rg as Q,sa as jt,sg as Y,u as T,wb as a,x as It,xb as r,y as Mt,yb as h,yg as j}from"./chunk-SCDKUK6D.js";var ee=class n{modal=u(Bt);i;schema={properties:{name:{title:"Name",type:"string"}},required:["name"],ui:{spanLabelFixed:150,grid:{span:24}}};save(o){this.modal.destroy(o)}close(){this.modal.destroy()}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["app-demo-dialog-modal"]],decls:20,vars:4,consts:[["sf",""],[1,"modal-header"],[1,"modal-title"],["mode","edit","button","none",3,"schema","formData"],[1,"modal-footer"],["nz-button","","type","button",3,"click"],["nz-button","","type","submit",3,"click","nzType","disabled"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"div",1),d(2,`
...
export class FormAclSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),r(),d(8,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,re,w,k,x],encapsulation:2})};var se=class n{msg=u(b);schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string"},code:{type:"number"},name:{type:"string"},pwd:{type:"string",ui:{type:"password"}}},required:["login_type"],if:{properties:{login_type:{enum:["mobile"]}}},then:{required:["mobile","code"]},else:{required:["name","pwd"]}};submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-conditional-if"]],decls:3,vars:1,consts:[[3,"formSubmit","schema"]],template:function(e,t){e&1&&(d(0," "),a(1,"sf",0),m("formSubmit",function(p){return t.submit(p)}),r(),d(2," ")),e&2&&(c(),i("schema",t.schema))},dependencies:[f,g],encapsulation:2})};var to=["sf"],le=class n{msg=u(b);sf;searchDepartment$=new Tt;schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string",description:"Try typing: ng-alain",ui:{changeDebounceTime:100,change:o=>{this.sf.getProperty("/department")?.updateFeedback("validating"),this.searchDepartment$.next(o)},visibleIf:{login_type:o=>o==="mobile"?{required:!0,show:!0}:null}}},code:{type:"number",ui:{visibleIf:{login_type:["mobile"]}}},type:{type:"string",title:"\u7C7B\u578B",enum:["\u5185\u7F51","\u5916\u7F51"],default:"\u5185\u7F51",ui:{widget:"select",visibleIf:{login_type:o=>o==="mobile"}}},department:{type:"string",title:"Department",default:"\u90E8\u95E81",ui:{widget:"select",visibleIf:{type:["\u5185\u7F51"]}}},remark:{type:"string",title:"Remark",ui:{visibleIf:{type:o=>o==="\u5185\u7F51"?{required:!0,show:!0}:null}}},adr:{type:"string",title:"Address",ui:{visibleIf:{type:o=>o==="\u5916\u7F51"?{required:!0,show:!0}:null}}},name:{type:"string",ui:{visibleIf:{login_type:["account"]}}},pwd:{type:"string",ui:{type:"password",visibleIf:{login_type:["account"]}}}},required:["login_type"],ui:{debug:!0}};ngOnInit(){let o=e=>T(e==="ng-alain"?new Array(5).fill(0).map((t,l)=>`NG-ALAIN\u90E8\u95E8${l+1}`):new Array(3).fill(0).map((t,l)=>`\u90E8\u95E8${l+1}`)).pipe(M(500),_t(()=>[]));this.searchDepartment$.asObservable().pipe(At(o)).subscribe(e=>{let t=this.sf.getProperty("/department");t.schema.enum=e,t.schema.default=e[0],t.widget.reset(e[0]),this.sf.getProperty("/department")?.updateFeedback()})}toggleMobile(o){this.sf.getProperty("/mobile")?.setVisible(o)?.widget?.detectChanges()}submit(o){this.msg.success(JSON.stringify(o))}ngOnDestroy(){this.searchDepartment$.complete()}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-conditional-visibleIf"]],viewQuery:function(e,t){if(e&1&&P(to,7),e&2){let l;_(l=A())&&(t.sf=l.first)}},decls:10,vars:1,consts:[["sf",""],["type","button","nz-button","",3,"click"],[3,"formSubmit","schema"]],template:function(e,t){if(e&1){let l=I();d(0,`
...
export class FormConditionalVisibleIfComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.searchDepartment$.complete();
        ...
        `),r(),d(13,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id),c(5),i("item",t.codes[1]),C("id",t.codes[1].id))},dependencies:[F,se,le,w,k,x],encapsulation:2})};var oo=["sf"],pe=class n{msg=u(b);i18n=u(Vt);comp;schema=this.i18nSchema;get i18nSchema(){return{properties:{name:{type:"string",ui:{i18n:"sf.name",descriptionI18n:"sf.description",optionalHelp:{i18n:"sf.description"}}},password:{type:"string",title:this.i18n.fanyi("sf.name"),description:this.i18n.fanyi("sf.description"),ui:{type:"password"}}},required:["name","password"]}}changeLang(o){this.i18n.use(this.i18n.zone==="zh"?"en-US":"zh-CN"),o==="ref"&&this.comp.refreshSchema(this.i18nSchema)}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-i18n-simple"]],viewQuery:function(e,t){if(e&1&&P(oo,7),e&2){let l;_(l=A())&&(t.comp=l.first)}},decls:10,vars:1,consts:[["sf",""],["nz-button","","type","button",3,"click"],[3,"formSubmit","schema"]],template:function(e,t){if(e&1){let l=I();d(0,`
...
export class FormMethodSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),r(),d(8,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,ue,w,k,x],encapsulation:2})};var fe=class n{mh=u(Ht);msg=u(b);open(){this.mh.create(ee).subscribe(o=>this.msg.success(JSON.stringify(o)))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-modal-simple"]],decls:4,vars:0,consts:[["nz-button","","type","button",3,"click"]],template:function(e,t){e&1&&(d(0," "),a(1,"button",0),m("click",function(){return t.open()}),d(2,"Open"),r(),d(3," "))},dependencies:[U,W,j,O],encapsulation:2})};var be=class n{item={cols:1,urls:{"en-US":"packages/form/examples/modal/index.en-US.md","zh-CN":"packages/form/examples/modal/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Using a form in a modal box is a very common scenario. In fact, when you run <code>ng g ng-alain:edit edit</code>, you will get a complete example; you will get an HTML template like this:</p><pre class="hljs language-html"><code>&lt;sf mode="edit" [schema]="schema" [ui]="ui" [formData]="i" button="none"&gt;
...
export class FormCheckboxSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),r(),d(8,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,ke,w,k,x],encapsulation:2})};var ao=["sf"];function ro(n,o){if(n&1){let e=I();d(0,`
        `),a(1,"div",4),d(2,`
          `),a(3,"div",5),d(4,`
          ...
          `),r(),d(13,`
        `),r(),d(14,`
      `)}if(n&2){let e=o.$implicit,t=o.ui;c(5),i("disabled",e.disabled)("nzSize",e.size)("ngModel",e.value),C("id",e.id)("disabled",e.disabled),c(6),Wt(t.btnText)}}function co(n,o){if(n&1&&(d(0,`
        `),h(1,"nz-qrcode",8),d(2,`
      `)),n&2){let e=o.$implicit;c(),i("nzValue",e.value)}}var xe=class n{msg=u(b);sf;schema={properties:{formName:{type:"string",title:"Custom Title",ui:{widget:"custom",btnText:"Update Qr"},default:"test"},qr:{type:"string",ui:{widget:"custom"},default:"https://ng-alain.com"}}};updateQr(){let o=this.sf.getProperty("/formName")?.value;this.sf.getProperty("/qr")?.setValue(o,!0),this.msg.info("Suc")}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-custom-simple"]],viewQuery:function(e,t){if(e&1&&P(ao,5),e&2){let l;_(l=A())&&(t.sf=l.first)}},decls:9,vars:1,consts:[["sf",""],[3,"formSubmit","schema"],["sf-template","formName"],["sf-template","qr"],["nz-row",""],["nz-col",""],["nz-input","",3,"ngModelChange","disabled","nzSize","ngModel"],["nz-button","","type","button","nzType","link",3,"click"],[3,"nzValue"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"sf",1,0),m("formSubmit",function(E){return z(l),D(t.submit(E))}),d(3,`
      `),V(4,ro,15,6,"ng-template",2),d(5,`
      `),V(6,co,3,1,"ng-template",3),d(7,`
    `),r(),d(8,`
  `)}e&2&&(c(),i("schema",t.schema))},dependencies:[f,g,Kt,Gt,qt,Lt,Jt,Yt,w,k,X,Z,U,W,j,Xt,Zt],encapsulation:2})};var Ne=class n{item={cols:1,urls:{"en-US":"packages/form/src/widgets/custom/index.en-US.md","zh-CN":"packages/form/src/widgets/custom/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Custom the current dynamic form widget. For more complexity, please refer to <a href="/form/customize" data-url="/form/customize">customize</a> widget.</p><h2 id="Usage"><a class="lake-link"><i data-anchor="Usage"></i></a>Usage</h2><p>Make sure to specify <strong>sf-template</strong> a valid path value, for example:</p><pre class="hljs language-html"><code>&lt;sf&gt;
...
export class FormNumberSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),r(),d(8,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,Ie,w,k,x],encapsulation:2})};var Pe=class n{msg=u(b);schema={properties:{name:{type:"string"},age:{type:"number"}},required:["name","age"],ui:{spanLabel:4,spanControl:5}};submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-object-simple"]],decls:1,vars:1,consts:[[3,"formSubmit","schema"]],template:function(e,t){e&1&&(a(0,"sf",0),m("formSubmit",function(p){return t.submit(p)}),r()),e&2&&i("schema",t.schema)},dependencies:[f,g],encapsulation:2})};var so=["extra"];function lo(n,o){if(n&1){let e=I();d(0,`
...
export class FormRadioSimpleComponent {
  ...
  `)}e&2&&(c(),i("schema",t.schema))},dependencies:[f,g,U,W,j,O],encapsulation:2})};var ho=["sf"],Ue=class n{msg=u(b);sf;data={province:"Zhejiang",city:"Ningbo"};cityData={Zhejiang:["Hangzhou","Ningbo","Wenzhou"],Jiangsu:["Nanjing","Suzhou","Zhenjiang"]};schema={properties:{province:{type:"string",title:"Province",ui:{widget:"select",asyncData:()=>T(["Zhejiang","Jiangsu"]).pipe(M(100),Et(()=>this.updateCity(this.data.province,this.data.city))),change:o=>this.updateCity(o)}},city:{type:"string",title:"City",ui:{widget:"select"}}}};submit(o){this.msg.success(JSON.stringify(o))}updateCity(o,e=""){let t=this.sf.getProperty("/city"),l=this.cityData[o];t.schema.enum=l,t.widget.reset(e||l[0])}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-select-coordinate"]],viewQuery:function(e,t){if(e&1&&P(ho,5),e&2){let l;_(l=A())&&(t.sf=l.first)}},decls:4,vars:2,consts:[["sf",""],[3,"formSubmit","schema","formData"]],template:function(e,t){if(e&1){let l=I();d(0," "),a(1,"sf",1,0),m("formSubmit",function(E){return z(l),D(t.submit(E))}),r(),d(3," ")}e&2&&(c(),i("schema",t.schema)("formData",t.data))},dependencies:[f,g],encapsulation:2})};var go=["sf"],fo=["dropdownRender"];function bo(n,o){if(n&1){let e=I();d(0,`
    ...
    `)}if(n&2){let e=R();c(),i("schema",e.schema)}}function yo(n,o){if(n&1){let e=I();d(0,`
      ...
      `),a(3,"div",4),d(4,`
        `),h(5,"input",5,2),d(7,`
        `),a(8,"a",6),m("click",function(){z(e);let l=G(6),p=R();return D(p.addItem(l))}),h(9,"nz-icon",7),d(10," Add item"),r(),d(11,`
      `),r(),d(12,`
