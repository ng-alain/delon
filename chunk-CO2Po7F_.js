...
@delon/util \u662F\u4E00\u7EC4\u65E5\u5E38\u666E\u901A\u4F7F\u7528\u7684\u5DE5\u5177\u51FD\u6570\u7684\u96C6\u5408\u3002`}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-getting-started`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var p=class t{item={name:`array`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`array`,subtitle:`Array&Tree,flat,groupBy,uniq`,description:`Used for conversion and access between arrays and trees. It is generally used with nz-tree.You can override [ArrayService] to set the mapping name thr...`,group:`Tools`,order:0,path:`packages/util/array/index.en-US.md`,url:`/util/array/en`},text:`<h2 id="arrayservice"><a class="lake-link"><i data-anchor="arrayservice"></i></a>ArrayService<label class="api-type-label service">service</label></h2><p>Used for conversion and access between arrays and trees. It is generally used with <code>nz-tree</code>.</p>
<blockquote>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-decorator`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var g=class t{item={name:`form`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`form`,subtitle:`Reactive Forms`,description:`Match two control values, for examples:A set of validators for reactive forms, including:_Validators.num Wheter is number_Validators.int Wheter is int...`,group:`Tools`,order:0,path:`packages/util/form/index.en-US.md`,url:`/util/form/en`},text:`<h2 id="matchcontrol"><a class="lake-link"><i data-anchor="matchcontrol"></i></a>MatchControl</h2><p>Match two control values, for examples:</p>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-form`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var f=class t{item={name:`format`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`format`,subtitle:`String,Check,Currency,Mask`,description:`You can override to set the startingUnit, megaUnit, precision, ingoreZeroPrecision through Global Configuration.Format a number with commas as thousan...`,group:`Tools`,order:0,path:`packages/util/format/index.en-US.md`,url:`/util/format/en`},text:`<h2 id="currencyservice"><a class="lake-link"><i data-anchor="currencyservice"></i></a>CurrencyService<label class="api-type-label service">service</label></h2><blockquote>
...
`,api:``,toc:[{id:`inrange`,title:`inRange`},{id:`ceil`,title:`ceil`},{id:`floor`,title:`floor`},{id:`round`,title:`round`}],raw:"---\ntitle: math\nsubtitle: 范围、四舍五入\ntype: Tools\n---\n\n## inRange\n\n检查 `value` 是否在 `start` 与 `end` 之间，但不包括 `end`。 如果 `end` 没有指定，那么 `start` 设置为 `0`。 如果 `start` 大于 `end`，那么参数会交换以便支持负范围。\n\n```ts\ninRange(3, 2, 4); // true\ninRange(4, 8); // true\ninRange(4, 2); // false\ninRange(2, 2); // false\ninRange(1.2, 2); // true\ninRange(-3, -2, -6); // true\n```\n\n## ceil\n\n根据 `precision`（精度） 向上舍入 `number`。\n\n```ts\nceil(4.006); // 5\nceil(6.004, 2); // 6.01\nceil(6040, -2); // 6100\n```\n\n## floor\n\n根据 `precision`（精度） 向下舍入 `number`。\n\n```ts\nfloor(4.006); // 4\nfloor(0.046, 2); // 0.04\nfloor(4060, -2); // 4000\n```\n\n## round\n\n根据 `precision`（精度） 四舍五入 `number`。\n\n```ts\nround(4.006); // 4\nround(4.006, 2); // 4.01\nround(4060, -2); // 4100\n```"}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-math`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var b=class t{item={name:`other`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`other`,subtitle:`Deep get,copy,merge,lazy,assert`,description:`Omit specified keys from an object.Gets the value at path of object, like _.get in lodash.Base on extend deep copy.Deep merge object.LazyService delay...`,group:`Tools`,order:0,path:`packages/util/other/index.en-US.md`,url:`/util/other/en`},text:`<h2 id="omit"><a class="lake-link"><i data-anchor="omit"></i></a>omit</h2><p>Omit specified keys from an object.</p>
...
- \`assertObservable\` \u65AD\u8A00\u662F\u5426 \`Observable\` \u7C7B\u578B`}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-other`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var k=class t{item={name:`token`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`token`,subtitle:`Token`,description:`Access to global window object.Use the visibilitychange event to monitor whether the browser tab is visible, which is generally used when the user lea...`,group:`Tools`,order:0,path:`packages/util/token/index.en-US.md`,url:`/util/token/en`},text:`<h2 id="window"><a class="lake-link"><i data-anchor="window"></i></a>WINDOW</h2><p>Access to global <code>window</code> object.</p>
...
\u901A\u8FC7 \`visibilitychange\` \u4E8B\u4EF6\u6765\u76D1\u542C\u6D4F\u89C8\u5668\u9009\u9879\u5361\u662F\u5426\u53EF\u89C1\uFF0C\u4E00\u822C\u7528\u4E8E\u5F53\u7528\u6237\u79BB\u5F00\u5E94\u7528\u65F6\u6682\u65F6\u4E2D\u65AD\u540E\u7AEF\u6301\u7EED\u53D1\u9001\u8BF7\u6C42\u65F6\u3002`}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-token`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var v=class t{item={name:`pipes-currency`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`currency`,subtitle:`Currency Pipes`,module:`import { CurrencyPipeModule } from '@delon/util/pipes/currency';`,description:`You can override to set the startingUnit, megaUnit, precision, ingoreZeroPrecision through Global Configuration.Format a number with commas as thousan...`,group:`Pipes`,order:0,path:`packages/util/pipes/currency/index.en-US.md`,url:`/util/pipes-currency/en`},text:`<blockquote>
<p>You can override to set the <code>startingUnit</code>, <code>megaUnit</code>, <code>precision</code>, <code>ingoreZeroPrecision</code> through <a href="/docs/global-config">Global Configuration</a>.</p>
</blockquote>
...
[comment]: <demo(currency-cny)>`}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-pipes-currency`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var C=class t{item={name:`pipes-filter`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`filter`,subtitle:`Filter`,module:`import { FilterPipeModule } from '@delon/util/pipes/filter';`,description:`Filter array.`,group:`Pipes`,order:0,path:`packages/util/pipes/filter/index.en-US.md`,url:`/util/pipes-filter/en`},text:`<h2 id="filter"><a class="lake-link"><i data-anchor="filter"></i></a>filter</h2><p>Filter array.</p>
...
[comment]: <demo(filter)>`}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`util-pipes-filter`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var D=class t{item={name:`pipes-format`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`format`,subtitle:`Mask`,module:`import { FormatPipeModule } from '@delon/util/pipes/format';`,description:`Format mask.`,group:`Pipes`,order:0,path:`packages/util/pipes/format/index.en-US.md`,url:`/util/pipes-format/en`},text:`<h2 id="mask"><a class="lake-link"><i data-anchor="mask"></i></a>mask</h2><p>Format mask.</p>
