...
</html>`}function Le(e,t){let i=ue(e);i.action=W("/run",t),i.target=G(t),document.body.appendChild(i),i.submit(),document.body.removeChild(i)}function C(e){return e?.contentWindow?(Oe(e)??new D(e)).pending:Promise.reject("Provided element is not an iframe.")}function Pe(e,t){Le(e,t)}function Re(e,t){let i=W(`/edit/${e}`,t),n=G(t);window.open(i,n)}function $e(e,t){let i=W(`/github/${e}`,t),n=G(t);window.open(i,n)}function ze(e,t,i){let n=F(e),d=Ce(t,i),u=document.createElement("iframe");return B(n,u,i),u.contentDocument?.write(d),C(u)}function qe(e,t,i){let n=F(e),d=document.createElement("iframe");return d.src=U(`/edit/${t}`,i),B(n,d,i),C(d)}function De(e,t,i){let n=F(e),d=document.createElement("iframe");return d.src=U(`/github/${t}`,i),B(n,d,i),C(d)}var me={connect:C,embedGithubProject:De,embedProject:ze,embedProjectId:qe,openGithubProject:$e,openProject:Pe,openProjectId:Re};var ke=ee(he());var x=ee(ye());var K={$schema:"./node_modules/@angular/cli/lib/config/schema.json",cli:{analytics:"1e1de97b-a744-405a-8b5a-0397bb3d01ce"},newProjectRoot:"projects",projects:{demo:{architect:{build:{builder:"@angular-devkit/build-angular:application",configurations:{development:{extractLicenses:!1,namedChunks:!0,optimization:!1,sourceMap:!0},production:{aot:!0,extractLicenses:!0,namedChunks:!1,optimization:!0,outputHashing:"all",sourceMap:!1}},options:{assets:[],index:"src/index.html",browser:"src/main.ts",outputPath:"dist/demo",scripts:[],styles:["src/styles.css"],tsConfig:"tsconfig.json"}},serve:{builder:"@angular-devkit/build-angular:dev-server",configurations:{development:{buildTarget:"demo:build:development"},production:{buildTarget:"demo:build:production"}},defaultConfiguration:"development"}},prefix:"app",projectType:"application",root:"",schematics:{},sourceRoot:"src"}},version:1};var V=`import { ApplicationConfig } from '@angular/core';
import {
  provideHttpClient,
  withFetch,
  withInterceptors,
