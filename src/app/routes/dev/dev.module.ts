...
import { DevCustomComponent } from './custom/dev-custom.component';
...
const COMPONENTS = [DevLayoutComponent, DevHomeComponent, DevPageComponent, DemoComponent, DevCustomComponent];
