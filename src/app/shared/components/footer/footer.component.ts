  ...
  template: `
    <div class="footer__wrap">
      <div nz-row>
        ...
        <div nz-col nzXs="24" nzSm="24" nzLg="6">
          <div class="footer__center">
            Copyright &copy; 2026 <a href="https://github.com/cipchk" target="_blank">&copy;卡色</a>
            <p class="mt-sm">
...
export class FooterComponent {
  ...
  protected readonly color = signal(`#1890ff`);
  ...
  protected changeColor(res: { color: NzColor; format: string }): void {
