...
describe('Service: Scroll', () => {
    ...
    beforeEach(() => {
        injector = ReflectiveInjector.resolveAndCreate([ScrollService, { provide: DOCUMENT, useClass: MockDocument }, { provide: PlatformLocation, useClass: MockPlatformLocation }]);
    ...
    describe('#scroll', () => {
        it('should scroll to the top if there is no hash', () => {
            ...
            document.getElementById.and.callFake(id => (id === 'top-of-page' ? topOfPage : null));
    ...
    describe('#scrollToTop', () => {
        it('should scroll to top', () => {
            ...
            document.getElementById.and.callFake(id => (id === 'top-of-page' ? topOfPageElement : null));
