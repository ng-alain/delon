import{f as M,g as w}from"./chunk-MR5FK4K7.js";import"./chunk-EARTFLPV.js";import"./chunk-L7HAQ6SN.js";import"./chunk-KEWBDC3Y.js";import"./chunk-OH6GSKKG.js";import{Eb as e,Gb as y,Hb as f,Ja as d,Jb as h,Pb as i,Qb as o,Rc as I,Sc as x,Yf as a,fb as r,ga as u,gb as p,hb as v,ia as c,rc as g}from"./chunk-T6QZOGIV.js";var S=(()=>{let t=class t{constructor(){this.route=u(I),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=c({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
