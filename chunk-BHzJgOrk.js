...
\u4E00\u822C\u6765\u8BF4 Mock \u90FD\u662F\u5F00\u53D1\u8FC7\u7A0B\u4E2D\u9700\u8981\uFF0C\u56E0\u6B64\u5EFA\u8BAE\u5728\u9879\u76EE\u6839\u76EE\u5F55\u4E0B\u521B\u5EFA\u4E00\u4E2A \`_mock\` \u76EE\u5F55\uFF0C\u5E76\u521B\u5EFA\u4E00\u4E2A \`index.ts\` \u6587\u4EF6\u7528\u4E8E\u5BFC\u51FA\u6240\u6709\u6570\u636E\u89C4\u5219\uFF0C\u53C2\u8003 [ng-alain/_mock](https://github.com/ng-alain/ng-alain/tree/master/_mock)\u3002`}}};codes=[];static ɵfac=function(e){return new(e||n)};static ɵcmp=Se({type:n,selectors:[[`mock-rule`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt(0,`app-docs`,0),e&2&&ie(`codes`,t.codes)(`item`,t.item)},dependencies:[ce],encapsulation:2})};var q=[{path:``,component:ee,children:[{path:`getting-started`,redirectTo:`getting-started/zh`,pathMatch:`full`},{path:`getting-started/:lang`,component:d},{path:`rule`,redirectTo:`rule/zh`,pathMatch:`full`},{path:`rule/:lang`,component:c}]}];export{q as routes};