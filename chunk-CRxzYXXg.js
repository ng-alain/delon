import{An as Mm,Cr as S,Ds as on,Fr as Se$1,Hc as vr,Hi as Ze$1,O as C,Pc as v5,Qn as P,Qt as Je$1,Rc as ve$1,Ta as cT,Ts as oe$1,Tt as Gt,Uc as vt$1,Us as qe$1,Ut as Io,Ws as ql,Xa as f5,Xs as re$1,as as m5,at as F0,bl as z0,c as $t,ca as a3,do as gt$1,er as P5,fa as an,fl as ye$1,fn as Kn,fs as mo,go as hI,it as F,jo as ie$1,js as pI,no as fo,ol as xr,pn as Kr,po as h,qi as Zr,si as Ve$1,u as A,un as Ke$1,uo as go,va as be$1,vi as Wl,vo as he$1,xt as Ge$1,zo as je$1,zs as pt$1}from"./chunk-Bix55avy.js";import"./chunk-B6DEdUMt.js";import"./chunk-BQHyAFCm.js";import{B as lu,O as Ya,P as fr,R as jn,X as xu,d as Fi,j as _c,p as He$1,t as At}from"./chunk-3aQ3WiqM.js";import{f as sn$1,i as We$1,s as cn$1}from"./chunk-Ioj09ejC.js";import"./chunk-Dm8IWcYA.js";import"./chunk-BEuoOxL9.js";import"./chunk-uiqTrtWh.js";import"./chunk-CgBXRMDB.js";import{F as Rt,I as fs,M as mi,N as nn,P as Cu,j as U,t as X}from"./main-KISOO6CU.js";import"./chunk-46Ii5gWu.js";import"./chunk-CKkdg4oh.js";import{t as ce$1}from"./chunk-D8eOcErz.js";import{t as ee$1}from"./chunk-CjITDEOi.js";var ee=class o{modal=h(F0);i;schema={properties:{name:{title:`Name`,type:`string`}},required:[`name`],ui:{spanLabelFixed:150,grid:{span:24}}};save(n){this.modal.destroy(n)}close(){this.modal.destroy()}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`app-demo-dialog-modal`]],decls:10,vars:3,consts:[[`sf`,``],[1,`modal-header`],[1,`modal-title`],[`mode`,`edit`,`button`,`none`,3,`schema`,`formData`],[1,`modal-footer`],[`nz-button`,``,`type`,`button`,3,`click`],[`nz-button`,``,`type`,`submit`,`nzType`,`primary`,3,`click`,`disabled`]],template:function(e,t){if(e&1){let s=on();oe$1(0,`div`,1)(1,`div`,2),an(2,`Sf demo`),he$1()(),oe$1(3,`sf`,3,0)(5,`div`,4)(6,`button`,5),je$1(`click`,function(){return t.close()}),an(7,`关闭`),he$1(),oe$1(8,`button`,6),je$1(`click`,function(){gt$1(s);let J=Wl(4);return vt$1(t.save(J.value))}),an(9,` 保存 `),he$1()()()}if(e&2){let s=Wl(4);A(3),ie$1(`schema`,t.schema)(`formData`,t.i),A(5),ie$1(`disabled`,!s.valid)}},dependencies:[v5,a3,f5,m5,Cu,Rt],encapsulation:2})};var te=class o{item={name:`validator`,langs:[`zh-CN`,`en-US`],content:{"zh-CN":{meta:{title:`在线校验器`,group:`Examples`,redirect:`/form-pages/validator/zh`},text:``,toc:[]},"en-US":{meta:{title:`Online Validator`,group:`Examples`,redirect:`/form-pages/validator/en`},text:``,toc:[]}}};codes=[];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`validator`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt$1(0,`app-docs`,0),e&2&&ie$1(`codes`,t.codes)(`item`,t.item)},dependencies:[ce$1],encapsulation:2})};var ne=class o{item={name:`customize`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:4,title:`Customize Widgets`,description:`@delon/form try our best to meet the needs of different environments, in addition to the built-in basic widgets (Some require manual registration), yo...`,group:`Documents`,path:`packages/form/docs/customize.en-US.md`,url:`/form/customize/en`},text:`<h2 id="foreword"><a class="lake-link"><i data-anchor="foreword"></i></a>Foreword</h2><p><code>&#64;delon/form</code> try our best to meet the needs of different environments, in addition to the built-in basic widgets (Some require manual registration), you can further expand the requirements in two ways:</p>
...
<p><strong>ngModel and form registration</strong></p>
<p>The <code>ngModel</code> inside a widget template is only a local binding synchronized with <code>FormProperty</code>, it neither needs nor should be registered with any form, so it must be declared as <code>standalone</code>; otherwise Angular v22 reports a <code>NG01354</code> warning in the console.</p>
<blockquote>
<p>Note: Do not follow that warning and add <code>viewProviders: [&#123; provide: ControlContainer, useExisting: NgForm &#125;]</code>: it makes <code>ngModel</code> try to register with the internal form of SF, and since it has no <code>name</code>, it throws <code>NG01352</code> immediately.</p>
</blockquote>
...
<p>Widget state is fully signal-driven: <code>ui</code> / <code>schema</code> are reactive objects, and your own state should use <code>signal</code>.
Therefore <strong>manual change detection is no longer needed</strong> (<code>detectChanges()</code> has been removed) \u2014 the view refreshes automatically.</p>
<blockquote>
<p>Note: <code>ui</code> / <code>schema</code> must be <strong>replaced as a whole</strong> (e.g. <code>ui.optionalHelp = &#123; ...ui.optionalHelp, text &#125;</code>);
mutating nested structures in place (e.g. <code>schema.enum.push(...)</code>) is not tracked.</p>
</blockquote>
...
<p><strong>ngModel \u4E0E\u8868\u5355\u6CE8\u518C</strong></p>
<p>\u5C0F\u90E8\u4EF6\u6A21\u677F\u91CC\u7684 <code>ngModel</code> \u53EA\u662F\u4E0E <code>FormProperty</code> \u540C\u6B65\u7684\u5C40\u90E8\u7ED1\u5B9A\uFF0C\u4E0D\u9700\u8981\u4E5F\u4E0D\u5E94\u8BE5\u6CE8\u518C\u5230\u4EFB\u4F55\u8868\u5355\uFF0C\u56E0\u6B64\u5FC5\u987B\u58F0\u660E\u4E3A <code>standalone</code>\uFF1B\u5426\u5219 Angular v22 \u4F1A\u5728\u63A7\u5236\u53F0\u7ED9\u51FA <code>NG01354</code> \u8B66\u544A\u3002</p>
<blockquote>
<p>\u6CE8\u610F\uFF1A\u4E0D\u8981\u6309\u8BE5\u8B66\u544A\u7684\u63D0\u793A\u6DFB\u52A0 <code>viewProviders: [&#123; provide: ControlContainer, useExisting: NgForm &#125;]</code>\uFF1A\u8FD9\u4F1A\u8BA9 <code>ngModel</code> \u5C1D\u8BD5\u6CE8\u518C\u5230 SF \u5185\u90E8\u7684\u8868\u5355\uFF0C\u800C\u5B83\u6CA1\u6709 <code>name</code>\uFF0C\u4F1A\u76F4\u63A5\u629B\u51FA <code>NG01352</code>\u3002</p>
</blockquote>
<p><strong>sf-item-wrap</strong></p>
<p>\u5728\u6A21\u677F\u4E2D\u552F\u4E00\u662F\u5229\u7528 <code>sf-item-wrap</code> \u5305\u88F9\u81EA\u5B9A\u4E49\u5185\u5BB9\uFF0C\u5B83\u5185\u90E8\u5C01\u88C5\u8868\u5355\u57FA\u7840\u5143\u7D20\u3002</p>
<p><strong>\u53D8\u66F4\u68C0\u6D4B</strong></p>
<p>\u5C0F\u90E8\u4EF6\u72B6\u6001\u5168\u90E8\u7531 signal \u9A71\u52A8\uFF1A<code>ui</code> / <code>schema</code> \u662F\u54CD\u5E94\u5F0F\u5BF9\u8C61\uFF0C\u7EC4\u4EF6\u81EA\u8EAB\u7684\u72B6\u6001\u4E5F\u5E94\u4F7F\u7528 <code>signal</code>\u3002
\u56E0\u6B64<strong>\u4E0D\u518D\u9700\u8981\u624B\u52A8\u89E6\u53D1\u53D8\u66F4\u68C0\u6D4B</strong>\uFF08<code>detectChanges()</code> \u5DF2\u79FB\u9664\uFF09\uFF0C\u4FEE\u6539\u72B6\u6001\u540E\u89C6\u56FE\u4F1A\u81EA\u52A8\u5237\u65B0\u3002</p>
<blockquote>
<p>\u6CE8\u610F\uFF1A<code>ui</code> / <code>schema</code> \u53EA\u80FD<strong>\u6574\u503C\u66FF\u6362</strong>\uFF08\u5982 <code>ui.optionalHelp = &#123; ...ui.optionalHelp, text &#125;</code>\uFF09\uFF1B
\u5C31\u5730\u4FEE\u6539\u5D4C\u5957\u7ED3\u6784\uFF08\u5982 <code>schema.enum.push(...)</code>\uFF09\u4E0D\u4F1A\u88AB\u8DDF\u8E2A\u3002</p>
</blockquote>
...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-customize`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt$1(0,`app-docs`,0),e&2&&ie$1(`codes`,t.codes)(`item`,t.item)},dependencies:[ce$1],encapsulation:2})};var oe=class o{item={name:`error`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:3,title:`Validation Error`,description:`A set of error messages may be created during JSON Schema validation, every error has a fixed keyword, you can configure errors in global config to ov...`,group:`Documents`,path:`packages/form/docs/error.en-US.md`,url:`/form/error/en`},text:`<h2 id="prologue"><a class="lake-link"><i data-anchor="prologue"></i></a>Prologue</h2><p>A set of error messages may be created during JSON Schema validation, every error has a fixed <code>keyword</code>, you can configure <code>errors</code> in <a href="/docs/global-config">global config</a> to override default error messages, you can also handle internationalization error messages in global config. Following is an example when it is failed to pass required field validation:</p>
...
**\u6CE8\u610F\uFF1A** \`expandable\` \u548C \`collapse\` \u5C5E\u4E8E UI \u5C42\u9762\u7684\u63A7\u5236\uFF0C\u4E0E\u5B57\u6BB5\u7684 \`required\` \u903B\u8F91\u65E0\u5173\u3002`}}};codes=[];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-layout`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt$1(0,`app-docs`,0),e&2&&ie$1(`codes`,t.codes)(`item`,t.item)},dependencies:[ce$1],encapsulation:2})};var ie=class o{item={name:`qa`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:99,title:`FAQ`,description:`Many functions require passing path parameter, it uses / to represent form object path, following JSON Schema is an example:Following path are all val...`,group:`Documents`,path:`packages/form/docs/qa.en-US.md`,url:`/form/qa/en`},text:`<h2 id="path"><a class="lake-link"><i data-anchor="path"></i></a>path</h2><p>Many functions require passing <code>path</code> parameter, it uses <code>/</code> to represent form object path, following JSON Schema is an example:</p>
<pre><code class="language-ts">schema: SFSchema = &#123;
  properties: &#123;
    app: &#123;
      type: &#39;string&#39;,
...
<h2 id="how_to_toggle_show_or_hide_an_element"><a class="lake-link"><i data-anchor="how_to_toggle_show_or_hide_an_element"></i></a>How to toggle show or hide an element</h2><pre><code class="language-ts">this.sf.getProperty(&#39;/mobile&#39;)?.setVisible(status);
</code></pre>
...
<h2 id="\u5982\u4F55\u5207\u6362\u663E\u793A\u6216\u9690\u85CF\u67D0yuan\u7D20"><a class="lake-link"><i data-anchor="\u5982\u4F55\u5207\u6362\u663E\u793A\u6216\u9690\u85CF\u67D0yuan\u7D20"></i></a>\u5982\u4F55\u5207\u6362\u663E\u793A\u6216\u9690\u85CF\u67D0\u5143\u7D20</h2><pre><code class="language-ts">this.sf.getProperty(&#39;/mobile&#39;)?.setVisible(status);
</code></pre>
...
\`\`\`ts
this.sf.getProperty('/mobile')?.setVisible(status);
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-qa`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,t){e&1&&pt$1(0,`app-docs`,0),e&2&&ie$1(`codes`,t.codes)(`item`,t.item)},dependencies:[ce$1],encapsulation:2})};var re=class o{item={name:`schema`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:2,title:`Schema`,description:`JSON Schema is a specification to define JSON data structure, it doesn't include detailed explanation about how to convert the specification to specif...`,group:`Documents`,path:`packages/form/docs/schema.en-US.md`,url:`/form/schema/en`},text:`<h2 id="prologue"><a class="lake-link"><i data-anchor="prologue"></i></a>Prologue</h2><p><a href="http://json-schema.org/" target="_blank" rel="noopener">JSON Schema</a> is a specification to define JSON data structure, it doesn&#39;t include detailed explanation about how to convert the specification to specific forms, <code>&#64;delon/form</code> is a dynamic form library developed based on our own understanding of JSON Schema and current data input components of <code>ng-zorro-antd</code>.</p>
...
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/examples/acl/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-acl`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-acl-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ce,sn$1,We$1,X],encapsulation:2})};var le=class o{msg=h(lu);schema={properties:{login_type:{type:`string`,title:`登录方式`,enum:[{label:`手机`,value:`mobile`},{label:`账密`,value:`account`}],default:`mobile`,ui:{widget:`radio`,styleType:`button`}},mobile:{type:`string`},code:{type:`number`},name:{type:`string`},pwd:{type:`string`,ui:{type:`password`}}},required:[`login_type`],if:{properties:{login_type:{enum:[`mobile`]}}},then:{required:[`mobile`,`code`]},else:{required:[`name`,`pwd`]}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-conditional-if`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var cn=[`sf`];var me=class o{msg=h(lu);sf;searchDepartment$=new C;schema={properties:{login_type:{type:`string`,title:`登录方式`,enum:[{label:`手机`,value:`mobile`},{label:`账密`,value:`account`}],default:`mobile`,ui:{widget:`radio`,styleType:`button`}},mobile:{type:`string`,description:`Try typing: ng-alain`,ui:{changeDebounceTime:100,change:n=>{this.sf.getProperty(`/department`)?.updateFeedback(`validating`),this.searchDepartment$.next(n)},visibleIf:{login_type:n=>n===`mobile`?{required:!0,show:!0}:null}}},code:{type:`number`,ui:{visibleIf:{login_type:[`mobile`]}}},type:{type:`string`,title:`类型`,enum:[`内网`,`外网`],default:`内网`,ui:{widget:`select`,visibleIf:{login_type:n=>n===`mobile`}}},department:{type:`string`,title:`Department`,default:`部门1`,ui:{widget:`select`,visibleIf:{type:[`内网`]}}},remark:{type:`string`,title:`Remark`,ui:{visibleIf:{type:n=>n===`内网`?{required:!0,show:!0}:null}}},adr:{type:`string`,title:`Address`,ui:{visibleIf:{type:n=>n===`外网`?{required:!0,show:!0}:null}}},name:{type:`string`,ui:{visibleIf:{login_type:[`account`]}}},pwd:{type:`string`,ui:{type:`password`,visibleIf:{login_type:[`account`]}}}},required:[`login_type`],ui:{debug:!0}};ngOnInit(){let n=e=>S(e===`ng-alain`?new Array(5).fill(0).map((t,s)=>`NG-ALAIN\u90E8\u95E8${s+1}`):new Array(3).fill(0).map((t,s)=>`\u90E8\u95E8${s+1}`)).pipe(go(500),mo(()=>[]));this.searchDepartment$.asObservable().pipe(Ve$1(n)).subscribe(e=>{let t=this.sf.getProperty(`/department`);t.schema.enum=e,t.schema.default=e[0],t.widget.reset(e[0]),this.sf.getProperty(`/department`)?.updateFeedback()})}toggleMobile(n){this.sf.getProperty(`/mobile`)?.setVisible(n)}submit(n){this.msg.success(JSON.stringify(n))}ngOnDestroy(){this.searchDepartment$.complete()}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-conditional-visibleIf`]],viewQuery:function(e,t){if(e&1&&Kn(cn,7),e&2){let s;Ge$1(s=Ke$1())&&(t.sf=s.first)}},decls:6,vars:1,consts:[[`sf`,``],[`type`,`button`,`nz-button`,``,3,`click`],[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`button`,1),je$1(`click`,function(){return t.toggleMobile(!1)}),an(1,`Hide mobile`),he$1(),oe$1(2,`button`,1),je$1(`click`,function(){return t.toggleMobile(!0)}),an(3,`Show mobile`),he$1(),oe$1(4,`sf`,2,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&(A(4),ie$1(`schema`,t.schema))},dependencies:[Cu,Rt,v5,a3,f5,m5],encapsulation:2})};var pe=class o{item={name:`conditional`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`Conditional expression`,description:`sf supports two types of conditional expressions:JSON Schema Standard if-then-elseMore flexible visibleIf`,group:`Examples`,order:0,path:`packages/form/examples/conditional/index.en-US.md`,url:`/form/conditional/en`},text:`<p><code>sf</code> supports two types of conditional expressions:</p>
<ul>
...
`},summary_raw:{"en-US":"Use `visibleIf` to implement more flexible conditional expressions, which can support both display and required items. Feedback status can be updated with `updateFeedback`.\n","zh-CN":"利用 `visibleIf` 实现更加灵活的条件表达式，可以同时支持显示与可选项；利用 `updateFeedback` 可以更新反馈状态。\n"},path:`packages/form/examples/conditional/demo/visibleIf.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-conditional`]],hostAttrs:[1,`d-block`],decls:7,vars:7,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-conditional-if`),he$1(),oe$1(5,`code-box`,3),pt$1(6,`form-conditional-visibleIf`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A(2),ie$1(`item`,t.codes[1]),$t(`id`,t.codes[1].id))},dependencies:[ce$1,le,me,sn$1,We$1,X],encapsulation:2})};var sn=[`sf`];var ue=class o{msg=h(lu);i18n=h(Kr);comp;schema=this.i18nSchema;get i18nSchema(){return{properties:{name:{type:`string`,ui:{i18n:`sf.name`,descriptionI18n:`sf.description`,optionalHelp:{i18n:`sf.description`}}},password:{type:`string`,title:this.i18n.fanyi(`sf.name`),description:this.i18n.fanyi(`sf.description`),ui:{type:`password`}}},required:[`name`,`password`]}}changeLang(n){this.i18n.use(this.i18n.zone===`zh`?`en-US`:`zh-CN`),n===`ref`&&this.comp.refreshSchema(this.i18nSchema)}submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-i18n-simple`]],viewQuery:function(e,t){if(e&1&&Kn(sn,7),e&2){let s;Ge$1(s=Ke$1())&&(t.comp=s.first)}},decls:6,vars:1,consts:[[`sf`,``],[`nz-button`,``,`type`,`button`,3,`click`],[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`button`,1),je$1(`click`,function(){return t.changeLang(`srv`)}),an(1,`Change Language Via Service`),he$1(),oe$1(2,`button`,1),je$1(`click`,function(){return t.changeLang(`ref`)}),an(3,`Change Language Via call refresh schema`),he$1(),oe$1(4,`sf`,2,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&(A(4),ie$1(`schema`,t.schema))},dependencies:[Cu,Rt,v5,a3,f5,m5],encapsulation:2})};var he=class o{item={name:`i18n`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`i18n`,subtitle:`Internationalization`,description:`JSON Schema just a JSON object, it's support for internationalization. In addition, sf also supports some faster internationalization methods, but the...`,group:`Examples`,order:0,path:`packages/form/examples/i18n/index.en-US.md`,url:`/form/i18n/en`},text:`<p>JSON Schema just a JSON object, it&#39;s support for internationalization. In addition, <code>sf</code> also supports some faster internationalization methods, but the elements it supports are based on the following: <code>title</code>, <code>description</code>, <code>optionalHelp</code>.</p>
...
`},summary_raw:{"en-US":"The `name` element uses built-in i18n method; `password` uses external i18n method.\n","zh-CN":"`name` 元素采用内置的国际化方式；`password` 采用外部国际化方式。\n"},path:`packages/form/examples/i18n/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-i18n`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-i18n-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ue,sn$1,We$1,X],encapsulation:2})};var ln=[`sf`];var ge=class o{sf;msg=h(lu);d$=h(re$1);schema={properties:{userName:{type:`string`,title:`用户名`},pwd:{type:`string`,title:`密码`}},required:[`userName`,`pwd`]};get userNameRequired(){return(this.sf.getProperty(`/userName`)?.parent?.schema.required??[]).includes(`userName`)}get userNameDisabled(){return this.sf.getProperty(`/userName`)?.schema?.readOnly===!0}toggleUserNameRequired(){this.sf.setRequired(`/userName`,!this.userNameRequired)}toggleUserNameDisabled(){this.sf.setDisabled(`/userName`,!this.userNameDisabled)}modifyUserNameValue(){this.sf.setValue(`/userName`,`Mock text ${+new Date}`)}getUserNameValue(){this.msg.info(this.sf.getValue(`/userName`))}triggerUserNameAsyncStatus(){this.sf.updateFeedback(`/userName`,`validating`),fo(2e3).pipe(be$1(this.d$)).subscribe(()=>{this.sf.updateFeedback(`/userName`,`success`)})}submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-method-simple`]],viewQuery:function(e,t){if(e&1&&Kn(ln,5),e&2){let s;Ge$1(s=Ke$1())&&(t.sf=s.first)}},decls:13,vars:1,consts:[[`sf`,``],[1,`mb-md`],[`nz-button`,``,3,`click`],[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`p`,1)(1,`button`,2),je$1(`click`,function(){return t.getUserNameValue()}),an(2,`Get userName value`),he$1(),oe$1(3,`button`,2),je$1(`click`,function(){return t.modifyUserNameValue()}),an(4,`Modify userName value`),he$1(),oe$1(5,`button`,2),je$1(`click`,function(){return t.toggleUserNameRequired()}),an(6,`Toggle userName required`),he$1(),oe$1(7,`button`,2),je$1(`click`,function(){return t.toggleUserNameDisabled()}),an(8,`Toggle userName disabled`),he$1(),oe$1(9,`button`,2),je$1(`click`,function(){return t.triggerUserNameAsyncStatus()}),an(10,`userName async status`),he$1()(),oe$1(11,`sf`,3,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&(A(11),ie$1(`schema`,t.schema))},dependencies:[Cu,Rt,v5,a3,f5,m5],encapsulation:2})};var fe=class o{item={name:`method`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`method`,subtitle:`Built-in methods`,description:`SFComponent provides some shortcut methods, such as: setValue, setDisabled, setRequired, etc.`,group:`Examples`,order:0,path:`packages/form/examples/method/index.en-US.md`,url:`/form/method/en`},text:`<p><code>SFComponent</code> provides some shortcut methods, such as: <code>setValue</code>, <code>setDisabled</code>, <code>setRequired</code>, etc.</p>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/examples/method/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-method`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-method-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ge,sn$1,We$1,X],encapsulation:2})};var be=class o{mh=h(Mm);msg=h(lu);open(){this.mh.create(ee).subscribe(n=>this.msg.success(JSON.stringify(n)))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-modal-simple`]],decls:2,vars:0,consts:[[`nz-button`,``,`type`,`button`,3,`click`]],template:function(e,t){e&1&&(oe$1(0,`button`,0),je$1(`click`,function(){return t.open()}),an(1,`Open`),he$1())},dependencies:[v5,a3,f5,m5],encapsulation:2})};var ye=class o{item={name:`modal`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`modal`,subtitle:`Modal`,description:`Using a form in a modal box is a very common scenario. In fact, when you run ng g ng-alain:edit edit, you will get a complete example; you will get an...`,group:`Examples`,order:0,path:`packages/form/examples/modal/index.en-US.md`,url:`/form/modal/en`},text:`<p>Using a form in a modal box is a very common scenario. In fact, when you run <code>ng g ng-alain:edit edit</code>, you will get a complete example; you will get an HTML template like this:</p>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/examples/modal/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-modal`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-modal-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,be,sn$1,We$1,X],encapsulation:2})};var Se=class o{schema={properties:{name:{type:`string`,title:`姓名`,ui:{placeholder:`请输入姓名`}},email:{type:`string`,title:`邮箱`,format:`email`,ui:{placeholder:`请输入邮箱`}},role:{type:`string`,title:`角色`,enum:[`管理员`,`编辑`,`访客`],ui:{placeholder:`请选择角色`}},createdDate:{type:`string`,title:`创建日期`,ui:{widget:`date`,collapse:!0,width:200}},status:{type:`string`,title:`状态`,enum:[`启用`,`禁用`],ui:{collapse:!0,placeholder:`请选择状态`,width:150}},remark:{type:`string`,title:`备注`,ui:{collapse:!0,widget:`textarea`,autosize:!0,width:300}}}};submit(n){console.log(`search`,n)}reset(){console.log(`reset`)}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-search-simple`]],decls:1,vars:2,consts:[[`mode`,`search`,3,`formSubmit`,`formReset`,`schema`,`expandable`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)})(`formReset`,function(){return t.reset()}),he$1()),e&2&&ie$1(`schema`,t.schema)(`expandable`,!0)},dependencies:[Cu,Rt],encapsulation:2})};var ve=class o{item={name:`search`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`search`,subtitle:`Search`,description:`Use expand/collapse to save space when there are many search conditions.Set mode="search" to quickly configure search mode, which automatically sets l...`,group:`Examples`,order:0,path:`packages/form/examples/search/index.en-US.md`,url:`/form/search/en`},text:`<p>Use expand/collapse to save space when there are many search conditions.</p>
...
`},path:`packages/form/examples/search/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-search`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-search-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,Se,sn$1,We$1,X],encapsulation:2})};var we=class o{msg=h(lu);schema={properties:{product:{type:`array`,title:`产品清单`,maxItems:4,items:{type:`object`,properties:{name:{type:`string`,title:`名称`},price:{type:`number`,title:`单价`,minimum:1}},required:[`name`,`price`]},ui:{grid:{arraySpan:12}}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-array-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Fe=class o{msg=h(lu);schema={properties:{title:{type:`string`},market:{type:`number`},price:{type:`number`},skus:{type:`array`,title:`Skus`,maxItems:4,default:[{}],items:{type:`object`,properties:{name:{type:`string`,title:`名称`},price:{type:`number`,title:`单价`,minimum:1},stock:{type:`number`,minimum:1},desc:{type:`string`,ui:{grid:{span:24}}}},required:[`name`,`price`,`stock`],ui:{grid:{span:12}}},ui:{grid:{span:24,arraySpan:12}}},desc:{type:`string`,ui:{grid:{span:24}}}},required:[`title`,`market`,`price`],ui:{spanLabelFixed:100,grid:{span:8}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-array-irregular`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Ce=class o{item={name:`array`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`array`,subtitle:`Array`,order:2,description:`Create array object, it's only valid when schema.type="array".Array layout is divided into array itself and array element layout, arraySpan determines...`,group:`Widgets`,path:`packages/form/src/widgets/array/index.en-US.md`,url:`/form/array/en`},text:`<p>Create array object, it&#39;s only valid when <code>schema.type=&quot;array&quot;</code>.</p>
...
`},summary_raw:{"en-US":"Flexible use of `ui` for complex and irregular layouts.\n","zh-CN":"灵活使用 `ui` 来复杂不规则布局。\n"},path:`packages/form/src/widgets/array/demo/irregular.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-array`]],hostAttrs:[1,`d-block`],decls:7,vars:7,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-array-simple`),he$1(),oe$1(5,`code-box`,3),pt$1(6,`form-array-irregular`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A(2),ie$1(`item`,t.codes[1]),$t(`id`,t.codes[1].id))},dependencies:[ce$1,we,Fe,sn$1,We$1,X],encapsulation:2})};var ke=class o{msg=h(lu);schema={properties:{status:{type:`boolean`,title:`是否启用`},enabled:{type:`boolean`,title:`是否启用`,ui:{checkedChildren:`开`,unCheckedChildren:`关`}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-boolean-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var De=class o{item={name:`boolean`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`boolean`,subtitle:`Switch`,order:4,description:`Switching Selector.`,group:`Widgets`,path:`packages/form/src/widgets/boolean/index.en-US.md`,url:`/form/boolean/en`},text:`<p>Switching Selector.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/src/widgets/boolean/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-boolean`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-boolean-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ke,sn$1,We$1,X],encapsulation:2})};var ze=class o{msg=h(lu);schema={properties:{single:{type:`boolean`,title:`同意本协议`,description:`《用户协议》`,ui:{widget:`checkbox`},default:!0},mulit:{type:`string`,title:`Mulit`,enum:[`Apple`,`Pear`,`Orange`],ui:{widget:`checkbox`,span:8,checkAll:!0},default:[`Apple`]},async:{type:`string`,title:`Async`,ui:{widget:`checkbox`,asyncData:()=>S([{label:`Apple`,value:`Apple`},{label:`Pear`,value:`Pear`},{label:`Orange`,value:`Orange`}]).pipe(go(200))},default:[`Apple`]}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-checkbox-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var xe=class o{item={name:`checkbox`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`checkbox`,subtitle:`Checkbox`,description:`Checkbox.`,group:`Widgets`,order:0,path:`packages/form/src/widgets/checkbox/index.en-US.md`,url:`/form/checkbox/en`},text:`<p>Checkbox.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
<tr>
<td><code>[enum]</code></td>
<td>Render checkbox group when the value exists</td>
<td><code>SFSchemaEnumType[]</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[title]</code></td>
<td>Text of the single checkbox</td>
<td><code>string</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[description]</code></td>
<td>Help text of the single checkbox</td>
<td><code>string</code></td>
<td>-</td>
</tr>
</tbody></table>
...
<tbody><tr>
<td><code>[asyncData]</code></td>
<td>Async data source, render checkbox group when the value exists</td>
<td><code>() =&gt; Observable&lt;SFSchemaEnumType[]&gt;</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[span]</code></td>
<td>Raster number of cells to occupy</td>
<td><code>number</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[styleType]</code></td>
<td>Style of the <code>nz-checkbox</code></td>
<td><code>default, button</code></td>
<td><code>default</code></td>
</tr>
<tr>
<td><code>[checkAll]</code></td>
<td>Whether to select all</td>
<td><code>boolean</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[checkAllText]</code></td>
<td>Select all button text</td>
<td><code>string</code></td>
<td><code>\u5168\u9009</code></td>
</tr>
<tr>
<td><code>[change]</code></td>
<td>Changed event, Parameter: single checkbox is <code>boolean</code>, otherwise <code>SFSchemaEnum[]</code></td>
<td><code>(res: boolean | SFSchemaEnum[]) =&gt; void</code></td>
<td>-</td>
</tr>
</tbody></table>
...
<tr>
<td><code>[title]</code></td>
<td>\u65E0 <code>enum</code> \u65F6\u8868\u793A\u591A\u9009\u6846\u6587\u672C\u5185\u5BB9</td>
<td><code>string</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[description]</code></td>
<td>\u65E0 <code>enum</code> \u65F6\u8868\u793A\u591A\u9009\u6846\u540E\u5E2E\u52A9\u4FE1\u606F</td>
<td><code>string</code></td>
<td>-</td>
</tr>
</tbody></table>
...
<tr>
<td><code>[change]</code></td>
<td>\u503C\u53D8\u66F4\u4E8B\u4EF6\uFF0C\u53C2\u6570\uFF1A\u5355\u4E2A\u591A\u9009\u6846\u4E3A <code>boolean</code>\uFF0C\u5426\u5219\u4E3A <code>SFSchemaEnum[]</code></td>
<td><code>(res: boolean | SFSchemaEnum[]) =&gt; void</code></td>
<td>-</td>
</tr>
</tbody></table>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/src/widgets/checkbox/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-checkbox`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-checkbox-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ze,sn$1,We$1,X],encapsulation:2})};var pn=[`sf`];function un(o,n){if(o&1){let e=on();oe$1(0,`div`,4)(1,`div`,5)(2,`input`,6),hI(),je$1(`ngModelChange`,function(s){let p=gt$1(e).$implicit;return vt$1(p.setValue(s))}),he$1()(),oe$1(3,`div`,5)(4,`button`,7),je$1(`click`,function(){gt$1(e);let s=F();return vt$1(s.updateQr())}),an(5),he$1()()()}if(o&2){let e=n.$implicit,t=n.ui;A(2),ie$1(`disabled`,e.disabled)(`nzSize`,e.size)(`ngModel`,e.value),$t(`id`,e.id)(`disabled`,e.disabled),pI(),A(3),vr(t.btnText)}}function hn(o,n){if(o&1&&pt$1(0,`nz-qrcode`,8),o&2){let e=n.$implicit;ie$1(`nzValue`,e.value)}}var Ne=class o{msg=h(lu);sf;schema={properties:{formName:{type:`string`,title:`Custom Title`,ui:{widget:`custom`,btnText:`Update Qr`},default:`test`},qr:{type:`string`,ui:{widget:`custom`},default:`https://ng-alain.com`}}};updateQr(){let n=this.sf.getProperty(`/formName`)?.value;this.sf.getProperty(`/qr`)?.setValue(n,!0),this.msg.info(`Suc`)}submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-custom-simple`]],viewQuery:function(e,t){if(e&1&&Kn(pn,5),e&2){let s;Ge$1(s=Ke$1())&&(t.sf=s.first)}},decls:4,vars:1,consts:[[`sf`,``],[3,`formSubmit`,`schema`],[`sf-template`,`formName`],[`sf-template`,`qr`],[`nz-row`,``],[`nz-col`,``],[`nz-input`,``,3,`ngModelChange`,`disabled`,`nzSize`,`ngModel`],[`nz-button`,``,`type`,`button`,`nzType`,`link`,3,`click`],[3,`nzValue`]],template:function(e,t){e&1&&(oe$1(0,`sf`,1,0),je$1(`formSubmit`,function(p){return t.submit(p)}),qe$1(2,un,6,6,`ng-template`,2)(3,hn,1,1,`ng-template`,3),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt,fs,fr,At,jn,Fi,cn$1,sn$1,We$1,_c,He$1,v5,a3,f5,mi,nn],encapsulation:2})};var Te=class o{item={name:`custom`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`custom`,subtitle:`Custom`,description:`Custom the current dynamic form widget. For more complexity, please refer to customize widget.Make sure to specify sf-template a valid path value, for...`,group:`Widgets`,order:0,path:`packages/form/src/widgets/custom/index.en-US.md`,url:`/form/custom/en`},text:`<p>Custom the current dynamic form widget. For more complexity, please refer to <a href="/form/customize">customize</a> widget.</p>
...
`},summary_raw:{"en-US":"Use the `sf-template` directive to custom complex widget in the current form.\n","zh-CN":"使用 `sf-template` 指令在当前表单自定义复杂部件。\n"},path:`packages/form/src/widgets/custom/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-custom`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-custom-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,Ne,sn$1,We$1,X],encapsulation:2})};var _e=class o{msg=h(lu);schema={properties:{datetime:{type:`string`,format:`date-time`},date:{type:`string`,format:`date`},date_number:{type:`number`,ui:{widget:`date`}},year:{type:`number`,ui:{widget:`date`,mode:`year`,format:`yyyy`}},month:{type:`string`,format:`month`},week:{type:`string`,format:`week`},range:{type:`string`,ui:{widget:`date`,mode:`range`}},start:{type:`string`,ui:{widget:`date`,end:`end`}},end:{type:`string`,ui:{widget:`date`,end:`end`}},inline:{type:`string`,ui:{widget:`date`,inline:!0}}}};submit(n){this.msg.success(JSON.stringify(n))}change(n){console.log(`change`,n)}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-date-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`formChange`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)})(`formChange`,function(p){return t.change(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Me=class o{msg=h(lu);schema={properties:{start:{type:`string`,ui:{widget:`date`,end:`end`,separator:`到`},default:new Date},end:{type:`string`,default:P5(new Date,6)},startWeek:{type:`string`,ui:{widget:`date`,rangeMode:`week`,end:`endWeek`},default:new Date},endWeek:{type:`string`,default:P5(new Date,6)},startMonth:{type:`string`,ui:{widget:`date`,rangeMode:`month`,end:`endMonth`},default:new Date},endMonth:{type:`string`,default:P5(new Date,6)},startYear:{type:`string`,ui:{widget:`date`,rangeMode:`year`,end:`endYear`},default:new Date},endYear:{type:`string`,default:P5(new Date,6)}},required:[`start`]};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-date-range`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Ie=class o{item={name:`date`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`date`,subtitle:`Date`,description:`To select or input a date.Format is divided into two types: Data format means form data, Display format means display data (nzFormat)All Data format u...`,group:`Widgets`,order:0,path:`packages/form/src/widgets/date/index.en-US.md`,url:`/form/date/en`},text:`<p>To select or input a date.</p>
...
<td>Preset ranges for quick selection, only valid in <code>range</code> mode</td>
<td><code>&#123; [key: string]: Date[] | (() =&gt; Date[]) &#125;</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[autoFocus]</code></td>
...
<tr>
<td><code>[ranges]</code></td>
<td>\u9884\u8BBE\u65F6\u95F4\u8303\u56F4\u5FEB\u6377\u9009\u62E9\uFF08\u4EC5 <code>range</code> \u6A21\u5F0F\u6709\u6548\uFF09</td>
<td><code>&#123; [key: string]: Date[] | (() =&gt; Date[]) &#125;</code></td>
<td>-</td>
</tr>
<tr>
...
`},summary_raw:{"en-US":"A simple start & end date range, **Note:** `end` still needs define in schema, but will forced to be hidden.\n","zh-CN":"一个简单的开始与结束日期，**注意：** `end` 依然需要定义对应的Schema，但会强制隐藏状态。\n"},path:`packages/form/src/widgets/date/demo/range.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-date`]],hostAttrs:[1,`d-block`],decls:7,vars:7,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-date-simple`),he$1(),oe$1(5,`code-box`,3),pt$1(6,`form-date-range`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A(2),ie$1(`item`,t.codes[1]),$t(`id`,t.codes[1].id))},dependencies:[ce$1,_e,Me,sn$1,We$1,X],encapsulation:2})};var qe=class o{msg=h(lu);schema={properties:{number:{type:`number`,minimum:18,maximum:100,multipleOf:2,ui:{widgetWidth:200}},integer:{type:`integer`,default:10,ui:{widgetWidth:`100%`}},unit:{type:`number`,default:10,ui:{unit:`%`}},prefix:{type:`number`,default:10,ui:{prefix:`$`}},hideStep:{type:`number`,default:10,ui:{hideStep:!0}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-number-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Pe=class o{item={name:`number`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`number`,subtitle:`Input Number`,order:5,description:`Enter a number within certain range with the mouse or keyboard.All components of NG-ZORRO are in OnPush mode. A special case is that when the unit nee...`,group:`Widgets`,path:`packages/form/src/widgets/number/index.en-US.md`,url:`/form/number/en`},text:`<p>Enter a number within certain range with the mouse or keyboard.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
<td>Set the pre label</td>
<td><code>string</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[addOnAfter]</code></td>
<td>Set the post label</td>
<td><code>string</code></td>
<td>-</td>
</tr>
<tr>
...
<td>Callback when getting focus</td>
<td><code>() =&gt; void</code></td>
<td>-</td>
</tr>
<tr>
<td><code>(blur)</code></td>
<td>Callback when losing focus</td>
<td><code>() =&gt; void</code></td>
<td>-</td>
</tr>
</tbody></table>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/src/widgets/number/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-number`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-number-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,qe,sn$1,We$1,X],encapsulation:2})};var Ee=class o{msg=h(lu);schema={properties:{name:{type:`string`},age:{type:`number`}},required:[`name`,`age`],ui:{spanLabel:4,spanControl:5}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-object-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var gn=[`extra`];function fn(o,n){if(o&1){let e=on();oe$1(0,`sf`,2),je$1(`formSubmit`,function(s){gt$1(e);let p=F();return vt$1(p.submit(s))}),he$1()}if(o&2){let e=F();ie$1(`schema`,e.schema)}}function bn(o,n){if(o&1){let e=on();oe$1(0,`a`,3),je$1(`click`,function(){gt$1(e);let s=F();return vt$1(s.msg.success(`Success`))}),an(1,`More`),he$1()}}var Ae=class o{msg=h(lu);extra;schema;ngOnInit(){this.schema={properties:{name:{type:`string`},age:{type:`number`},address1:{title:`地址1`,type:`object`,properties:{country:{type:`string`},city:{type:`string`},zone:{type:`string`}},ui:{type:`card`,cardExtra:this.extra}},address2:{title:`地址2`,type:`object`,properties:{country:{type:`string`},city:{type:`string`},zone:{type:`string`}},ui:{type:`card`,showExpand:!1}}},required:[`name`,`age`],ui:{spanLabelFixed:150,grid:{span:12,gutter:16}}}}submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-object-card`]],viewQuery:function(e,t){if(e&1&&Kn(gn,7),e&2){let s;Ge$1(s=Ke$1())&&(t.extra=s.first)}},decls:3,vars:1,consts:[[`extra`,``],[3,`schema`],[3,`formSubmit`,`schema`],[3,`click`]],template:function(e,t){e&1&&(ve$1(0,fn,1,1,`sf`,1),qe$1(1,bn,2,0,`ng-template`,null,0,ql)),e&2&&ye$1(t.schema?0:-1)},dependencies:[Cu,Rt],encapsulation:2})};var Oe=class o{item={name:`object`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`object`,subtitle:`Object`,order:1,description:`Create an object widget, valid only for schema.type="object".`,group:`Widgets`,path:`packages/form/src/widgets/object/index.en-US.md`,url:`/form/object/en`},text:`<p>Create an object widget, valid only for <code>schema.type=&quot;object&quot;</code>.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
`,"zh-CN":`\u5305\u542B\u6807\u9898\u3001\u5185\u5BB9\u3001\u64CD\u4F5C\u533A\u57DF\u3002
`},path:`packages/form/src/widgets/object/demo/card.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-object`]],hostAttrs:[1,`d-block`],decls:7,vars:7,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-object-simple`),he$1(),oe$1(5,`code-box`,3),pt$1(6,`form-object-card`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A(2),ie$1(`item`,t.codes[1]),$t(`id`,t.codes[1].id))},dependencies:[ce$1,Ee,Ae,sn$1,We$1,X],encapsulation:2})};var Re=class o{msg=h(lu);schema={properties:{btn:{type:`string`,title:`Button`,enum:[`A`,`B`,`C`],ui:{widget:`radio`,styleType:`button`,buttonStyle:`solid`},default:`A`},async:{type:`string`,title:`Async`,ui:{widget:`radio`,asyncData:()=>S([{label:`男`,value:`M`},{label:`女`,value:`F`},{label:`未知`,value:`N`}]).pipe(go(100)),change:console.log},default:`N`}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-radio-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var We=class o{item={name:`radio`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`radio`,subtitle:`Radio`,description:`Radio.`,group:`Widgets`,order:0,path:`packages/form/src/widgets/radio/index.en-US.md`,url:`/form/radio/en`},text:`<p>Radio.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/src/widgets/radio/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-radio`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-radio-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,Re,sn$1,We$1,X],encapsulation:2})};var yn=[`sf`];var Ue=class o{msg=h(lu);sf;asyncData=[{label:`订单状态`,group:!0,children:[{label:`待支付`,value:`WAIT_BUYER_PAY`},{label:`已支付`,value:`TRADE_SUCCESS`},{label:`交易完成`,value:`TRADE_FINISHED`}]}];delay=1200;schema={properties:{status:{type:`string`,title:`状态`,enum:[{label:`待支付`,value:`WAIT_BUYER_PAY`,otherData:1},{label:`已支付`,value:`TRADE_SUCCESS`},{label:`交易完成`,value:`TRADE_FINISHED`}],default:`WAIT_BUYER_PAY`,ui:{widget:`select`,change:(n,e)=>console.log(n,e)}},tags:{type:`string`,title:`标签`,enum:[{label:`待支付`,value:`WAIT_BUYER_PAY`},{label:`已支付`,value:`TRADE_SUCCESS`},{label:`交易完成`,value:`TRADE_FINISHED`}],ui:{widget:`select`,mode:`tags`},default:null},async:{type:`string`,title:`Async`,default:`WAIT_BUYER_PAY`,ui:{widget:`select`,asyncData:()=>S(this.asyncData).pipe(go(this.delay))}},hide:{type:`string`,title:`隐藏项`,enum:[{label:`第1个`,value:1},{label:`第2个`,value:2,hide:!0},{label:`第3个(第2个被隐藏了)`,value:3}],default:1}}};submit(n){this.msg.success(JSON.stringify(n))}updateStatus(){let n=this.sf.getProperty(`/status`);n.schema.enum=[`1`,`2`,`3`],n.widget.reset(`2`)}updateAsyncData(){this.delay=0,this.asyncData=[{label:`Order Status`,group:!0,children:[{label:`Wait buyer pay`,value:`WAIT_BUYER_PAY`},{label:`Trade success`,value:`TRADE_SUCCESS`},{label:`Trade finished`,value:`TRADE_FINISHED`}]}];let n=`/async`;this.sf.setValue(n,this.sf.getProperty(n)?.value)}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-select-simple`]],viewQuery:function(e,t){if(e&1&&Kn(yn,5),e&2){let s;Ge$1(s=Ke$1())&&(t.sf=s.first)}},decls:6,vars:1,consts:[[`sf`,``],[3,`formSubmit`,`schema`],[`nz-button`,``,3,`click`]],template:function(e,t){e&1&&(oe$1(0,`sf`,1,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1(),oe$1(2,`button`,2),je$1(`click`,function(){return t.updateStatus()}),an(3,`Update Status`),he$1(),oe$1(4,`button`,2),je$1(`click`,function(){return t.updateAsyncData()}),an(5,`Update async data`),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt,v5,a3,f5,m5],encapsulation:2})};var Sn=[`sf`];var je=class o{msg=h(lu);sf;data={province:`Zhejiang`,city:`Ningbo`};cityData={Zhejiang:[`Hangzhou`,`Ningbo`,`Wenzhou`],Jiangsu:[`Nanjing`,`Suzhou`,`Zhenjiang`]};schema={properties:{province:{type:`string`,title:`Province`,ui:{widget:`select`,asyncData:()=>S([`Zhejiang`,`Jiangsu`]).pipe(go(100),Je$1(()=>this.updateCity(this.data.province,this.data.city))),change:n=>this.updateCity(n)}},city:{type:`string`,title:`City`,ui:{widget:`select`}}}};submit(n){this.msg.success(JSON.stringify(n))}updateCity(n,e=``){let t=this.sf.getProperty(`/city`),s=this.cityData[n];t.schema.enum=s,t.widget.reset(e??s[0])}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-select-coordinate`]],viewQuery:function(e,t){if(e&1&&Kn(Sn,5),e&2){let s;Ge$1(s=Ke$1())&&(t.sf=s.first)}},decls:2,vars:2,consts:[[`sf`,``],[3,`formSubmit`,`schema`,`formData`]],template:function(e,t){e&1&&(oe$1(0,`sf`,1,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)(`formData`,t.data)},dependencies:[Cu,Rt],encapsulation:2})};var wn=[`sf`];var Fn=[`dropdownRender`];function Cn(o,n){if(o&1){let e=on();oe$1(0,`sf`,4,1),je$1(`formSubmit`,function(s){gt$1(e);let p=F();return vt$1(p.submit(s))}),he$1()}if(o&2){let e=F();ie$1(`schema`,e.schema)}}function kn(o,n){if(o&1){let e=on();pt$1(0,`nz-divider`),oe$1(1,`div`,5),pt$1(2,`input`,6,2),oe$1(4,`a`,7),je$1(`click`,function(){gt$1(e);let s=Wl(3),p=F();return vt$1(p.addItem(s))}),pt$1(5,`nz-icon`,8),an(6,` Add item`),he$1()()}}var Ve=class o{msg=h(lu);sf;dropdownRender;schema;statusList=[`1`,`2`,`3`];submit(n){this.msg.success(JSON.stringify(n))}ngOnInit(){this.schema={properties:{status:{type:`string`,title:`状态`,enum:this.statusList,default:`1`,ui:{widget:`select`,dropdownRender:this.dropdownRender}}}}}addItem(n){this.statusList.push(n.value);let e=this.sf.getProperty(`/status`);e.schema.enum=this.statusList,this.sf.setValue(`/status`,n.value)}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-select-custom-dropdown-menu`]],viewQuery:function(e,t){if(e&1&&Kn(wn,5)(Fn,7),e&2){let s;Ge$1(s=Ke$1())&&(t.sf=s.first),Ge$1(s=Ke$1())&&(t.dropdownRender=s.first)}},decls:3,vars:1,consts:[[`dropdownRender`,``],[`sf`,``],[`inputElement`,``],[3,`schema`],[3,`formSubmit`,`schema`],[1,`container`],[`type`,`text`,`nz-input`,``],[1,`add-item`,3,`click`],[`nzType`,`plus`]],template:function(e,t){e&1&&(ve$1(0,Cn,2,1,`sf`,3),qe$1(1,kn,7,0,`ng-template`,null,0,ql)),e&2&&ye$1(t.schema?0:-1)},dependencies:[Cu,Rt,xu,Ya,_c,He$1,xr,Gt],styles:[`nz-divider[_ngcontent-%COMP%]{margin:4px 0}.container[_ngcontent-%COMP%]{display:flex;flex-wrap:nowrap;padding:8px}.add-item[_ngcontent-%COMP%]{flex:0 0 auto;padding:8px;display:block}`]})};var Le=class o{msg=h(lu);http=h(z0);schema={properties:{status:{type:`string`,title:`用户`,ui:{widget:`select`,serverSearch:!0,searchDebounceTime:300,searchLoadingText:`搜索中...`,onSearch:n=>cT(this.http.get(`https://api.randomuser.me/?results=5&q=${n}`).pipe(P(e=>e.results.map(t=>({label:t.email,value:t.email})))))}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-select-search`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Be=class o{item={name:`select`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`select`,subtitle:`Select`,order:6,description:`Select.`,group:`Widgets`,path:`packages/form/src/widgets/select/index.en-US.md`,url:`/form/select/en`},text:`<p>Select.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
`},path:`packages/form/src/widgets/select/demo/search.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-select`]],hostAttrs:[1,`d-block`],decls:11,vars:11,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-select-simple`),he$1(),oe$1(5,`code-box`,3),pt$1(6,`form-select-coordinate`),he$1(),oe$1(7,`code-box`,3),pt$1(8,`form-select-custom-dropdown-menu`),he$1(),oe$1(9,`code-box`,3),pt$1(10,`form-select-search`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A(2),ie$1(`item`,t.codes[1]),$t(`id`,t.codes[1].id),A(2),ie$1(`item`,t.codes[2]),$t(`id`,t.codes[2].id),A(2),ie$1(`item`,t.codes[3]),$t(`id`,t.codes[3].id))},dependencies:[ce$1,Ue,je,Ve,Le,sn$1,We$1,X],encapsulation:2})};var He=class o{msg=h(lu);schema={properties:{name:{type:`string`,title:`Name`,ui:{addOnAfter:`RMB`,placeholder:`RMB结算`,change:n=>console.log(n),focus:n=>console.log(`focus`,n),blur:n=>console.log(`blur`,n),enter:n=>console.log(`enter`,n)}},mobile:{type:`string`,format:`mobile`,title:`手机号`},sfz:{type:`string`,format:`id-card`,title:`身份证号`},regex:{type:`string`,pattern:`^[abc]+$`,title:`正则表达式`,ui:{placeholder:`^[abc]+$`}},color:{type:`string`,format:`color`,title:`颜色`,ui:{optionalHelp:{text:`我是有背景颜色的喔`,bgColor:`#f50`}}}},required:[`name`]};submit(n){this.msg.success(JSON.stringify(n))}valueChange(n){this.msg.info(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-string-simple`]],decls:1,vars:1,consts:[[3,`formValueChange`,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formValueChange`,function(p){return t.valueChange(p)})(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Dn=[`sf`];var Je=class o{msg=h(lu);http=h(z0);sf;schema={properties:{q:{type:`string`,title:`Key`,ui:{changeDebounceTime:500,changeMap:n=>n?.length>0?this.http.get(`/users?q=${n}&ps=6`):S({list:[]}),change:n=>{if(n.list.length<=0)return;let e=this.sf.getProperty(`/items`);e.schema.enum=n.list.map(t=>t.email),e.widget.reset(n.list[0].email)}}},items:{type:`string`,enum:[`a`,`b`,`c`]}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-string-time`]],viewQuery:function(e,t){if(e&1&&Kn(Dn,5),e&2){let s;Ge$1(s=Ke$1())&&(t.sf=s.first)}},decls:2,vars:1,consts:[[`sf`,``],[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,1,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Ge=class o{item={name:`string`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`string`,subtitle:`Input`,order:3,description:`Default widget, A basic widget for getting the user input is a text field.`,group:`Widgets`,path:`packages/form/src/widgets/string/index.en-US.md`,url:`/form/string/en`},text:`<p>Default widget, A basic widget for getting the user input is a text field.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
<tr>
<td><code>[allowClear]</code></td>
<td>Allow clicking the clear icon to delete the content</td>
<td><code>boolean</code></td>
<td><code>false</code></td>
</tr>
<tr>
...
`},summary_raw:{"en-US":"Use `changeDebounceTime` to enable throttling control, use `changeMap` and `change` to debounce fetch and ajax callback order flow.\n","zh-CN":"使用 `changeDebounceTime` 启用节流控制，并利用 `changeMap` 和 `change` 配合完成节流、请求顺序。\n"},path:`packages/form/src/widgets/string/demo/time.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-string`]],hostAttrs:[1,`d-block`],decls:7,vars:7,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-string-simple`),he$1(),oe$1(5,`code-box`,3),pt$1(6,`form-string-time`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A(2),ie$1(`item`,t.codes[1]),$t(`id`,t.codes[1].id))},dependencies:[ce$1,He,Je,sn$1,We$1,X],encapsulation:2})};var $e=class o{msg=h(lu);loading=!1;schema={properties:{id1:{type:`number`,ui:{widget:`text`}},id2:{type:`number`,ui:{widget:`text`,defaultText:`default text`}},name:{type:`string`,title:`Name`,ui:{addOnAfter:`RMB`,placeholder:`RMB结算`}}},required:[`name`]};submit(n){this.loading=!0,setTimeout(()=>{this.loading=!1,this.msg.success(JSON.stringify(n))},1e3)}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-text-simple`]],decls:1,vars:2,consts:[[3,`formSubmit`,`schema`,`loading`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)(`loading`,t.loading)},dependencies:[Cu,Rt],encapsulation:2})};var Ye=class o{item={name:`text`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`text`,subtitle:`Text`,description:`Text in form.Forced remove of the required effectAuto render - if the defaultText value does not exist`,group:`Widgets`,order:0,path:`packages/form/src/widgets/text/index.en-US.md`,url:`/form/text/en`},text:`<p>Text in form.</p>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/src/widgets/text/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-text`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-text-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,$e,sn$1,We$1,X],encapsulation:2})};var Qe=class o{msg=h(lu);schema={properties:{remark:{type:`string`,title:`描述`,ui:{widget:`textarea`,autosize:{minRows:2,maxRows:6},change:n=>console.log(`change`,n),focus:n=>console.log(`focus`,n),blur:n=>console.log(`blur`,n)}},max:{type:`string`,title:`Max`,ui:{widget:`textarea`,maxCharacterCount:100}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-textarea-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Ke=class o{item={name:`textarea`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`textarea`,subtitle:`Textarea`,description:`Textarea.`,group:`Widgets`,order:0,path:`packages/form/src/widgets/textarea/index.en-US.md`,url:`/form/textarea/en`},text:`<p>Textarea.</p>
`,api:`<h2 id="api"><a class="lake-link"><i data-anchor="api"></i></a>API</h2><h3 id="schema"><a class="lake-link"><i data-anchor="schema"></i></a>schema</h3><table>
<thead>
<tr>
<th>Property</th>
...
<tr>
<td><code>[allowClear]</code></td>
<td>Allow clicking the clear icon to delete the content; mutually exclusive with <code>maxCharacterCount</code> (<code>maxCharacterCount</code> takes precedence when both are set)</td>
<td><code>boolean</code></td>
<td><code>false</code></td>
</tr>
<tr>
...
<tr>
<td><code>[allowClear]</code></td>
<td>\u5141\u8BB8\u70B9\u51FB\u6E05\u9664\u56FE\u6807\u5220\u9664\u5185\u5BB9\uFF1B\u4E0E <code>maxCharacterCount</code> \u4E92\u65A5\uFF08\u540C\u65F6\u8BBE\u7F6E\u65F6\u4EE5 <code>maxCharacterCount</code> \u4F18\u5148\uFF09</td>
<td><code>boolean</code></td>
<td><code>false</code></td>
</tr>
<tr>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/src/widgets/textarea/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-textarea`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-textarea-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,Qe,sn$1,We$1,X],encapsulation:2})};var Ze=class o{msg=h(lu);schema={properties:{format:{type:`string`,title:`Format`,format:`email`},widget:{type:`string`,title:`指定widget`,ui:{widget:`autocomplete`,type:`email`}},async:{type:`string`,title:`异步`,ui:{widget:`autocomplete`,debounceTime:100,asyncData:n=>S(n?[{label:n,value:1,otherData:1},{label:n+n,value:2}]:[]),change:(n,e)=>console.log(n,e)},default:`asdf`}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-autocomplete-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Xe=class o{item={name:`autocomplete`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`autocomplete`,subtitle:`Autocomplete`,description:`Input complete automatically.Non-built-in modules need to additionally register withAutoCompleteWidget in json-schema.StaticEvery filter after data go...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/autocomplete/index.en-US.md`,url:`/form/autocomplete/en`},text:`<p>Input complete automatically.</p>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/autocomplete/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-autocomplete`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-autocomplete-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,Ze,sn$1,We$1,X],encapsulation:2})};var et=class o{msg=h(lu);schema={properties:{static:{type:`number`,title:`Static`,enum:[{value:11e4,label:`北京`,parent:0,children:[{value:110100,label:`北京市`,parent:11e4,children:[{value:110101,label:`东城区`,parent:110100,isLeaf:!0},{value:110105,label:`朝阳区`,parent:110100,isLeaf:!0}]}]}],ui:`cascader`,default:[11e4,110100,110105]},async:{type:`number`,title:`RealTime`,ui:{widget:`cascader`,multiple:!0,asyncData:(n,e)=>new Promise(t=>{setTimeout(()=>{n.children=[{value:11e4,label:`北京`,parent:0},{value:110100,label:`北京市`,parent:11e4},{value:110101,label:`东城区`,parent:110100},{value:110105,label:`朝阳区`,parent:110100},{value:31e4,label:`上海`,parent:0},{value:310100,label:`上海市`,parent:31e4},{value:310101,label:`黄浦区`,parent:310100},{value:310104,label:`徐汇区`,parent:310100}].filter(s=>(s.isLeaf=e===1,s.parent===(n.value??0))),t()},300)})},default:[11e4,110100,110105]}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-cascader-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var tt=class o{item={name:`cascader`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`cascader`,subtitle:`Cascader`,description:`Usually, it's used in province/city/district, company hierarchy, category of things, etc.Non-built-in modules need to additionally register withCascad...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/cascader/index.en-US.md`,url:`/form/cascader/en`},text:`<p>Usually, it&#39;s used in province/city/district, company hierarchy, category of things, etc.</p>
...
<tr>
<td><code>[suffixIcon]</code></td>
<td>Custom select box suffix icon</td>
<td><code>TemplateRef&lt;any&gt;, string</code></td>
<td>-</td>
</tr>
<tr>
<td><code>(openChange)</code></td>
<td>Dropdown menu open/close callback</td>
<td><code>(status: boolean) =&gt; void</code></td>
<td>-</td>
</tr>
<tr>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/cascader/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-cascader`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-cascader-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,et,sn$1,We$1,X],encapsulation:2})};var nt=class o{msg=h(lu);schema={properties:{base:{type:`string`,title:`Base`,ui:{widget:`color`,title:`Pls choose a color`,change:console.log}},showText:{type:`string`,title:`Show Text`,ui:{widget:`color`,showText:!0,trigger:`hover`,change:console.log}},defaultValue:{type:`string`,title:`Default Value`,ui:{widget:`color`,showText:!0,defaultValue:`#0a0`,change:console.log}},clearColor:{type:`string`,title:`Clear Color`,ui:{widget:`color`,allowClear:!0,change:console.log}},disabled:{type:`string`,title:`Disabled`,ui:{widget:`color`,showText:!0},readOnly:!0},rgb:{type:`string`,title:`RGB`,ui:{widget:`color`,format:`rgb`,showText:!0,change:console.log,formatChange:console.log}},block:{type:`string`,title:`Block Color`,ui:{widget:`color`,block:!0},default:`#f50`}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-color-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var ot=class o{item={name:`color`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`color`,subtitle:`Color`,description:`Used when the user needs to customize the color selection.Non-built-in modules need to additionally register withColorWidget in json-schema.`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/color/index.en-US.md`,url:`/form/color/en`},text:`<p>Used when the user needs to customize the color selection.</p>
...
<tr>
<td><code>[disabledAlpha]</code></td>
<td>Disable alpha selector</td>
<td><code>boolean</code></td>
<td><code>false</code></td>
</tr>
<tr>
<td><code>[presets]</code></td>
<td>Preset color list</td>
<td><code>NzPresetColor[]</code></td>
<td>-</td>
</tr>
<tr>
...
<td>Callback when the clear button is clicked</td>
<td><code>() =&gt; void</code></td>
<td>-</td>
</tr>
<tr>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/color/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-color`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-color-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,nt,sn$1,We$1,X],encapsulation:2})};var Mt=[`asdf`,`cipchk`,`中文`,`にほんご`];var dt=class o{msg=h(lu);schema={properties:{remark:{type:`string`,title:`描述`,enum:Mt,minimum:2,maximum:5,ui:{widget:`mention`,inputStyle:`textarea`}},async:{type:`string`,title:`Async`,ui:{widget:`mention`,asynxcData:()=>S(Mt).pipe(go(1e3))}},real_time:{type:`string`,title:`RealTime`,ui:{widget:`mention`,loadData:n=>S(Mt.filter(e=>e.indexOf(n.value)!==-1)).pipe(go(300))}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-mention-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var at=class o{item={name:`mention`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`mention`,subtitle:`Mention`,description:`Mention widget.Non-built-in modules need to additionally register withMentionWidget in json-schema.You must set valueWith parameter if there is no lab...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/mention/index.en-US.md`,url:`/form/mention/en`},text:`<p>Mention widget.</p>
...
<tr>
<td><code>(onClear)</code></td>
<td>Callback when content is cleared</td>
<td><code>() =&gt; void</code></td>
<td>-</td>
</tr>
<tr>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/mention/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-mention`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-mention-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,dt,sn$1,We$1,X],encapsulation:2})};var it=class o{msg=h(lu);schema={properties:{base:{type:`string`,title:`Base`,default:`https://ng-alain.com/`,ui:{widget:`qr-code`,refresh:console.log}},icon:{type:`string`,title:`With Icon`,default:`https://ng-alain.com/`,ui:{widget:`qr-code`,icon:`https://ng-alain.com/assets/img/logo-color.png`,bordered:!0}},color:{type:`string`,title:`Color`,default:`https://ng-alain.com/`,ui:{widget:`qr-code`,color:`#f50`}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-qr-code-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var rt=class o{item={name:`qr-code`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`qr-code`,subtitle:`QRCode`,description:`Used when the link needs to be converted into a QR Code.Non-built-in modules need to additionally register withQrCodeWidget in json-schema.`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/qr-code/index.en-US.md`,url:`/form/qr-code/en`},text:`<p>Used when the link needs to be converted into a QR Code.</p>
...
<td><code>canvas,svg</code></td>
<td><code>canvas</code></td>
</tr>
<tr>
<td><code>[status]</code></td>
<td>QR code status</td>
<td><code>&#39;active&#39;\uFF5C&#39;expired&#39; \uFF5C&#39;loading&#39; \uFF5C&#39;scanned&#39;</code></td>
...
<tr>
<td><code>[boostLevel]</code></td>
<td>Automatically raises the error correction level</td>
<td><code>boolean</code></td>
<td><code>true</code></td>
</tr>
<tr>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/qr-code/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-qr-code`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-qr-code-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,it,sn$1,We$1,X],encapsulation:2})};var ct=class o{msg=h(lu);schema={properties:{rate:{type:`number`,title:`评级`,default:4.5,ui:{widget:`rate`}},rate2:{type:`number`,title:`评级`,maximum:5,multipleOf:.5,default:4.5,ui:{widget:`rate`,text:`{{value}} starts`}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-rate-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var st=class o{item={name:`rate`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`rate`,subtitle:`Rate`,description:`A quick rating operation on something.Non-built-in modules need to additionally register withRateWidget in json-schema.`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/rate/index.en-US.md`,url:`/form/rate/en`},text:`<p>A quick rating operation on something.</p>
...
<td><code>TemplateRef&lt;&#123; $implicit: number &#125;&gt;</code></td>
<td>-</td>
</tr>
<tr>
<td><code>[text]</code></td>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/rate/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-rate`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-rate-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ct,sn$1,We$1,X],encapsulation:2})};var lt=class o{msg=h(lu);schema={properties:{base:{type:`string`,title:`Base`,default:2,enum:[`Daily`,`Weekly`,`Monthly`,`Quarterly`,`Yearly`],ui:{widget:U.KEY,valueChange:console.log}},asyncData:{type:`string`,title:`Async Data`,ui:{widget:U.KEY,asyncData:()=>S([{label:`Label1`,value:`a`},{label:`Label2`,value:`b`},{label:`Label3`,value:`c`,disabled:!0}]).pipe(go(1e3)),valueChange:console.log}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-segmented-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var mt=class o{item={name:`segmented`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`segmented`,subtitle:`Segmented`,description:`When displaying multiple options and user can select a single option;When switching the selected option, the content of the associated area changes.No...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/segmented/index.en-US.md`,url:`/form/segmented/en`},text:`<ul>
...
<td>Whether to enable vertical mode</td>
<td><code>boolean</code></td>
<td><code>false</code></td>
</tr>
<tr>
<td><code>[shape]</code></td>
<td>Shape of the segmented</td>
<td><code>default,round</code></td>
<td><code>default</code></td>
</tr>
<tr>
<td><code>[asyncData]</code></td>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/segmented/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-segmented`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-segmented-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,lt,sn$1,We$1,X],encapsulation:2})};var pt=class o{msg=h(lu);schema={properties:{count:{type:`number`,title:`数量`,ui:{widget:`slider`},default:10},range:{type:`number`,title:`范围`,ui:{widget:`slider`,range:!0},default:[10,20]}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-slider-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var ut=class o{item={name:`slider`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`slider`,subtitle:`Slider`,description:`A Slider component for displaying current value and intervals in range.Non-built-in modules need to additionally register withSliderWidget in json-sch...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/slider/index.en-US.md`,url:`/form/slider/en`},text:`<p>A Slider component for displaying current value and intervals in range.</p>
...
<code>[step]</code> | The granularity the slider can step through values; when <code>marks</code> is not null, <code>null</code> means only the marks are selectable; default to <code>multipleOf</code> | <code>number, null</code> | <code>multipleOf</code> |
...
<code>[reverse]</code> | Reverse axis coordinate | <code>boolean</code> | <code>false</code>
<code>[tooltipVisible]</code> | When always show tooltip with value <code>always</code>, never show with <code>never</code> | <code>default,always,never</code> | <code>default</code>
<code>[tooltipPlacement]</code> | Set default placement of Tooltip | <code>string</code> | -
...
<code>[step]</code> | \u6B65\u957F\uFF1B<code>marks</code> \u4E0D\u4E3A\u7A7A\u5BF9\u8C61\u65F6\u53EF\u8BBE\u4E3A <code>null</code>\uFF0C\u6B64\u65F6\u53EF\u9009\u503C\u4EC5\u6709 <code>marks</code> \u6807\u51FA\u7684\u90E8\u5206\uFF1B\u672A\u8BBE\u7F6E\u65F6\u4EE5 <code>multipleOf</code> \u4E3A\u51C6 | <code>number, null</code> | <code>multipleOf</code> |
...
<code>[reverse]</code> | \u53CD\u5411\u5750\u6807\u8F74 | <code>boolean</code> | <code>false</code>
<code>[tooltipVisible]</code> | \u503C\u4E3A <code>always</code> \u65F6\u603B\u662F\u663E\u793A\uFF0C\u503C\u4E3A <code>never</code> \u65F6\u5728\u4EFB\u4F55\u60C5\u51B5\u4E0B\u90FD\u4E0D\u663E\u793A | <code>default,always,never</code> | <code>default</code>
<code>[tooltipPlacement]</code> | \u8BBE\u7F6E Tooltip \u7684\u9ED8\u8BA4\u4F4D\u7F6E | <code>string</code> | -
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/slider/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-slider`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-slider-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,pt,sn$1,We$1,X],encapsulation:2})};var ht=class o{msg=h(lu);schema={properties:{like:{type:`number`,title:`兴趣`,enum:[{value:1,label:`电影`},{value:2,label:`书`},{value:3,label:`旅行`}],ui:{widget:`tag`},default:[1,2]},like1:{type:`number`,title:`兴趣`,ui:{widget:`tag`,asyncData:()=>S([{value:1,label:`电影`},{value:2,label:`书`},{value:3,label:`旅行`}]).pipe(go(10))},default:[1,2]},icon:{type:`number`,title:`兴趣`,enum:[{value:1,label:`Twitter`,prefixIcon:{type:`twitter`}},{value:2,label:`Facebook`,suffixIcon:{type:`facebook`}}],ui:{widget:`tag`}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-tag-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var gt=class o{item={name:`tag`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`tag`,subtitle:`Tag`,description:`Tag for categorizing or markup, Notice: Just only supported checkable tag mode.Non-built-in modules need to additionally register withTagWidget in jso...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/tag/index.en-US.md`,url:`/form/tag/en`},text:`<p>Tag for categorizing or markup, <strong>Notice:</strong> Just only supported <code>checkable</code> tag mode.</p>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/tag/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-tag`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-tag-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ht,sn$1,We$1,X],encapsulation:2})};var ft=class o{msg=h(lu);schema={properties:{time:{type:`string`,ui:{widget:`time`}},time_number:{type:`number`,ui:{widget:`time`}},time_format:{type:`string`,format:`time`,ui:{format:`HH:mm:ss+00:00`}},"12hours":{type:`string`,ui:{widget:`time`,format:`h:mm:ss a`,use12Hours:!0}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-time-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var bt=class o{item={name:`time`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`time`,subtitle:`Time`,description:`To select/input a time.Non-built-in modules need to additionally register withTimeWidget in json-schema.Format is divided into two types: Data format ...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/time/index.en-US.md`,url:`/form/time/en`},text:`<p>To select/input a time.</p>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/time/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-time`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-time-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,ft,sn$1,We$1,X],encapsulation:2})};var yt=class o{msg=h(lu);schema={properties:{roles:{type:`number`,title:`角色`,enum:[{title:`DNS管理`,value:10},{title:`ECS管理`,value:11},{title:`OSS管理`,value:12},{title:`RDS管理`,value:13}],ui:{widget:`transfer`,titles:[`未拥有`,`已拥有`]},default:[11,12]},roles2:{type:`number`,title:`角色`,ui:{widget:`transfer`,titles:[`未拥有`,`已拥有`],asyncData:()=>S([{title:`DNS管理`,value:10},{title:`ECS管理`,value:11},{title:`OSS管理`,value:12},{title:`RDS管理`,value:13}]).pipe(go(10))},default:[11,12]}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-transfer-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var St=class o{item={name:`transfer`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`transfer`,subtitle:`Transfer`,description:`Double column transfer choice box.Non-built-in modules need to additionally register withTransferWidget in json-schema.default value direction: 'right...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/transfer/index.en-US.md`,url:`/form/transfer/en`},text:`<p>Double column transfer choice box.</p>
...
<td>Whether show select all checkbox at bottom</td>
<td><code>boolean</code></td>
<td><code>true</code></td>
</tr>
<tr>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/transfer/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-transfer`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-transfer-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,yt,sn$1,We$1,X],encapsulation:2})};var vt=class o{msg=h(lu);schema={properties:{status1:{type:`string`,title:`基本`,enum:[{title:`待支付`,key:`WAIT_BUYER_PAY`},{title:`已支付`,key:`TRADE_SUCCESS`},{title:`交易完成`,key:`TRADE_FINISHED`}],default:`WAIT_BUYER_PAY`,ui:{widget:`tree-select`}},status2:{type:`string`,title:`多选`,enum:[{title:`待支付`,key:`WAIT_BUYER_PAY`},{title:`已支付`,key:`TRADE_SUCCESS`},{title:`交易完成`,key:`TRADE_FINISHED`}],default:[`WAIT_BUYER_PAY`,`TRADE_SUCCESS`],ui:{widget:`tree-select`,multiple:!0}},status3:{type:`string`,title:`可勾选`,default:[`WAIT_BUYER_PAY`,`TRADE_FINISHED`],ui:{widget:`tree-select`,checkable:!0,asyncData:()=>S([{title:`待支付`,key:`WAIT_BUYER_PAY`},{title:`已支付`,key:`TRADE_SUCCESS`},{title:`交易完成`,key:`TRADE_FINISHED`}]).pipe(go(10))}},async:{type:`string`,title:`Async`,enum:[{title:`待支付`,key:`WAIT_BUYER_PAY`},{title:`已支付`,key:`TRADE_SUCCESS`},{title:`交易完成`,key:`TRADE_FINISHED`}],ui:{widget:`tree-select`,expandChange:()=>S([{title:`待支付`,key:`WAIT_BUYER_PAY`},{title:`已支付`,key:`TRADE_SUCCESS`},{title:`交易完成`,key:`TRADE_FINISHED`}]).pipe(go(10))}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-tree-select-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var zn=[`customTpl`];function xn(o,n){if(o&1&&pt$1(0,`sf`,1),o&2){let e=F();ie$1(`schema`,e.schema)}}function Nn(o,n){if(o&1&&(oe$1(0,`span`,2)(1,`span`),pt$1(2,`nz-icon`,3),an(3),he$1()()),o&2){let e=n.$implicit;Ze$1(`ant-tree-node-selected`,e.isSelected),A(2),ie$1(`nzType`,e.isExpanded?`folder-open`:`folder`),A(),Io(` `,e.title,` `)}}var wt=class o{customTpl;schema;ngOnInit(){this.schema={properties:{status:{type:`string`,title:`基本`,enum:[{title:`parent 1`,key:`100`,expanded:!0,icon:`smile`,children:[{title:`leaf 1-0-0`,key:`10010`,icon:`meh`,isLeaf:!0},{title:`leaf 1-0-1`,key:`10011`,icon:`frown`,isLeaf:!0}]}],default:`10010`,ui:{widget:`tree-select`,treeTemplate:this.customTpl}}}}}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-tree-select-customized-icon`]],viewQuery:function(e,t){if(e&1&&Kn(zn,7),e&2){let s;Ge$1(s=Ke$1())&&(t.customTpl=s.first)}},decls:3,vars:1,consts:[[`customTpl`,``],[3,`schema`],[1,`ant-tree-node-content-wrapper`],[3,`nzType`]],template:function(e,t){e&1&&(ve$1(0,xn,1,1,`sf`,1),qe$1(1,Nn,4,4,`ng-template`,null,0,ql)),e&2&&ye$1(t.schema?0:-1)},dependencies:[Cu,Rt,xr,Gt],encapsulation:2})};var Ft=class o{msg=h(lu);schema={properties:{status1:{type:`string`,title:`虚拟滚动`,enum:this.dig(),ui:{widget:`tree-select`,virtualHeight:`300px`}}}};dig(n=`0`,e=3){let t=[];for(let s=0;s<10;s+=1){let p=`${n}-${s}`,J={title:p,key:p,expanded:!0,children:[],isLeaf:!1};e>0?J.children=this.dig(p,e-1):J.isLeaf=!0,t.push(J)}return t}submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-tree-select-virtual-scroll`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Ct=class o{item={name:`tree-select`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`tree-select`,subtitle:`Tree Select`,description:`Tree select widget.Note:Data source of tree-select must have keys of title、keyNon-built-in modules need to additionally register withTreeSelectWidget ...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/tree-select/index.en-US.md`,url:`/form/tree-select/en`},text:`<p>Tree select widget.</p>
...
<td><code>bottomLeft,bottomRight,topLeft,topRight</code></td>
...
`},summary_raw:{"en-US":"Set `virtualHeight` to enable virtual scroll.\n","zh-CN":"设定 `virtualHeight` 开启虚拟滚动。\n"},path:`packages/form/widgets/tree-select/demo/virtual-scroll.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-tree-select`]],hostAttrs:[1,`d-block`],decls:9,vars:9,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-tree-select-simple`),he$1(),oe$1(5,`code-box`,3),pt$1(6,`form-tree-select-customized-icon`),he$1(),oe$1(7,`code-box`,3),pt$1(8,`form-tree-select-virtual-scroll`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id),A(2),ie$1(`item`,t.codes[1]),$t(`id`,t.codes[1].id),A(2),ie$1(`item`,t.codes[2]),$t(`id`,t.codes[2].id))},dependencies:[ce$1,vt,wt,Ft,sn$1,We$1,X],encapsulation:2})};var kt=class o{msg=h(lu);schema={properties:{file:{type:`string`,title:`单个文件`,enum:[{uid:-1,name:`xxx.png`,status:`done`,url:`https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png`,response:{resource_id:1}}],ui:{widget:`upload`,action:`/upload`,resReName:`resource_id`,urlReName:`url`}},mulit:{type:`string`,title:`多个文件`,ui:{widget:`upload`,action:`/upload`,resReName:`resource_id`,urlReName:`url`,multiple:!0}},drag:{type:`string`,title:`Drag`,ui:{widget:`upload`,action:`/upload`,resReName:`resource_id`,urlReName:`url`,type:`drag`}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-upload-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Dt=class o{item={name:`upload`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`upload`,subtitle:`Upload`,description:`Upload file widget by select or drag.Non-built-in modules need to additionally register withUploadWidget in json-schema.Must set resReName to get corr...`,group:`Non-built-in widgets`,order:0,path:`packages/form/widgets/upload/index.en-US.md`,url:`/form/upload/en`},text:`<p>Upload file widget by select or drag.</p>
...
<li>Use <code>fileList</code> to provide initial files; <code>enum</code> and <code>asyncData</code> act only as generic data sources, and their shape (<code>&#123; label, value &#125;</code>) does not match the file object (<code>NzUploadFile</code>), so they are not applied as initial files</li>
...
<td>Limit the number of uploaded files; when set to <code>1</code>, the latest uploaded file always replaces the current file</td>
<td><code>number</code></td>
<td>-</td>
</tr>
<tr>
...
<li>\u521D\u59CB\u6587\u4EF6\u8BF7\u4F7F\u7528 <code>fileList</code> \u5C5E\u6027\uFF1B<code>enum</code> \u4E0E <code>asyncData</code> \u4EC5\u4F5C\u4E3A\u901A\u7528\u6570\u636E\u6E90\u5B58\u5728\uFF0C\u5176\u7ED3\u6784\uFF08<code>&#123; label, value &#125;</code>\uFF09\u4E0E\u6587\u4EF6\u5BF9\u8C61\uFF08<code>NzUploadFile</code>\uFF09\u4E0D\u7B26\uFF0C\u4E0D\u4F1A\u4F5C\u4E3A\u521D\u59CB\u6587\u4EF6\u751F\u6548</li>
...
<tr>
<td><code>[maxCount]</code></td>
<td>\u9650\u5236\u4E0A\u4F20\u6570\u91CF\uFF1B\u5F53\u4E3A <code>1</code> \u65F6\uFF0C\u59CB\u7EC8\u7528\u6700\u65B0\u4E0A\u4F20\u7684\u6587\u4EF6\u4EE3\u66FF\u5F53\u524D\u6587\u4EF6</td>
<td><code>number</code></td>
<td>-</td>
</tr>
<tr>
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets/upload/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-upload`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-upload-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,kt,sn$1,We$1,X],encapsulation:2})};var zt=class o{msg=h(lu);schema={properties:{json:{type:`string`,title:`JSON`,default:`{"string": "abc","number": 1 }`,ui:{widget:`monaco-editor`,options:{language:`json`}}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-monaco-editor-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var xt=class o{item={name:`monaco-editor`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`monaco-editor`,subtitle:`Monaco Editor`,description:`Markdown EditorInstallation dependencies  yarn add @ng-util/monaco-editor
...
`},summary_raw:{"en-US":`Simplest of usage.
`,"zh-CN":`\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002
`},path:`packages/form/widgets-third/monaco-editor/demo/simple.md`}];static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-monaco-editor`]],hostAttrs:[1,`d-block`],decls:5,vars:5,consts:[[3,`codes`,`item`],[`nz-row`,``,3,`nzGutter`],[`nz-col`,``,`nzSpan`,`24`],[3,`item`]],template:function(e,t){e&1&&(oe$1(0,`app-docs`,0)(1,`div`,1)(2,`div`,2)(3,`code-box`,3),pt$1(4,`form-monaco-editor-simple`),he$1()()()()),e&2&&(ie$1(`codes`,t.codes)(`item`,t.item),A(),ie$1(`nzGutter`,16),A(2),ie$1(`item`,t.codes[0]),$t(`id`,t.codes[0].id))},dependencies:[ce$1,zt,sn$1,We$1,X],encapsulation:2})};var Nt=class o{msg=h(lu);schema={properties:{remark:{type:`string`,title:`描述`,ui:{widget:`tinymce`}}}};submit(n){this.msg.success(JSON.stringify(n))}static ɵfac=function(e){return new(e||o)};static ɵcmp=Se$1({type:o,selectors:[[`form-tinymce-simple`]],decls:1,vars:1,consts:[[3,`formSubmit`,`schema`]],template:function(e,t){e&1&&(oe$1(0,`sf`,0),je$1(`formSubmit`,function(p){return t.submit(p)}),he$1()),e&2&&ie$1(`schema`,t.schema)},dependencies:[Cu,Rt],encapsulation:2})};var Tt=class o{item={name:`tinymce`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{title:`tinymce`,subtitle:`Tinymce Rich Text`,description:`Tinymce rich text.Installation dependencies  Since the Tinymce editor relies on a third-party plug-in ngx-tinymce, the dependency should be installed ...`,group:`Third Widgets`,order:0,path:`packages/form/widgets-third/tinymce/index.en-US.md`,url:`/form/tinymce/en`},text:`<p>Tinymce rich text.</p>
<h2 id="how_to_use"><a class="lake-link"><i data-anchor="how_to_use"></i></a>How to Use</h2><p><strong>Installation dependencies</strong></p>
