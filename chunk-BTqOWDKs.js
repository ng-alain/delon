...
- \`authJWTCanActivate\`, \`authJWTCanActivateChild\`, \`authJWTCanMatch\` \u57FA\u4E8E Json Web Token \u8BA4\u8BC1\u98CE\u683C`}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`auth-guard`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var u=class t{item={name:`qa`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:10,title:`QA`,description:`When calling the request, add ALLOW_ANONYMOUS.`,group:`Documents`,path:`packages/auth/docs/qa.en-US.md`,url:`/auth/qa/en`},text:`<h2 id="how_to_ignore_a_request"><a class="lake-link"><i data-anchor="how_to_ignore_a_request"></i></a>How to ignore a request</h2><p>When calling the request, add <code>ALLOW_ANONYMOUS</code>.</p>
...
[DEMO](//ng-alain.github.io/ng-alain/#/passport/login)\uFF0C\u8D26\u5BC6\u6216\u5176\u4ED6\u767B\u5F55\u65B9\u5F0F\u767B\u5F55\uFF0C\u5E76\u89C2\u5BDF\u6D4F\u89C8\u5668 localStorage \u5B58\u50A8\u6570\u636E\u7684\u53D8\u5316\u3002`}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`auth-send`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var k=class t{item={name:`service`,langs:[`en-US`,`zh-CN`],content:{"en-US":{meta:{order:2,title:`TokenService`,description:`ITokenService contains some service class for Token operations, such as get current Token information:After subscribing to refresh, the token will be ...`,group:`Documents`,path:`packages/auth/docs/service.en-US.md`,url:`/auth/service/en`},text:`<p><code>ITokenService</code> contains some service class for Token operations, such as get current Token information:</p>
