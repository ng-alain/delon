import{b as $}from"./chunk-2XFZESQ7.js";import{e as he,i as _e}from"./chunk-AJZURQR5.js";import"./chunk-JNBWG3V5.js";import"./chunk-GLCCKKJA.js";import"./chunk-UCVZGBUM.js";import{d as te,e as ie,f as oe}from"./chunk-E6YOA5N4.js";import{a as ae,b as me,c as le}from"./chunk-7L5LZR22.js";import"./chunk-2KNSIAM2.js";import"./chunk-ZWD35SLT.js";import{b as H,c as K}from"./chunk-2VDJBXEI.js";import{a as ge}from"./chunk-F6SLASDL.js";import"./chunk-VSDGNSIH.js";import{c as ce,d as ue,e as fe}from"./chunk-NMFYKWJI.js";import{F as ne,H as re,O as se,U as de,V as pe,da as Ce,f as X,l as Y,u as Z}from"./chunk-7BM3L5ZS.js";import{Bb as w,Cg as P,Db as u,Eg as Q,Fb as _,Fg as U,Gc as W,Hg as J,Ig as G,Ih as q,Jb as I,Kb as S,La as p,Lb as v,Ld as O,Na as M,Od as B,Te as R,Ub as e,Va as x,Yb as C,Yh as ee,Zb as g,_b as y,dc as L,fa as h,ka as l,kb as T,la as s,mb as F,nb as N,nc as E,oc as b,pb as D,qb as k,rb as c,sb as r,tb as a,ub as z,wg as A,xg as j}from"./chunk-HYQTCAQ6.js";var ye=["schemaEditor"],ze=["formCodeEditor"],Se=["uiEditor"];function ve(f,n){if(f&1&&(e(0,`
        `),z(1,"nz-option",21),e(2,`
      `)),f&2){let o=n.$implicit;p(),c("nzValue",o.name)("nzLabel",o.title)}}function Ve(f,n){if(f&1){let o=w();e(0,`
    `),r(1,"div",4),e(2,`
...
export class DemoComponent {
  ...
  `),r(22,"div",10),e(23,`
    `),r(24,"nz-space-compact"),e(25,`
      ...
      `),a(),e(30,`
      `),r(31,"button",11),E(32,"i18n"),u("click",function(){return l(i),s(t.openOnStackBlitz())}),e(33,`
        `),z(34,"nz-icon",13),e(35,`
      `),a(),e(36,`
      `),r(37,"button",11),E(38,"i18n"),u("click",function(){return l(i),s(t.onCopy())}),e(39,`
...
`),r(46,"div",15),e(47,`
  ...
  `),a(),e(71,`
  `),T(72,Ve,6,5),a(),e(73,`
`)}o&2&&(p(2),c("nzSpan",18),p(2),C("ngModel",t.name),p(2),k(t.files),p(3),C("ngModel",t.layout),p(13),c("nzSpan",6),p(4),c("nzTooltipTitle",t.expand?"Hide Code":"Show Code"),p(2),c("nzType",L("vertical-",t.expand?"right":"left")),p(3),c("nzTooltipTitle",b(32,19,"app.demo.stackblitz")),p(6),c("nzTooltipTitle",b(38,21,"app.demo.copy")),p(9),c("nzGutter",24),p(2),c("nzSpan",12)("hidden",!t.expand),p(6),C("ngModel",t.schema),c("options",t.editorOptions),p(6),C("ngModel",t.formCode),c("options",t.editorOptions),p(6),C("ngModel",t.uiCode),c("options",t.editorOptions),p(6),F(t.schemaData?72:-1))},dependencies:[Z,X,Y,fe,ue,ce,pe,se,de,oe,ie,te,G,J,Q,U,P,re,ne,j,A,le,me,ae,$,_e,he,R],encapsulation:2,changeDetection:0})};var dt=[{path:"",component:ge,children:[{path:"validator/:lang",component:V,data:{titleI18n:"app.header.menu.form.validator"}}]}];export{dt as routes};
