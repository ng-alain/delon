import{a as xt,b as Nt,c as nt}from"./chunk-BVSBPEND.js";import{e as b,g as zt,i as y}from"./chunk-IIMPW73U.js";import"./chunk-J2LCNZEP.js";import"./chunk-35MVPD5B.js";import"./chunk-MHPFZSWD.js";import{a as wt,b as Ft}from"./chunk-VVGABK7C.js";import"./chunk-SH4AI75J.js";import{a as N}from"./chunk-6E3NQSDD.js";import"./chunk-S5ZNKJJV.js";import{a as w}from"./chunk-APX5OUAY.js";import{a as Dt}from"./chunk-YYGGPYJ3.js";import"./chunk-UHNRC4C2.js";import"./chunk-Z4EYE4FD.js";import"./chunk-Q7UE7XQH.js";import{s as F,t as z,u as x}from"./chunk-NBMMYNLY.js";import{I as dt,N as ot,R as S,d as St,g as vt,m as kt,v as Ct}from"./chunk-QFGZFXPV.js";import{$a as L,Ab as ut,Db as m,J as st,Ja as s,Ka as pt,O as P,Qb as A,Ra as C,Rb as j,Sa as a,Tb as E,Ua as k,Ub as J,X as lt,Z as mt,ab as H,bf as K,bg as X,cg as tt,dg as _,fb as r,fd as gt,fg as R,ga as g,gb as c,ha as l,hb as u,hd as ft,hg as U,jg as O,k as at,lb as q,na as B,ng as bt,oa as V,pb as h,rb as W,s as I,sg as yt,v as rt,w as ct,xb as Y,yb as n,yg as et,zb as ht}from"./chunk-7RYH264L.js";var Tt=(()=>{let t=class t{constructor(o){this.modal=o,this.schema={properties:{name:{title:"Name",type:"string"}},required:["name"],ui:{spanLabelFixed:150,grid:{span:24}}}}save(o){this.modal.destroy(o)}close(){this.modal.destroy()}};t.\u0275fac=function(e){return new(e||t)(pt(bt))},t.\u0275cmp=l({type:t,selectors:[["app-demo-dialog-modal"]],standalone:!0,features:[m],decls:20,vars:4,consts:[[1,"modal-header"],[1,"modal-title"],["mode","edit","button","none",3,"schema","formData"],["sf",""],[1,"modal-footer"],["nz-button","","type","button",3,"click"],["nz-button","","type","submit",3,"nzType","disabled","click"]],template:function(e,d){if(e&1){let p=q();n(0,`
    `),r(1,"div",0),n(2,`
...
export class FormAclSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(1),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,_t,x,z,F],encapsulation:2});let i=t;return i})();var Ot=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string"},code:{type:"number"},name:{type:"string"},pwd:{type:"string",ui:{type:"password"}}},required:["login_type"],if:{properties:{login_type:{enum:["mobile"]}}},then:{required:["mobile","code"]},else:{required:["name","pwd"]}}}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-conditional-if"]],standalone:!0,features:[m],decls:3,vars:1,consts:[[3,"schema","formSubmit"]],template:function(e,d){e&1&&(n(0," "),r(1,"sf",0),h("formSubmit",function(f){return d.submit(f)}),c(),n(2," ")),e&2&&(s(1),a("schema",d.schema))},dependencies:[y,b],encapsulation:2});let i=t;return i})();var td=["sf"],Wt=(()=>{let t=class t{constructor(){this.msg=g(S),this.searchDepartment$=new at,this.schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string",description:"Try typing: ng-alain",ui:{changeDebounceTime:100,change:o=>{this.sf.getProperty("/department")?.updateFeedback("validating"),this.searchDepartment$.next(o)},visibleIf:{login_type:o=>o==="mobile"?{required:!0,show:!0}:null}}},code:{type:"number",ui:{visibleIf:{login_type:["mobile"]}}},type:{type:"string",title:"\u7C7B\u578B",enum:["\u5185\u7F51","\u5916\u7F51"],default:"\u5185\u7F51",ui:{widget:"select",visibleIf:{login_type:o=>o==="mobile"}}},department:{type:"string",title:"Department",default:"\u90E8\u95E81",ui:{widget:"select",visibleIf:{type:["\u5185\u7F51"]}}},remark:{type:"string",title:"Remark",ui:{visibleIf:{type:o=>o==="\u5185\u7F51"?{required:!0,show:!0}:null}}},adr:{type:"string",title:"Address",ui:{visibleIf:{type:o=>o==="\u5916\u7F51"?{required:!0,show:!0}:null}}},name:{type:"string",ui:{visibleIf:{login_type:["account"]}}},pwd:{type:"string",ui:{type:"password",visibleIf:{login_type:["account"]}}}},required:["login_type"],ui:{debug:!0}}}ngOnInit(){let o=e=>I(e==="ng-alain"?new Array(5).fill(0).map((d,p)=>`NG-ALAIN\u90E8\u95E8${p+1}`):new Array(3).fill(0).map((d,p)=>`\u90E8\u95E8${p+1}`)).pipe(P(500),st(()=>[]));this.searchDepartment$.asObservable().pipe(lt(o)).subscribe(e=>{let d=this.sf.getProperty("/department");d.schema.enum=e,d.schema.default=e[0],d.widget.reset(e[0]),this.sf.getProperty("/department")?.updateFeedback()})}toggleMobile(o){this.sf.getProperty("/mobile")?.setVisible(o)?.widget?.detectChanges()}submit(o){this.msg.success(JSON.stringify(o))}ngOnDestroy(){this.searchDepartment$.complete()}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-conditional-visibleIf"]],viewQuery:function(e,d){if(e&1&&j(td,7),e&2){let p;A(p=E())&&(d.sf=p.first)}},standalone:!0,features:[m],decls:10,vars:1,consts:[["type","button","nz-button","",3,"click"],[3,"schema","formSubmit"],["sf",""]],template:function(e,d){e&1&&(n(0,`
...
export class FormConditionalVisibleIfComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.searchDepartment$.complete();
        ...
        `),c(),n(13,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(1),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id),s(5),a("item",d.codes[1]),C("id",d.codes[1].id))},dependencies:[w,N,Ot,Wt,x,z,F],encapsulation:2});let i=t;return i})();var ed=["sf"],Bt=(()=>{let t=class t{constructor(){this.msg=g(S),this.i18n=g(gt),this.schema=this.i18nSchema}get i18nSchema(){return{properties:{name:{type:"string",ui:{i18n:"sf.name",descriptionI18n:"sf.description",optionalHelp:{i18n:"sf.description"}}},password:{type:"string",title:this.i18n.fanyi("sf.name"),description:this.i18n.fanyi("sf.description"),ui:{type:"password"}}},required:["name","password"]}}changeLang(o){this.i18n.use(this.i18n.zone==="zh"?"en-US":"zh-CN"),o==="ref"&&this.comp.refreshSchema(this.i18nSchema)}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-i18n-simple"]],viewQuery:function(e,d){if(e&1&&j(ed,7),e&2){let p;A(p=E())&&(d.comp=p.first)}},standalone:!0,features:[m],decls:10,vars:1,consts:[["nz-button","","type","button",3,"click"],[3,"schema","formSubmit"],["sf",""]],template:function(e,d){e&1&&(n(0,`
...
export class FormI18nSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(1),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,Bt,x,z,F],encapsulation:2});let i=t;return i})();var qt=(()=>{let t=class t{constructor(){this.mh=g(yt),this.msg=g(S)}open(){this.mh.create(Tt).subscribe(o=>this.msg.success(JSON.stringify(o)))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-modal-simple"]],standalone:!0,features:[m],decls:4,vars:0,consts:[["nz-button","","type","button",3,"click"]],template:function(e,d){e&1&&(n(0," "),r(1,"button",0),h("click",function(){return d.open()}),n(2,"Open"),c(),n(3," "))},dependencies:[O,U,_,R],encapsulation:2});let i=t;return i})();var Lt=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"zh-CN":"packages/form/examples/modal/index.md"},content:{"zh-CN":{content:`<section class="markdown"><p>\u5728\u6A21\u6001\u6846\u91CC\u4F7F\u7528\u8868\u5355\u662F\u4E00\u79CD\u975E\u5E38\u5E38\u89C1\u573A\u666F\uFF0C\u5176\u5B9E <code>ng g ng-alain:edit edit</code> \u7684\u65F6\u5019\u4F1A\u5F97\u5230\u4E00\u4E2A\u5B8C\u6574\u793A\u4F8B\uFF1B\u4F1A\u5F97\u5230\u8FD9\u6837\u7684\u4E00\u4E2AHTML\u6A21\u677F\uFF1A</p><pre class="hljs language-html"><code>&lt;sf mode="edit" [schema]="schema" [ui]="ui" [formData]="i" button="none"&gt;
...
export class FormCheckboxSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(1),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,Yt,x,z,F],encapsulation:2});let i=t;return i})();var od=["sf"];function nd(i,t){if(i&1){let M=q();n(0,`
        `),r(1,"div",4),n(2,`
          `),r(3,"div",5),n(4,`
          ...
          `),c(),n(13,`
        `),c(),n(14,`
      `)}if(i&2){let M=t.$implicit,o=t.ui;s(5),a("disabled",M.disabled)("nzSize",M.size)("ngModel",M.value),C("id",M.id)("disabled",M.disabled),s(6),ht(o.btnText)}}function id(i,t){if(i&1&&(n(0,`
        `),u(1,"nz-qrcode",8),n(2,`
      `)),i&2){let M=t.$implicit;s(1),a("nzValue",M.value)}}var Zt=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{formName:{type:"string",title:"Custom Title",ui:{widget:"custom",btnText:"Update Qr"},default:"test"},qr:{type:"string",ui:{widget:"custom"},default:"https://ng-alain.com"}}}}updateQr(){let o=this.sf.getProperty("/formName")?.value;this.sf.getProperty("/qr")?.setValue(o,!0),this.msg.info("Suc")}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-custom-simple"]],viewQuery:function(e,d){if(e&1&&j(od,5),e&2){let p;A(p=E())&&(d.sf=p.first)}},standalone:!0,features:[m],decls:9,vars:1,consts:[[3,"schema","formSubmit"],["sf",""],["sf-template","formName"],["sf-template","qr"],["nz-row",""],["nz-col",""],["nz-input","",3,"disabled","nzSize","ngModel","ngModelChange"],["nz-button","","type","button","nzType","link",3,"click"],[3,"nzValue"]],template:function(e,d){e&1&&(n(0,`
    `),r(1,"sf",0,1),h("formSubmit",function(f){return d.submit(f)}),n(3,`
      `),L(4,nd,15,6,"ng-template",2),n(5,`
      `),L(6,id,3,1,"ng-template",3),n(7,`
    `),c(),n(8,`
  `)),e&2&&(s(1),a("schema",d.schema))},dependencies:[y,b,zt,Ct,St,vt,kt,x,z,F,ot,dt,O,U,_,Nt,xt],encapsulation:2});let i=t;return i})();var Xt=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/src/widgets/custom/index.en-US.md","zh-CN":"packages/form/src/widgets/custom/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Custom the current dynamic form widget. For more complexity, please refer to <a href="/form/customize" data-url="/form/customize">customize</a> widget.</p><h2 id="Usage"><a class="lake-link"><i data-anchor="Usage"></i></a>Usage</h2><p>Make sure to specify <strong>sf-template</strong> a valid path value, for example:</p><pre class="hljs language-html"><code>&lt;sf&gt;
...
export class FormTinymceSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(1),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,Ze,x,z,F],encapsulation:2});let i=t;return i})();var Pl=[{path:"",component:Dt,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"customize",redirectTo:"customize/zh",pathMatch:"full"},{path:"customize/:lang",component:Mt},{path:"error",redirectTo:"error/zh",pathMatch:"full"},{path:"error/:lang",component:It},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:Pt},{path:"layout",redirectTo:"layout/zh",pathMatch:"full"},{path:"layout/:lang",component:At},{path:"qa",redirectTo:"qa/zh",pathMatch:"full"},{path:"qa/:lang",component:jt},{path:"schema",redirectTo:"schema/zh",pathMatch:"full"},{path:"schema/:lang",component:Et},{path:"acl",redirectTo:"acl/zh",pathMatch:"full"},{path:"acl/:lang",component:Ut},{path:"conditional",redirectTo:"conditional/zh",pathMatch:"full"},{path:"conditional/:lang",component:Rt},{path:"i18n",redirectTo:"i18n/zh",pathMatch:"full"},{path:"i18n/:lang",component:Vt},{path:"modal",redirectTo:"modal/zh",pathMatch:"full"},{path:"modal/:lang",component:Lt},{path:"array",redirectTo:"array/zh",pathMatch:"full"},{path:"array/:lang",component:Gt},{path:"boolean",redirectTo:"boolean/zh",pathMatch:"full"},{path:"boolean/:lang",component:Qt},{path:"checkbox",redirectTo:"checkbox/zh",pathMatch:"full"},{path:"checkbox/:lang",component:Kt},{path:"custom",redirectTo:"custom/zh",pathMatch:"full"},{path:"custom/:lang",component:Xt},{path:"date",redirectTo:"date/zh",pathMatch:"full"},{path:"date/:lang",component:de},{path:"number",redirectTo:"number/zh",pathMatch:"full"},{path:"number/:lang",component:ne},{path:"object",redirectTo:"object/zh",pathMatch:"full"},{path:"object/:lang",component:re},{path:"radio",redirectTo:"radio/zh",pathMatch:"full"},{path:"radio/:lang",component:se},{path:"select",redirectTo:"select/zh",pathMatch:"full"},{path:"select/:lang",component:ue},{path:"string",redirectTo:"string/zh",pathMatch:"full"},{path:"string/:lang",component:be},{path:"text",redirectTo:"text/zh",pathMatch:"full"},{path:"text/:lang",component:Se},{path:"textarea",redirectTo:"textarea/zh",pathMatch:"full"},{path:"textarea/:lang",component:ke},{path:"autocomplete",redirectTo:"autocomplete/zh",pathMatch:"full"},{path:"autocomplete/:lang",component:we},{path:"cascader",redirectTo:"cascader/zh",pathMatch:"full"},{path:"cascader/:lang",component:ze},{path:"color",redirectTo:"color/zh",pathMatch:"full"},{path:"color/:lang",component:Ne},{path:"mention",redirectTo:"mention/zh",pathMatch:"full"},{path:"mention/:lang",component:Te},{path:"qr-code",redirectTo:"qr-code/zh",pathMatch:"full"},{path:"qr-code/:lang",component:Ie},{path:"rate",redirectTo:"rate/zh",pathMatch:"full"},{path:"rate/:lang",component:Ae},{path:"segmented",redirectTo:"segmented/zh",pathMatch:"full"},{path:"segmented/:lang",component:Ee},{path:"slider",redirectTo:"slider/zh",pathMatch:"full"},{path:"slider/:lang",component:Ue},{path:"tag",redirectTo:"tag/zh",pathMatch:"full"},{path:"tag/:lang",component:We},{path:"time",redirectTo:"time/zh",pathMatch:"full"},{path:"time/:lang",component:Be},{path:"transfer",redirectTo:"transfer/zh",pathMatch:"full"},{path:"transfer/:lang",component:qe},{path:"tree-select",redirectTo:"tree-select/zh",pathMatch:"full"},{path:"tree-select/:lang",component:Ge},{path:"upload",redirectTo:"upload/zh",pathMatch:"full"},{path:"upload/:lang",component:Qe},{path:"monaco-editor",redirectTo:"monaco-editor/zh",pathMatch:"full"},{path:"monaco-editor/:lang",component:Ke},{path:"tinymce",redirectTo:"tinymce/zh",pathMatch:"full"},{path:"tinymce/:lang",component:Xe}]}];export{Pl as routes};
