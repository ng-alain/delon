...
| **Neovate Code**   | 运行 `neovate` 并使用提示词描述任务。[文档](https://github.com/neovateai/neovate-code)                                                                 | `阅读 https://ng-alain.com/llms-full-cn.txt 并理解 @delon/* 组件库，在编写 @delon/* 代码时使用这些知识。` |
