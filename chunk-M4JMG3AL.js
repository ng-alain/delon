import{a as D}from"./chunk-UJVITK7Q.js";import"./chunk-JQSS4BL6.js";import{a as $}from"./chunk-N5LLKC7K.js";import{a as X}from"./chunk-XJOKAKUL.js";import"./chunk-T6SR3K6A.js";import"./chunk-WCHKEMEB.js";import"./chunk-7C3FA3PO.js";import{s as w,t as T,u as M}from"./chunk-NIWBKAGC.js";import{R as G}from"./chunk-PLWMGIRY.js";import{Ab as N,Db as h,Dc as W,Ja as l,Jb as k,Ka as f,Kb as S,Ra as g,Re as Q,Sa as p,Ua as v,Z as I,_c as Y,a as U,ca as V,cg as _,dd as L,ea as J,eg as z,fa as y,fb as s,ga as K,gb as c,gg as E,ha as m,hb as b,ig as B,j,jd as x,l as A,pb as d,qc as C,s as q,w as F,yb as n}from"./chunk-KLO4GQEX.js";var Z=new J("DC_STORE_STORAGE_TOKEN",{providedIn:"root",factory:()=>new P(K(x))}),P=class{constructor(o){this.platform=o}get(o){return this.platform.isBrowser&&JSON.parse(localStorage.getItem(o)||"null")||null}set(o,re){return this.platform.isBrowser&&localStorage.setItem(o,JSON.stringify(re)),!0}remove(o){this.platform.isBrowser&&localStorage.removeItem(o)}};var O=(()=>{let o=class o{constructor(e,t,i,r){this.store=t,this.http=i,this.platform=r,this.memory=new Map,this.notifyBuffer=new Map,this.meta=new Set,this.freqTick=3e3,this.cog=e.merge("cache",{mode:"promise",reName:"",prefix:"",meta_key:"__cache_meta"}),r.isBrowser&&(this.loadMeta(),this.startExpireNotify())}pushMeta(e){this.meta.has(e)||(this.meta.add(e),this.saveMeta())}removeMeta(e){this.meta.has(e)&&(this.meta.delete(e),this.saveMeta())}loadMeta(){let e=this.store.get(this.cog.meta_key);e&&e.v&&e.v.forEach(t=>this.meta.add(t))}saveMeta(){let e=[];this.meta.forEach(t=>e.push(t)),this.store.set(this.cog.meta_key,{v:e,e:0})}getMeta(){return this.meta}set(e,t,i={}){if(!this.platform.isBrowser)return;let r=0,{type:u,expire:se}=this.cog;i=U({type:u,expire:se},i),i.expire&&(r=Q(new Date,i.expire).valueOf());let H=i.emitNotify!==!1;if(!(t instanceof j)){this.save(i.type,e,{v:t,e:r},H);return}return t.pipe(I(ce=>{this.save(i.type,e,{v:ce,e:r},H)}))}save(e,t,i,r=!0){e==="m"?this.memory.set(t,i):(this.store.set(this.cog.prefix+t,i),this.pushMeta(t)),r&&this.runNotify(t,"set")}get(e,t={}){if(!this.platform.isBrowser)return null;let i=t.mode!=="none"&&this.cog.mode==="promise",r=this.memory.has(e)?this.memory.get(e):this.store.get(this.cog.prefix+e);return!r||r.e&&r.e>0&&r.e<new Date().valueOf()?i?(this.cog.request?this.cog.request(e):this.http.get(e)).pipe(F(u=>Y(u,this.cog.reName,u)),I(u=>this.set(e,u,{type:t.type,expire:t.expire,emitNotify:t.emitNotify}))):null:i?q(r.v):r.v}getNone(e){return this.get(e,{mode:"none"})}tryGet(e,t,i={}){if(!this.platform.isBrowser)return null;let r=this.getNone(e);return r===null?t instanceof j?this.set(e,t,i):(this.set(e,t,i),t):q(r)}has(e){return this.memory.has(e)||this.meta.has(e)}_remove(e,t){if(t&&this.runNotify(e,"remove"),this.memory.has(e)){this.memory.delete(e);return}this.store.remove(this.cog.prefix+e),this.removeMeta(e)}remove(e){this.platform.isBrowser&&this._remove(e,!0)}clear(){this.platform.isBrowser&&(this.notifyBuffer.forEach((e,t)=>this.runNotify(t,"remove")),this.memory.clear(),this.meta.forEach(e=>this.store.remove(this.cog.prefix+e)))}set freq(e){this.freqTick=Math.max(20,e),this.abortExpireNotify(),this.startExpireNotify()}startExpireNotify(){this.checkExpireNotify(),this.runExpireNotify()}runExpireNotify(){this.freqTime=setTimeout(()=>{this.checkExpireNotify(),this.runExpireNotify()},this.freqTick)}checkExpireNotify(){let e=[];this.notifyBuffer.forEach((t,i)=>{this.has(i)&&this.getNone(i)===null&&e.push(i)}),e.forEach(t=>{this.runNotify(t,"expire"),this._remove(t,!1)})}abortExpireNotify(){clearTimeout(this.freqTime)}runNotify(e,t){this.notifyBuffer.has(e)&&this.notifyBuffer.get(e).next({type:t,value:this.getNone(e)})}notify(e){if(!this.notifyBuffer.has(e)){let t=new A(this.getNone(e));this.notifyBuffer.set(e,t)}return this.notifyBuffer.get(e).asObservable()}cancelNotify(e){this.notifyBuffer.has(e)&&(this.notifyBuffer.get(e).unsubscribe(),this.notifyBuffer.delete(e))}hasNotify(e){return this.notifyBuffer.has(e)}clearNotify(){this.notifyBuffer.forEach(e=>e.unsubscribe()),this.notifyBuffer.clear()}ngOnDestroy(){this.memory.clear(),this.abortExpireNotify(),this.clearNotify()}};o.\u0275fac=function(t){return new(t||o)(y(L),y(Z),y(W),y(x))},o.\u0275prov=V({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();var te=(()=>{let o=class o{get newValue(){return+new Date}constructor(e,t){this.srv=e,this.msg=t,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}};o.\u0275fac=function(t){return new(t||o)(f(O),f(G))},o.\u0275cmp=m({type:o,selectors:[["cache-getting-started-simple"]],standalone:!0,features:[h],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(t,i){t&1&&(n(0,`
    `),s(1,"p"),n(2),k(3,"json"),c(),n(4,`
    `),s(5,"div",0),n(6,`
      Basic:
      `),s(7,"button",1),d("click",function(){return i.srv.set(i.key,i.newValue)}),n(8,"Set"),c(),n(9,`
      `),s(10,"button",1),d("click",function(){return i.value=i.srv.getNone(i.key)}),n(11,"Get"),c(),n(12,`
      `),s(13,"button",1),d("click",function(){return i.srv.remove(i.key)}),n(14,"Remove"),c(),n(15,`
      `),s(16,"button",1),d("click",function(){return i.srv.clear()}),n(17,"Clear"),c(),n(18,`
    `),c(),n(19,`
    `),s(20,"div",0),n(21,`
      Key is valid request:
      `),s(22,"button",1),d("click",function(){return i.getByHttp()}),n(23,"Get"),c(),n(24,`
    `),c(),n(25,`
    `),s(26,"div",0),n(27,`
      Notify:
      `),s(28,"button",1),d("click",function(){return i.registerNotify()}),n(29,"Register"),c(),n(30,`
      `),s(31,"button",1),d("click",function(){return i.unRegisterNotify()}),n(32,"UnRegister"),c(),n(33,`
    `),c(),n(34,`
  `)),t&2&&(l(2),N("value: ",S(3,1,i.value),""))},dependencies:[C,B,E,_,z],encapsulation:2});let a=o;return a})();var ie=(()=>{let o=class o{constructor(){this.item={cols:1,urls:{"zh-CN":"packages/cache/docs/getting-started.md"},content:{"zh-CN":{content:`<section class="markdown"><h2 id="\u5199\u5728\u524D\u9762"><a class="lake-link"><i data-anchor="\u5199\u5728\u524D\u9762"></i></a>\u5199\u5728\u524D\u9762</h2><p>\u901A\u5E38\u628A\u4E00\u4E9B\u8FDC\u7A0B\u6570\u636E\u7F13\u5B58\u5728\u5185\u5B58\u6216 <code>localStorage</code> \u6301\u4E45\u5316\uFF0C\u76EE\u7684\u662F\u4E3A\u4E86\u51CF\u5C11 Http \u8BF7\u6C42\u7684\u6210\u672C\uFF1B\u8FD9\u6837\u7684\u6570\u636E\u901A\u5E38\u662F\u5B57\u5178\u3001\u57CE\u5E02\u6570\u636E\u7B49\u3002</p><p>\u7F13\u5B58\u7684\u83B7\u53D6\u5E94\u8BE5\u662F\u975E\u5E38\u7B80\u5355\u7684\uFF0C\u6211\u4EEC\u4E0D\u5E94\u8BE5\u628A\u65F6\u95F4\u6D6A\u8D39\u5728\u5982\u4F55\u4FDD\u8BC1\u52A0\u8F7D\u8FD9\u4EF6\u4E8B\u60C5\u4E0A\uFF0C\u56E0\u6B64 <code>@delon/cache</code> \u66F4\u591A\u662F\u4EE5<strong>\u7EA6\u5B9A</strong>\u4E3A\u524D\u63D0\u3002<code>key</code> \u4F5C\u4E3A\u7F13\u5B58\u7684\u552F\u4E00\u952E\u503C\uFF0C\u5B83\u4E0D\u5E94\u8BE5\u53EA\u662F\u5355\u7EAF\u7684\u4E00\u4E2A\u6807\u8BC6\u7B26\uFF0C\u5982\u679C\u9075\u5B88\u67D0\u79CD\u7EA6\u5B9A\u5B83\u7684\u5B58\u5728\u4F1A\u66F4\u6709\u4EF7\u503C\u3002<code>@delon/cache</code> \u9ED8\u8BA4\u60C5\u51B5\u4E0B\u4E0D\u5149\u628A <code>key</code> \u5F53\u4F5C\u552F\u4E00\u6807\u8BC6\u7B26\uFF0C\u540C\u65F6\u5B83\u8FD8\u662F\u4E00\u4E2A\u7528\u4E8E\u83B7\u53D6\u8FDC\u7A0B\u6570\u636E\u7684\u6709\u6548HTTP\uFF0C\u4F8B\u5982\uFF1A</p><pre class="hljs language-ts"><code>cacheService.get('/data/unit');</code></pre><p>\u5728\u4EE5\u5F80\u6211\u4EEC\u4F1A\u8BA4\u4E3A\uFF0C\u5728\u5B83\u4E4B\u524D\u5E94\u8BE5\u9700\u8981\u52A0\u4E00\u4E2A\uFF1A</p><pre class="hljs language-ts"><code>cacheService.set('/data/unit', [ '\u4E2A', '\u4EF6' ]);</code></pre><p>\u624D\u80FD\u591F\u786E\u4FDD\u83B7\u53D6\u5230\u7F13\u5B58\u6570\u636E\u3002</p><p>\u800C\u5BF9\u4E8E <code>@delon/cache</code> \u800C\u8A00\uFF0C\u4F60\u65E0\u987B <code>set</code> \u65B9\u6CD5\uFF0C\u76F4\u63A5\u4F7F\u7528 <code>get</code> \u83B7\u53D6\u5230\u5355\u4F4D\u5B57\u5178\uFF0C\u56E0\u4E3A\u6211\u4EEC\u6709\u4E00\u79CD<strong>\u7EA6\u5B9A</strong>\uFF0C\u5F53\u7F13\u5B58\u4E0D\u5B58\u5728\u900F\u8FC7 <code>key</code> \u4F5C\u4E3AHTTP\u8BF7\u6C42\u6570\u636E\u7F13\u5B58\u540E\u518D\u8FD4\u56DE\u3002</p><p>\u7F13\u5B58\u7684\u83B7\u53D6\u4E0E\u8BBE\u7F6E\u90FD\u662F\u901A\u8FC7 <a href="/cache/service" data-url="/cache/service">CacheService</a> \u6765\u64CD\u4F5C\uFF0C\u4F60\u53EA\u9700\u8981\u5C06 <code>CacheService</code> \u5BFC\u5165\u5BF9\u5E94\u7684\u7C7B\u5F53\u4E2D\u5373\u53EF\u3002</p><h2 id="\u5982\u4F55\u4F7F\u7528"><a class="lake-link"><i data-anchor="\u5982\u4F55\u4F7F\u7528"></i></a>\u5982\u4F55\u4F7F\u7528</h2><p><strong>\u5B89\u88C5</strong></p><pre class="hljs language-bash"><code>npm i -S @delon/cache</code></pre><p><strong>\u6CE8\u518C</strong></p><p>\u5728\u6839\u6A21\u5757 <code>AppModule</code> \u5BFC\u5165 <code>DelonCacheModule</code>\uFF1B</p><pre class="hljs language-ts"><code>import { DelonCacheModule } from '@delon/cache';
...
}`,lang:"ts",componentName:"CacheGettingStartedSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}};o.\u0275fac=function(t){return new(t||o)},o.\u0275cmp=m({type:o,selectors:[["app-cache-getting-started"]],hostVars:2,hostBindings:function(t,i){t&2&&v("d-block","true")},standalone:!0,features:[h],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(t,i){t&1&&(s(0,"app-docs",0)(1,"div",1)(2,"div",2),n(3,`
        `),s(4,"code-box",3),n(5,`
          `),b(6,"cache-getting-started-simple"),n(7,`
        `),c(),n(8,`
      `),c()()()),t&2&&(p("codes",i.codes)("item",i.item),l(1),p("nzGutter",16),l(3),p("item",i.codes[0]),g("id",i.codes[0].id))},dependencies:[$,D,te,M,T,w],encapsulation:2});let a=o;return a})();var ne=(()=>{let o=class o{get newValue(){return+new Date}constructor(e,t){this.srv=e,this.msg=t,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}};o.\u0275fac=function(t){return new(t||o)(f(O),f(G))},o.\u0275cmp=m({type:o,selectors:[["cache-service-simple"]],standalone:!0,features:[h],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(t,i){t&1&&(n(0,`
    `),s(1,"p"),n(2),k(3,"json"),c(),n(4,`
    `),s(5,"div",0),n(6,`
      Basic:
      `),s(7,"button",1),d("click",function(){return i.srv.set(i.key,i.newValue)}),n(8,"Set"),c(),n(9,`
...
}`,lang:"ts",componentName:"CacheServiceSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}};o.\u0275fac=function(t){return new(t||o)},o.\u0275cmp=m({type:o,selectors:[["app-cache-service"]],hostVars:2,hostBindings:function(t,i){t&2&&v("d-block","true")},standalone:!0,features:[h],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(t,i){t&1&&(s(0,"app-docs",0)(1,"div",1)(2,"div",2),n(3,`
        `),s(4,"code-box",3),n(5,`
          `),b(6,"cache-service-simple"),n(7,`
        `),c(),n(8,`
      `),c()()()),t&2&&(p("codes",i.codes)("item",i.item),l(1),p("nzGutter",16),l(3),p("item",i.codes[0]),g("id",i.codes[0].id))},dependencies:[$,D,ne,M,T,w],encapsulation:2});let a=o;return a})();var We=[{path:"",component:X,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:ie},{path:"service",redirectTo:"service/zh",pathMatch:"full"},{path:"service/:lang",component:oe}]}];export{We as routes};
