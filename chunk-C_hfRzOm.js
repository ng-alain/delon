...
\`\`\``}}};codes=[];static ɵfac=function(e){return new(e||t)};static ɵcmp=_e({type:t,selectors:[[`acl-guard`]],hostAttrs:[1,`d-block`],decls:1,vars:2,consts:[[3,`codes`,`item`]],template:function(e,n){e&1&&lt(0,`app-docs`,0),e&2&&re(`codes`,n.codes)(`item`,n.item)},dependencies:[rt],encapsulation:2})};var D=[{path:``,component:ee,children:[{path:`control`,redirectTo:`control/zh`,pathMatch:`full`},{path:`control/:lang`,component:c},{path:`getting-started`,redirectTo:`getting-started/zh`,pathMatch:`full`},{path:`getting-started/:lang`,component:d},{path:`guard`,redirectTo:`guard/zh`,pathMatch:`full`},{path:`guard/:lang`,component:s}]}];export{D as routes};