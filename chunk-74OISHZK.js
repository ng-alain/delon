import{Bc as C,Eb as m,Gc as g,Ma as i,Mg as v,Mh as S,Ng as y,Pg as _,Qg as z,Tc as f,Vb as e,Wa as c,Xb as l,fa as d,oc as s,pc as u,sb as a,tb as t,ub as n,zh as N}from"./chunk-UENMMWRA.js";var b=class p{modal=d(N);record;input_value=C("");model_value=g("");ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static \u0275fac=function(o){return new(o||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record",input_value:[1,"input_value"],model_value:[1,"model_value"]},outputs:{model_value:"model_valueChange"},decls:26,vars:9,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(o,r){o&1&&(e(0,`
    `),t(1,"div",0),e(2,`
  ...
  `)),o&2&&(i(8),l("\u53C2\u6570\uFF1A",u(9,7,r.record)),i(4),l("input_value: ",r.input_value()),i(3),l("model_value: ",r.model_value()),i(4),a("nzType","default")("nzSize","large"),i(3),a("nzType","primary")("nzSize","large"))},dependencies:[z,_,v,y,f],encapsulation:2})};var h=class p{ref=d(S);record;ok(){this.ref.close(`new time: ${+new Date}`),this.cancel()}cancel(){this.ref.close()}static \u0275fac=function(o){return new(o||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-drawer"]],inputs:{record:"record"},decls:16,vars:5,consts:[[2,"height","1000px"],["routerLink","/"],[1,"drawer-footer"],["nz-button","",3,"click","nzType"]],template:function(o,r){o&1&&(e(0,`
    ...
    `),n(),e(15,`
  `)),o&2&&(i(2),l("\u53C2\u6570\uFF1A",u(3,3,r.record),","),i(7),a("nzType","default"),i(3),a("nzType","primary"))},dependencies:[z,_,v,y,f],encapsulation:2})};export{b as a,h as b};
