import{a as Xt,b as eo,c as Dt}from"./chunk-OGQC4W65.js";import{e as g,g as Zt,i as f}from"./chunk-KC3ZPM5E.js";import"./chunk-JDH5UDCO.js";import"./chunk-VDCQKXU5.js";import"./chunk-4XYZYN7Y.js";import"./chunk-PSCYKAJ5.js";import{a as Qt,b as Yt}from"./chunk-5ZSKOA76.js";import"./chunk-5SAYTD6G.js";import"./chunk-5NPHVE65.js";import{a as x}from"./chunk-A3BRRRBQ.js";import"./chunk-KGORWHCQ.js";import{a as F}from"./chunk-LCRFSZUS.js";import{a as to}from"./chunk-QBWKUSAZ.js";import"./chunk-CFI3VMUF.js";import"./chunk-O4AVNO2Y.js";import"./chunk-QFQGBMDT.js";import{q as k,r as w,s as Kt}from"./chunk-RWB7VE6G.js";import{I as X,M as ee,P as b,d as Lt,g as Jt,m as Gt,v as $t}from"./chunk-5L373TCB.js";import{Ag as j,Cb as R,F as _t,Gb as P,Gg as O,Hb as _,Ia as c,Ib as A,Ig as W,Jg as U,Kd as Rt,Ld as Vt,Lh as Z,M as At,Mb as $,Ob as v,Od as Bt,Q as M,Qa as s,Rb as d,Sb as Ut,Tb as Ot,Wa as V,X as Et,Yg as Q,Z as jt,db as C,fb as q,ha as u,hb as L,la as z,m as It,ma as D,mb as i,nb as a,ob as r,pb as h,pc as J,ra as Wt,sg as Y,sh as Ht,tg as K,uh as qt,v as T,wb as I,y as Mt,z as Pt,zb as m}from"./chunk-VMLETMXK.js";var te=class n{modal=u(Ht);i;schema={properties:{name:{title:"Name",type:"string"}},required:["name"],ui:{spanLabelFixed:150,grid:{span:24}}};save(o){this.modal.destroy(o)}close(){this.modal.destroy()}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["app-demo-dialog-modal"]],decls:20,vars:4,consts:[["sf",""],[1,"modal-header"],[1,"modal-title"],["mode","edit","button","none",3,"schema","formData"],[1,"modal-footer"],["nz-button","","type","button",3,"click"],["nz-button","","type","submit",3,"click","nzType","disabled"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"div",1),d(2,`
...
export class FormConditionalVisibleIfComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.searchDepartment$.complete();
        ...
        `),r(),d(13,`
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id),c(5),i("item",t.codes[1]),C("id",t.codes[1].id))},dependencies:[F,le,me,w,k,x],encapsulation:2})};var no=["sf"],he=class n{msg=u(b);i18n=u(Bt);comp;schema=this.i18nSchema;get i18nSchema(){return{properties:{name:{type:"string",ui:{i18n:"sf.name",descriptionI18n:"sf.description",optionalHelp:{i18n:"sf.description"}}},password:{type:"string",title:this.i18n.fanyi("sf.name"),description:this.i18n.fanyi("sf.description"),ui:{type:"password"}}},required:["name","password"]}}changeLang(o){this.i18n.use(this.i18n.zone==="zh"?"en-US":"zh-CN"),o==="ref"&&this.comp.refreshSchema(this.i18nSchema)}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-i18n-simple"]],viewQuery:function(e,t){if(e&1&&P(no,7),e&2){let l;_(l=A())&&(t.comp=l.first)}},decls:10,vars:1,consts:[["sf",""],["nz-button","","type","button",3,"click"],[3,"formSubmit","schema"]],template:function(e,t){if(e&1){let l=I();d(0,`
    ...
    this.msg.success(JSON.stringify(value));
      ...
      `),r()()()),e&2&&(i("codes",t.codes)("item",t.item),c(),i("nzGutter",16),c(3),i("item",t.codes[0]),C("id",t.codes[0].id))},dependencies:[F,we,w,k,x],encapsulation:2})};var ro=["sf"];function co(n,o){if(n&1){let e=I();d(0,`
        `),a(1,"div",4),d(2,`
          ...
          `),r(),d(13,`
        `),r(),d(14,`
      `)}if(n&2){let e=o.$implicit,t=o.ui;c(5),i("disabled",e.disabled)("nzSize",e.size)("ngModel",e.value),C("id",e.id)("disabled",e.disabled),c(6),Ut(t.btnText)}}function so(n,o){if(n&1&&(d(0,`
        `),h(1,"nz-qrcode",8),d(2,`
      `)),n&2){let e=o.$implicit;c(),i("nzValue",e.value)}}var Ne=class n{msg=u(b);sf;schema={properties:{formName:{type:"string",title:"Custom Title",ui:{widget:"custom",btnText:"Update Qr"},default:"test"},qr:{type:"string",ui:{widget:"custom"},default:"https://ng-alain.com"}}};updateQr(){let o=this.sf.getProperty("/formName")?.value;this.sf.getProperty("/qr")?.setValue(o,!0),this.msg.info("Suc")}submit(o){this.msg.success(JSON.stringify(o))}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=s({type:n,selectors:[["form-custom-simple"]],viewQuery:function(e,t){if(e&1&&P(ro,5),e&2){let l;_(l=A())&&(t.sf=l.first)}},decls:9,vars:1,consts:[["sf",""],[3,"formSubmit","schema"],["sf-template","formName"],["sf-template","qr"],["nz-row",""],["nz-col",""],["nz-input","",3,"ngModelChange","disabled","nzSize","ngModel"],["nz-button","","type","button","nzType","link",3,"click"],[3,"nzValue"]],template:function(e,t){if(e&1){let l=I();d(0,`
    `),a(1,"sf",1,0),m("formSubmit",function(E){return z(l),D(t.submit(E))}),d(3,`
      `),V(4,co,15,6,"ng-template",2),d(5,`
      `),V(6,so,3,1,"ng-template",3),d(7,`
    `),r(),d(8,`
  `)}e&2&&(c(),i("schema",t.schema))},dependencies:[f,g,Zt,$t,Lt,Jt,Gt,Kt,w,k,ee,X,U,W,j,eo,Xt],encapsulation:2})};var ze=class n{item={cols:1,urls:{"en-US":"packages/form/src/widgets/custom/index.en-US.md","zh-CN":"packages/form/src/widgets/custom/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Custom the current dynamic form widget. For more complexity, please refer to <a href="/form/customize" data-url="/form/customize">customize</a> widget.</p><h2 id="Usage"><a class="lake-link"><i data-anchor="Usage"></i></a>Usage</h2><p>Make sure to specify <strong>sf-template</strong> a valid path value, for example:</p><pre class="hljs language-html"><code>&lt;sf&gt;
