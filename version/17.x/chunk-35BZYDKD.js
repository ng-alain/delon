import{a as Dt,b as Tt,c as nt}from"./chunk-YEDJ6F2O.js";import{e as b,g as Nt,i as y}from"./chunk-DK5SB3ER.js";import"./chunk-EYCUOI5Q.js";import"./chunk-KLLLXOHE.js";import"./chunk-PGMM336O.js";import{a as zt,b as xt}from"./chunk-K7DBDZKM.js";import"./chunk-KV4C4BDO.js";import{a as N}from"./chunk-FEMJZTGJ.js";import"./chunk-JZZ2D6Y3.js";import{a as w}from"./chunk-OO7Z5XQN.js";import{a as Mt}from"./chunk-XVODZEZ6.js";import"./chunk-6WIBMPTM.js";import"./chunk-TBZVYH6Z.js";import"./chunk-SCARKHZL.js";import{s as F,t as z,u as x}from"./chunk-ZY3TDUWQ.js";import{I as dt,N as ot,R as S,d as kt,g as Ct,m as wt,v as Ft}from"./chunk-HF5TSODR.js";import{Ab as E,Bb as _,Cb as K,D as st,Db as n,Eb as ut,Fb as gt,J as lt,Ja as s,Jg as St,Lb as m,Lg as vt,O as P,Oa as ht,Sg as et,Ta as q,Ua as C,Va as a,Wb as $,X as mt,Xa as k,Z as pt,bg as X,cb as G,cg as tt,da as l,dg as j,eg as R,gg as U,ha as B,hb as r,ia as V,ib as c,ig as O,jb as u,k as at,nb as H,nd as ft,od as bt,qb as h,qd as yt,s as I,sb as W,v as rt,va as g,w as ct,yg as Z,zb as A}from"./chunk-OB24VCRC.js";var It=(()=>{let t=class t{constructor(){this.modal=g(St),this.schema={properties:{name:{title:"Name",type:"string"}},required:["name"],ui:{spanLabelFixed:150,grid:{span:24}}}}save(o){this.modal.destroy(o)}close(){this.modal.destroy()}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["app-demo-dialog-modal"]],standalone:!0,features:[m],decls:20,vars:4,consts:[[1,"modal-header"],[1,"modal-title"],["mode","edit","button","none",3,"schema","formData"],["sf",""],[1,"modal-footer"],["nz-button","","type","button",3,"click"],["nz-button","","type","submit",3,"nzType","disabled","click"]],template:function(e,d){if(e&1){let p=H();n(0,`
    `),r(1,"div",0),n(2,`
      `),r(3,"div",1),n(4,"Sf demo"),c(),n(5,`
    `),c(),n(6,`
    `),r(7,"sf",2,3),n(9,`
      `),r(10,"div",4),n(11,`
        `),r(12,"button",5),h("click",function(){return d.close()}),n(13,"\u5173\u95ED"),c(),n(14,`
        `),r(15,"button",6),h("click",function(){B(p);let Y=K(8);return V(d.save(Y.value))}),n(16,`
          \u4FDD\u5B58
        `),c(),n(17,`
      `),c(),n(18,`
    `),c(),n(19,`
  `)}if(e&2){let p=K(8);s(7),a("schema",d.schema)("formData",d.i),s(8),a("nzType","primary")("disabled",!p.valid)}},dependencies:[O,U,j,R,y,b],encapsulation:2});let i=t;return i})();var Pt=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/docs/customize.en-US.md","zh-CN":"packages/form/docs/customize.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><h2 id="Foreword"><a class="lake-link"><i data-anchor="Foreword"></i></a>Foreword</h2><p><code>@delon/form</code> try our best to meet the needs of different environments, in addition to the built-in basic widgets (Some require manual registration), you can further expand the requirements in two ways:</p><h2 id="Customwidgetinsf"><a class="lake-link"><i data-anchor="Customwidgetinsf"></i></a>Customwidgetinsf</h2><p>Please refer to <a href="/form/custom" data-url="/form/custom">Custom Widget</a>.</p><h2 id="Makingwidgets"><a class="lake-link"><i data-anchor="Makingwidgets"></i></a>Makingwidgets</h2><p>Making a set of widgets for project can lead to faster development work.</p><h3 id="Howtomakingwidget"><a class="lake-link"><i data-anchor="Howtomakingwidget"></i></a>Howtomakingwidget</h3><p><strong>Create widgets</strong></p><p>A widget is a component. You only need to inherit <code>ControlWidget</code> to create a widget. For example:</p><pre class="hljs language-ts"><code>import { ChangeDetectionStrategy, Component, OnInit } from '@angular/core';
...
const alainConfig: AlainConfig = {
  ...
  `)),e&2&&(s(),a("schema",d.schema))},dependencies:[y,b,O,U,j,R],encapsulation:2});let i=t;return i})();var Rt=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/examples/acl/index.en-US.md","zh-CN":"packages/form/examples/acl/index.zh-CN.md"},content:{"en-US":{content:'<section class="markdown"><p>Combined with <code>@delon/acl</code> permissions, a Schema can be used to build forms for different roles or permission points.</p></section>',meta:{title:"acl",subtitle:"ACL",type:"Examples"},toc:[]},"zh-CN":{content:'<section class="markdown"><p>\u7ED3\u5408 <code>@delon/acl</code> \u6743\u9650\u53EF\u4EE5\u5229\u7528\u4E00\u4E2A Schema \u6765\u6784\u5EFA\u4E0D\u540C\u89D2\u8272\u6216\u6743\u9650\u70B9\u7684\u8868\u5355\u3002</p></section>',meta:{title:"acl",subtitle:"ACL",type:"Examples"},toc:[]}},demo:!0},this.codes=[{id:"form-acl-simple",meta:{title:{"zh-CN":"\u57FA\u7840\u6837\u4F8B","en-US":"Basic Usage"},order:0},summary:{"zh-CN":"<p>\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002</p>","en-US":"<p>Simplest of usage.</p>"},code:`import { Component, inject } from '@angular/core';
...
export class FormAclSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,Ot,x,z,F],encapsulation:2});let i=t;return i})();var Wt=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string"},code:{type:"number"},name:{type:"string"},pwd:{type:"string",ui:{type:"password"}}},required:["login_type"],if:{properties:{login_type:{enum:["mobile"]}}},then:{required:["mobile","code"]},else:{required:["name","pwd"]}}}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-conditional-if"]],standalone:!0,features:[m],decls:3,vars:1,consts:[[3,"schema","formSubmit"]],template:function(e,d){e&1&&(n(0," "),r(1,"sf",0),h("formSubmit",function(f){return d.submit(f)}),c(),n(2," ")),e&2&&(s(),a("schema",d.schema))},dependencies:[y,b],encapsulation:2});let i=t;return i})();var nd=["sf"],Bt=(()=>{let t=class t{constructor(){this.msg=g(S),this.searchDepartment$=new at,this.schema={properties:{login_type:{type:"string",title:"\u767B\u5F55\u65B9\u5F0F",enum:[{label:"\u624B\u673A",value:"mobile"},{label:"\u8D26\u5BC6",value:"account"}],default:"mobile",ui:{widget:"radio",styleType:"button"}},mobile:{type:"string",description:"Try typing: ng-alain",ui:{changeDebounceTime:100,change:o=>{this.sf.getProperty("/department")?.updateFeedback("validating"),this.searchDepartment$.next(o)},visibleIf:{login_type:o=>o==="mobile"?{required:!0,show:!0}:null}}},code:{type:"number",ui:{visibleIf:{login_type:["mobile"]}}},type:{type:"string",title:"\u7C7B\u578B",enum:["\u5185\u7F51","\u5916\u7F51"],default:"\u5185\u7F51",ui:{widget:"select",visibleIf:{login_type:o=>o==="mobile"}}},department:{type:"string",title:"Department",default:"\u90E8\u95E81",ui:{widget:"select",visibleIf:{type:["\u5185\u7F51"]}}},remark:{type:"string",title:"Remark",ui:{visibleIf:{type:o=>o==="\u5185\u7F51"?{required:!0,show:!0}:null}}},adr:{type:"string",title:"Address",ui:{visibleIf:{type:o=>o==="\u5916\u7F51"?{required:!0,show:!0}:null}}},name:{type:"string",ui:{visibleIf:{login_type:["account"]}}},pwd:{type:"string",ui:{type:"password",visibleIf:{login_type:["account"]}}}},required:["login_type"],ui:{debug:!0}}}ngOnInit(){let o=e=>I(e==="ng-alain"?new Array(5).fill(0).map((d,p)=>`NG-ALAIN\u90E8\u95E8${p+1}`):new Array(3).fill(0).map((d,p)=>`\u90E8\u95E8${p+1}`)).pipe(P(500),lt(()=>[]));this.searchDepartment$.asObservable().pipe(mt(o)).subscribe(e=>{let d=this.sf.getProperty("/department");d.schema.enum=e,d.schema.default=e[0],d.widget.reset(e[0]),this.sf.getProperty("/department")?.updateFeedback()})}toggleMobile(o){this.sf.getProperty("/mobile")?.setVisible(o)?.widget?.detectChanges()}submit(o){this.msg.success(JSON.stringify(o))}ngOnDestroy(){this.searchDepartment$.complete()}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-conditional-visibleIf"]],viewQuery:function(e,d){if(e&1&&A(nd,7),e&2){let p;E(p=_())&&(d.sf=p.first)}},standalone:!0,features:[m],decls:10,vars:1,consts:[["type","button","nz-button","",3,"click"],[3,"schema","formSubmit"],["sf",""]],template:function(e,d){e&1&&(n(0,`
    `),r(1,"button",0),h("click",function(){return d.toggleMobile(!1)}),n(2,"Hide mobile"),c(),n(3,`
    `),r(4,"button",0),h("click",function(){return d.toggleMobile(!0)}),n(5,"Show mobile"),c(),n(6,`
    `),r(7,"sf",1,2),h("formSubmit",function(f){return d.submit(f)}),c(),n(9,`
  `)),e&2&&(s(7),a("schema",d.schema))},dependencies:[y,b,O,U,j,R],encapsulation:2});let i=t;return i})();var Vt=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/examples/conditional/index.en-US.md","zh-CN":"packages/form/examples/conditional/index.zh-CN.md"},content:{"en-US":{content:'<section class="markdown"><p><code>sf</code> supports two types of conditional expressions:</p><ul><li><p>JSON Schema Standard <a target="_blank" href="https://ajv.js.org/json-schema.html#if-then-else" data-url="https://ajv.js.org/json-schema.html#if-then-else">if-then-else</a></p></li><li><p>More flexible <code>visibleIf</code></p></li></ul></section>',meta:{title:"Conditional expression",type:"Examples"},toc:[]},"zh-CN":{content:'<section class="markdown"><p><code>sf</code> \u652F\u6301\u4E24\u79CD\u7C7B\u578B\u7684\u6761\u4EF6\u8868\u8FBE\u5F0F\uFF0C\u5206\u522B\u4E3A\uFF1A</p><ul><li><p>JSON Schema \u6807\u51C6 <a target="_blank" href="https://ajv.js.org/json-schema.html#if-then-else" data-url="https://ajv.js.org/json-schema.html#if-then-else">if-then-else</a> </p></li><li><p>\u7075\u6D3B\u6027\u66F4\u5F3A\u7684 <code>visibleIf</code></p></li></ul></section>',meta:{title:"visibleIf",subtitle:"\u6761\u4EF6\u8868\u8FBE\u5F0F",type:"Examples"},toc:[]}},demo:!0},this.codes=[{id:"form-conditional-if",meta:{title:{"zh-CN":"If\u6837\u4F8B","en-US":"If Usage"},order:1},summary:{"zh-CN":'<p>\u652F\u6301 JSON Schema \u7684 <a target="_blank" href="https://ajv.js.org/json-schema.html#if-then-else" data-url="https://ajv.js.org/json-schema.html#if-then-else">if-then-else</a> \u7528\u6CD5\u3002</p>',"en-US":'<p><a target="_blank" href="https://ajv.js.org/json-schema.html#if-then-else" data-url="https://ajv.js.org/json-schema.html#if-then-else">if-then-else</a> usage of JSON Schema is supported.</p>'},code:`import { Component, inject } from '@angular/core';
...
export class FormConditionalVisibleIfComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.searchDepartment$.complete();
        ...
        `),c(),n(13,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id),s(5),a("item",d.codes[1]),C("id",d.codes[1].id))},dependencies:[w,N,Wt,Bt,x,z,F],encapsulation:2});let i=t;return i})();var id=["sf"],Ht=(()=>{let t=class t{constructor(){this.msg=g(S),this.i18n=g(yt),this.schema=this.i18nSchema}get i18nSchema(){return{properties:{name:{type:"string",ui:{i18n:"sf.name",descriptionI18n:"sf.description",optionalHelp:{i18n:"sf.description"}}},password:{type:"string",title:this.i18n.fanyi("sf.name"),description:this.i18n.fanyi("sf.description"),ui:{type:"password"}}},required:["name","password"]}}changeLang(o){this.i18n.use(this.i18n.zone==="zh"?"en-US":"zh-CN"),o==="ref"&&this.comp.refreshSchema(this.i18nSchema)}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-i18n-simple"]],viewQuery:function(e,d){if(e&1&&A(id,7),e&2){let p;E(p=_())&&(d.comp=p.first)}},standalone:!0,features:[m],decls:10,vars:1,consts:[["nz-button","","type","button",3,"click"],[3,"schema","formSubmit"],["sf",""]],template:function(e,d){e&1&&(n(0,`
    `),r(1,"button",0),h("click",function(){return d.changeLang("srv")}),n(2,"Change Language Via Service"),c(),n(3,`
    `),r(4,"button",0),h("click",function(){return d.changeLang("ref")}),n(5,"Change Language Via call refresh schema"),c(),n(6,`
    `),r(7,"sf",1,2),h("formSubmit",function(f){return d.submit(f)}),c(),n(9,`
  `)),e&2&&(s(7),a("schema",d.schema))},dependencies:[y,b,O,U,j,R],encapsulation:2});let i=t;return i})();var qt=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/examples/i18n/index.en-US.md","zh-CN":"packages/form/examples/i18n/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>JSON Schema just a JSON object, it's support for internationalization. In addition, <code>sf</code> also supports some faster internationalization methods, but the elements it supports are based on the following: <code>title</code>, <code>description</code>, <code>optionalHelp</code>.</p></section>`,meta:{title:"i18n",subtitle:"Internationalization",type:"Examples"},toc:[]},"zh-CN":{content:'<section class="markdown"><p>JSON Schema \u672C\u8EAB\u53EA\u662F\u4E00\u4E2A JSON \u5BF9\u8C61\uFF0C\u56E0\u6B64\u672C\u8D28\u4E0A\u5DF2\u7ECF\u662F\u652F\u6301\u56FD\u9645\u5316\u3002\u6B64\u5916\uFF0C<code>sf</code> \u8FD8\u652F\u6301\u4E00\u4E9B\u6BD4\u8F83\u5FEB\u6377\u7684\u56FD\u9645\u5316\u65B9\u5F0F\uFF0C\u4F46\u5B83\u652F\u6301\u7684\u5143\u7D20\u6BD4\u8F83\u57FA\u7840\uFF1A<code>title</code>\u3001<code>description</code>\u3001<code>optionalHelp</code> \u4E09\u4E2A\u5143\u7D20\u3002</p></section>',meta:{title:"i18n",subtitle:"\u56FD\u9645\u5316",type:"Examples"},toc:[]}},demo:!0},this.codes=[{id:"form-i18n-simple",meta:{title:{"zh-CN":"\u57FA\u7840\u6837\u4F8B","en-US":"Basic Usage"},order:0},summary:{"zh-CN":"<p><code>name</code> \u5143\u7D20\u91C7\u7528\u5185\u7F6E\u7684\u56FD\u9645\u5316\u65B9\u5F0F\uFF1B<code>password</code> \u91C7\u7528\u5916\u90E8\u56FD\u9645\u5316\u65B9\u5F0F\u3002</p>","en-US":"<p>The <code>name</code> element uses built-in i18n method; <code>password</code> uses external i18n method.</p>"},code:`import { Component, ViewChild, inject } from '@angular/core';
...
export class FormMethodSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,Lt,x,z,F],encapsulation:2});let i=t;return i})();var Gt=(()=>{let t=class t{constructor(){this.mh=g(vt),this.msg=g(S)}open(){this.mh.create(It).subscribe(o=>this.msg.success(JSON.stringify(o)))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-modal-simple"]],standalone:!0,features:[m],decls:4,vars:0,consts:[["nz-button","","type","button",3,"click"]],template:function(e,d){e&1&&(n(0," "),r(1,"button",0),h("click",function(){return d.open()}),n(2,"Open"),c(),n(3," "))},dependencies:[O,U,j,R],encapsulation:2});let i=t;return i})();var $t=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/examples/modal/index.en-US.md","zh-CN":"packages/form/examples/modal/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Using a form in a modal box is a very common scenario. In fact, when you run <code>ng g ng-alain:edit edit</code>, you will get a complete example; you will get an HTML template like this:</p><pre class="hljs language-html"><code>&lt;sf mode="edit" [schema]="schema" [ui]="ui" [formData]="i" button="none"&gt;
...
export class FormModalSimpleComponent {
  ...
  open(): void {
    this.mh.create(DemoSfComponent).subscribe(res => this.msg.success(JSON.stringify(res)));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,Gt,x,z,F],encapsulation:2});let i=t;return i})();var Qt=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{product:{type:"array",title:"\u4EA7\u54C1\u6E05\u5355",maxItems:4,items:{type:"object",properties:{name:{type:"string",title:"\u540D\u79F0"},price:{type:"number",title:"\u5355\u4EF7",minimum:1}},required:["name","price"]},ui:{grid:{arraySpan:12}}}}}}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-array-simple"]],standalone:!0,features:[m],decls:3,vars:1,consts:[[3,"schema","formSubmit"]],template:function(e,d){e&1&&(n(0," "),r(1,"sf",0),h("formSubmit",function(f){return d.submit(f)}),c(),n(2," ")),e&2&&(s(),a("schema",d.schema))},dependencies:[y,b],encapsulation:2});let i=t;return i})();var Yt=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{title:{type:"string"},market:{type:"number"},price:{type:"number"},skus:{type:"array",title:"Skus",maxItems:4,default:[{}],items:{type:"object",properties:{name:{type:"string",title:"\u540D\u79F0"},price:{type:"number",title:"\u5355\u4EF7",minimum:1},stock:{type:"number",minimum:1},desc:{type:"string",ui:{grid:{span:24}}}},required:["name","price","stock"],ui:{grid:{span:12}}},ui:{grid:{span:24,arraySpan:12}}},desc:{type:"string",ui:{grid:{span:24}}}},required:["title","market","price"],ui:{spanLabelFixed:100,grid:{span:8}}}}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-array-irregular"]],standalone:!0,features:[m],decls:3,vars:1,consts:[[3,"schema","formSubmit"]],template:function(e,d){e&1&&(n(0," "),r(1,"sf",0),h("formSubmit",function(f){return d.submit(f)}),c(),n(2," ")),e&2&&(s(),a("schema",d.schema))},dependencies:[y,b],encapsulation:2});let i=t;return i})();var Kt=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/src/widgets/array/index.en-US.md","zh-CN":"packages/form/src/widgets/array/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Create array object, it's only valid when <code>schema.type="array"</code>.</p><h2 id="Layout"><a class="lake-link"><i data-anchor="Layout"></i></a>Layout</h2><p>Array layout is divided into array itself and array element layout, <code>arraySpan</code> determines the number of grid of each array element.</p><p>UI embed in Schema:</p><pre class="hljs language-ts"><code>const schema = {
  list: {
    type: 'array',
    items: {
      a: { type: 'string' },
...
export class FormCheckboxSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,te,x,z,F],encapsulation:2});let i=t;return i})();var cd=["sf"];function sd(i,t){if(i&1){let M=H();n(0,`
        `),r(1,"div",4),n(2,`
          `),r(3,"div",5),n(4,`
            `),r(5,"input",6),h("ngModelChange",function(e){let p=B(M).$implicit;return V(p.setValue(e))}),c(),n(6,`
          `),c(),n(7,`
          `),r(8,"div",5),n(9,`
            `),r(10,"button",7),h("click",function(){B(M);let e=W();return V(e.updateQr())}),n(11),c(),n(12,`
          `),c(),n(13,`
        `),c(),n(14,`
      `)}if(i&2){let M=t.$implicit,o=t.ui;s(5),a("disabled",M.disabled)("nzSize",M.size)("ngModel",M.value),C("id",M.id)("disabled",M.disabled),s(6),ut(o.btnText)}}function ld(i,t){if(i&1&&(n(0,`
        `),u(1,"nz-qrcode",8),n(2,`
      `)),i&2){let M=t.$implicit;s(),a("nzValue",M.value)}}var de=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{formName:{type:"string",title:"Custom Title",ui:{widget:"custom",btnText:"Update Qr"},default:"test"},qr:{type:"string",ui:{widget:"custom"},default:"https://ng-alain.com"}}}}updateQr(){let o=this.sf.getProperty("/formName")?.value;this.sf.getProperty("/qr")?.setValue(o,!0),this.msg.info("Suc")}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-custom-simple"]],viewQuery:function(e,d){if(e&1&&A(cd,5),e&2){let p;E(p=_())&&(d.sf=p.first)}},standalone:!0,features:[m],decls:9,vars:1,consts:[[3,"schema","formSubmit"],["sf",""],["sf-template","formName"],["sf-template","qr"],["nz-row",""],["nz-col",""],["nz-input","",3,"disabled","nzSize","ngModel","ngModelChange"],["nz-button","","type","button","nzType","link",3,"click"],[3,"nzValue"]],template:function(e,d){e&1&&(n(0,`
    `),r(1,"sf",0,1),h("formSubmit",function(f){return d.submit(f)}),n(3,`
      `),q(4,sd,15,6,"ng-template",2),n(5,`
      `),q(6,ld,3,1,"ng-template",3),n(7,`
    `),c(),n(8,`
  `)),e&2&&(s(),a("schema",d.schema))},dependencies:[y,b,Nt,Ft,kt,Ct,wt,x,z,F,ot,dt,O,U,j,Tt,Dt],encapsulation:2});let i=t;return i})();var oe=(()=>{let t=class t{constructor(){this.item={cols:1,urls:{"en-US":"packages/form/src/widgets/custom/index.en-US.md","zh-CN":"packages/form/src/widgets/custom/index.zh-CN.md"},content:{"en-US":{content:`<section class="markdown"><p>Custom the current dynamic form widget. For more complexity, please refer to <a href="/form/customize" data-url="/form/customize">customize</a> widget.</p><h2 id="Usage"><a class="lake-link"><i data-anchor="Usage"></i></a>Usage</h2><p>Make sure to specify <strong>sf-template</strong> a valid path value, for example:</p><pre class="hljs language-html"><code>&lt;sf&gt;
...
export class FormNumberSimpleComponent {
  ...
  submit(value: {}): void {
    this.msg.success(JSON.stringify(value));
        ...
        `),c(),n(8,`
      `),c()()()),e&2&&(a("codes",d.codes)("item",d.item),s(),a("nzGutter",16),s(3),a("item",d.codes[0]),C("id",d.codes[0].id))},dependencies:[w,N,re,x,z,F],encapsulation:2});let i=t;return i})();var se=(()=>{let t=class t{constructor(){this.msg=g(S),this.schema={properties:{name:{type:"string"},age:{type:"number"}},required:["name","age"],ui:{spanLabel:4,spanControl:5}}}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-object-simple"]],standalone:!0,features:[m],decls:1,vars:1,consts:[[3,"schema","formSubmit"]],template:function(e,d){e&1&&(r(0,"sf",0),h("formSubmit",function(f){return d.submit(f)}),c()),e&2&&a("schema",d.schema)},dependencies:[y,b],encapsulation:2});let i=t;return i})();var md=["extra"];function pd(i,t){if(i&1){let M=H();n(0,`
      `),r(1,"sf",1),h("formSubmit",function(e){B(M);let d=W();return V(d.submit(e))}),c(),n(2,`
    `)}if(i&2){let M=W();s(),a("schema",M.schema)}}function hd(i,t){if(i&1){let M=H();n(0,`
      `),r(1,"a",2),h("click",function(){B(M);let e=W();return V(e.msg.success("Success"))}),n(2,"More"),c(),n(3,`
    `)}}var le=(()=>{let t=class t{constructor(){this.msg=g(S)}ngOnInit(){this.schema={properties:{name:{type:"string"},age:{type:"number"},address1:{title:"\u5730\u57401",type:"object",properties:{country:{type:"string"},city:{type:"string"},zone:{type:"string"}},ui:{type:"card",cardExtra:this.extra}},address2:{title:"\u5730\u57402",type:"object",properties:{country:{type:"string"},city:{type:"string"},zone:{type:"string"}},ui:{type:"card",showExpand:!1}}},required:["name","age"],ui:{spanLabelFixed:150,grid:{span:12,gutter:16}}}}submit(o){this.msg.success(JSON.stringify(o))}};t.\u0275fac=function(e){return new(e||t)},t.\u0275cmp=l({type:t,selectors:[["form-object-card"]],viewQuery:function(e,d){if(e&1&&A(md,7),e&2){let p;E(p=_())&&(d.extra=p.first)}},standalone:!0,features:[m],decls:5,vars:1,consts:[["extra",""],[3,"schema","formSubmit"],[3,"click"]],template:function(e,d){e&1&&(n(0,`
    `),q(1,pd,3,1)(2,hd,4,0,"ng-template",null,0,$),n(4,`
