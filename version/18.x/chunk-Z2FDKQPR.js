...
}`,lang:"ts",componentName:"CacheInterceptorSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=d({type:s,selectors:[["app-cache-interceptor"]],hostVars:2,hostBindings:function(n,i){n&2&&g("d-block","true")},standalone:!0,features:[p],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,i){n&1&&(o(0,"app-docs",0)(1,"div",1)(2,"div",2),t(3,`
        `),o(4,"code-box",3),t(5,`
          `),b(6,"cache-interceptor-simple"),t(7,`
        `),r(),t(8,`
      `),r()()()),n&2&&(m("codes",i.codes)("item",i.item),l(),m("nzGutter",16),l(3),m("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[M,G,ae,D,w,B],encapsulation:2})}}return s})();var de=(()=>{class s{get newValue(){return+new Date}constructor(e,n){this.srv=e,this.msg=n,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static{this.\u0275fac=function(n){return new(n||s)(u(f),u(T))}}static{this.\u0275cmp=d({type:s,selectors:[["cache-service-simple"]],standalone:!0,features:[p],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(n,i){n&1&&(t(0,`
    `),o(1,"p"),t(2),S(3,"json"),r(),t(4,`
    `),o(5,"div",0),t(6,`
      Basic:
      `),o(7,"button",1),a("click",function(){return i.srv.set(i.key,i.newValue)}),t(8,"Set"),r(),t(9,`
...
}`,lang:"ts",componentName:"CacheServiceSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=d({type:s,selectors:[["app-cache-service"]],hostVars:2,hostBindings:function(n,i){n&2&&g("d-block","true")},standalone:!0,features:[p],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,i){n&1&&(o(0,"app-docs",0)(1,"div",1)(2,"div",2),t(3,`
        `),o(4,"code-box",3),t(5,`
          `),b(6,"cache-service-simple"),t(7,`
        `),r(),t(8,`
      `),r()()()),n&2&&(m("codes",i.codes)("item",i.item),l(),m("nzGutter",16),l(3),m("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[M,G,de,D,w,B],encapsulation:2})}}return s})();var ut=[{path:"",component:Z,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:ce},{path:"interceptor",redirectTo:"interceptor/zh",pathMatch:"full"},{path:"interceptor/:lang",component:le},{path:"service",redirectTo:"service/zh",pathMatch:"full"},{path:"service/:lang",component:me}]}];export{ut as routes};
